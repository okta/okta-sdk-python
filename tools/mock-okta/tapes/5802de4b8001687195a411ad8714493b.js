...
module.exports = function (req, res) {
  ...
  res.setHeader("x-okta-request-id", "reqxHNVGcDGSsuy1S_cKsR_4A");
  res.setHeader("p3p", "CP=\"HONK\"");
  res.setHeader("set-cookie", ["sid=\"\"; Expires=Thu, 01-Jan-1970 00:00:10 GMT; Path=/","JSESSIONID=5B4E951ABB660F874D89706B48A1A70A; Path=/"]);
  res.setHeader("x-rate-limit-limit", "1200");
  res.setHeader("x-rate-limit-remaining", "1141");
