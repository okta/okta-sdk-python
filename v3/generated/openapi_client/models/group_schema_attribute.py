...
class GroupSchemaAttribute(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["description", "enum", "externalName", "externalNamespace", "items", "master", "maxLength", "minLength", "mutability", "oneOf", "permissions", "required", "scope", "title", "type", "union", "unique"]
