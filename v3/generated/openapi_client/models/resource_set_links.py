...
class ResourceSetLinks(BaseModel):
    ...
    resources: Optional[HrefObject] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resources": HrefObject.from_dict(obj["resources"]) if obj.get("resources") is not None else None,
            "bindings": HrefObject.from_dict(obj["bindings"]) if obj.get("bindings") is not None else None
        })
        return _obj
