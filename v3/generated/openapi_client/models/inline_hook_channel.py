...
class InlineHookChannel(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'HTTP': 'InlineHookChannelHttp','OAUTH': 'InlineHookChannelOAuth'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[InlineHookChannelHttp, InlineHookChannelOAuth]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[InlineHookChannelHttp, InlineHookChannelOAuth]]:
