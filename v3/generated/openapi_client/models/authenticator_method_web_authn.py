...
class AuthenticatorMethodWebAuthn(AuthenticatorMethodBase):
    """
    AuthenticatorMethodWebAuthn
    """ # noqa: E501
    settings: Optional[AuthenticatorMethodWebAuthnAllOfSettings] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "settings": AuthenticatorMethodWebAuthnAllOfSettings.from_dict(obj["settings"]) if obj.get("settings") is not None else None
        })
        return _obj
