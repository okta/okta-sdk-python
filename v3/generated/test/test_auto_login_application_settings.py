...
class TestAutoLoginApplicationSettings(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AutoLoginApplicationSettings:
        """Test AutoLoginApplicationSettings
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutoLoginApplicationSettings`
        """
        ...
        if include_optional:
            return AutoLoginApplicationSettings(
                ...
                sign_on = openapi_client.models.auto_login_application_settings_sign_on.AutoLoginApplicationSettingsSignOn(
                    login_url = '', 
                    redirect_url = '', )
            )
        else:
