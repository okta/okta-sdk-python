...
class TestPasswordPolicyRuleConditions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PasswordPolicyRuleConditions:
        """Test PasswordPolicyRuleConditions
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PasswordPolicyRuleConditions`
        """
    ...
    def testPasswordPolicyRuleConditions(self):
        """Test PasswordPolicyRuleConditions"""
