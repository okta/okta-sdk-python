...
class TestDeviceAssuranceMacOSPlatformAllOfThirdPartySignalProviders(unittest.TestCase):
    """DeviceAssuranceMacOSPlatformAllOfThirdPartySignalProviders unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceAssuranceMacOSPlatformAllOfThirdPartySignalProviders:
        """Test DeviceAssuranceMacOSPlatformAllOfThirdPartySignalProviders
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceAssuranceMacOSPlatformAllOfThirdPartySignalProviders`
        """
        model = DeviceAssuranceMacOSPlatformAllOfThirdPartySignalProviders()
        if include_optional:
            return DeviceAssuranceMacOSPlatformAllOfThirdPartySignalProviders(
    ...
    def testDeviceAssuranceMacOSPlatformAllOfThirdPartySignalProviders(self):
        """Test DeviceAssuranceMacOSPlatformAllOfThirdPartySignalProviders"""
