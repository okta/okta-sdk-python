...
class TestIdpDiscoveryPolicyRule(unittest.TestCase):
    """IdpDiscoveryPolicyRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IdpDiscoveryPolicyRule:
        """Test IdpDiscoveryPolicyRule
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IdpDiscoveryPolicyRule`
        """
        model = IdpDiscoveryPolicyRule()
        if include_optional:
            return IdpDiscoveryPolicyRule(
                actions = openapi_client.models.idp_policy_rule_action.IdpPolicyRuleAction(
    ...
    def testIdpDiscoveryPolicyRule(self):
        """Test IdpDiscoveryPolicyRule"""
