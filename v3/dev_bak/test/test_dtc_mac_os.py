...
class TestDTCMacOS(unittest.TestCase):
    """DTCMacOS unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DTCMacOS:
        """Test DTCMacOS
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DTCMacOS`
        """
        model = DTCMacOS()
        if include_optional:
            return DTCMacOS(
