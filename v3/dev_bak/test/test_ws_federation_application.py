...
class TestWsFederationApplication(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WsFederationApplication:
        """Test WsFederationApplication
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WsFederationApplication`
        """
    ...
    def testWsFederationApplication(self):
        """Test WsFederationApplication"""
