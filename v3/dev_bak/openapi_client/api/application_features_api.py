...
class ApplicationFeaturesApi:
    ...
    def get_feature_for_application(
        ...
        _param = self._get_feature_for_application_serialize(
            app_id=app_id,
    ...
    def get_feature_for_application_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApplicationFeature]:
        """Retrieve a Feature
    ...
    def list_features_for_application(
        ...
        _param = self._list_features_for_application_serialize(
            app_id=app_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def list_features_for_application_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ApplicationFeature]]:
        """List all Features
    ...
    def update_feature_for_application(
        ...
        _param = self._update_feature_for_application_serialize(
            app_id=app_id,
            feature_name=feature_name,
