...
class TestMultifactorEnrollmentPolicy(unittest.TestCase):
    """MultifactorEnrollmentPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MultifactorEnrollmentPolicy:
        """Test MultifactorEnrollmentPolicy
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultifactorEnrollmentPolicy`
        """
        model = MultifactorEnrollmentPolicy()
        if include_optional:
            return MultifactorEnrollmentPolicy(
                conditions = openapi_client.models.policy_rule_conditions.PolicyRuleConditions(
                    ...
                    user_status = openapi_client.models.user_status_policy_rule_condition.UserStatusPolicyRuleCondition(
                        value = 'ACTIVATING', ), ),
                settings = openapi_client.models.multifactor_enrollment_policy_settings.MultifactorEnrollmentPolicySettings(
                    authenticators = [
    ...
    def testMultifactorEnrollmentPolicy(self):
        """Test MultifactorEnrollmentPolicy"""
