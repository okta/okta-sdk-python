...
class TestProfileEnrollmentPolicy(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProfileEnrollmentPolicy:
        """Test ProfileEnrollmentPolicy
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfileEnrollmentPolicy`
        """
    ...
    def testProfileEnrollmentPolicy(self):
        """Test ProfileEnrollmentPolicy"""
