...
class TestAccessPolicyRuleConditions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AccessPolicyRuleConditions:
        """Test AccessPolicyRuleConditions
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessPolicyRuleConditions`
        """
        ...
        if include_optional:
            return AccessPolicyRuleConditions(
                ...
                user_status = openapi_client.models.user_status_policy_rule_condition.UserStatusPolicyRuleCondition(
                    value = 'ACTIVATING', ),
                el_condition = openapi_client.models.access_policy_rule_custom_condition.AccessPolicyRuleCustomCondition(
                    condition = '', ),
                user_type = openapi_client.models.user_type_condition.UserTypeCondition(
                    exclude = [
                        ''
                        ], 
                    include = [
    ...
    def testAccessPolicyRuleConditions(self):
        """Test AccessPolicyRuleConditions"""
