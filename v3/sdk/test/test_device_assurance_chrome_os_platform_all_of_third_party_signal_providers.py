...
class TestDeviceAssuranceChromeOSPlatformAllOfThirdPartySignalProviders(unittest.TestCase):
    """DeviceAssuranceChromeOSPlatformAllOfThirdPartySignalProviders unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceAssuranceChromeOSPlatformAllOfThirdPartySignalProviders:
        """Test DeviceAssuranceChromeOSPlatformAllOfThirdPartySignalProviders
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceAssuranceChromeOSPlatformAllOfThirdPartySignalProviders`
        """
        model = DeviceAssuranceChromeOSPlatformAllOfThirdPartySignalProviders()
        if include_optional:
            return DeviceAssuranceChromeOSPlatformAllOfThirdPartySignalProviders(
    ...
    def testDeviceAssuranceChromeOSPlatformAllOfThirdPartySignalProviders(self):
        """Test DeviceAssuranceChromeOSPlatformAllOfThirdPartySignalProviders"""
