...
class Authenticator(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "provider": AuthenticatorProvider.from_dict(obj["provider"]) if obj.get("provider") is not None else None,
            "settings": AuthenticatorSettings.from_dict(obj["settings"]) if obj.get("settings") is not None else None,
