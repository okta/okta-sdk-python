...
class PushProvider(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[APNSPushProvider, FCMPushProvider]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[APNSPushProvider, FCMPushProvider]]:
        """Create an instance of PushProvider from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'APNS':
            return import_module("openapi_client.models.apns_push_provider").APNSPushProvider.from_dict(obj)
        if object_type ==  'FCM':
            return import_module("openapi_client.models.fcm_push_provider").FCMPushProvider.from_dict(obj)
