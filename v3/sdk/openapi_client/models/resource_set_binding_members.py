...
class ResourceSetBindingMembers(BaseModel):
    ...
    """ # noqa: E501
    members: Optional[conlist(ResourceSetBindingMember)] = None
    links: Optional[ResourceSetBindingMembersLinks] = Field(None, alias="_links")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "members": [ResourceSetBindingMember.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None,
