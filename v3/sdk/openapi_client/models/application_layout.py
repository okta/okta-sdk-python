...
class ApplicationLayout(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["elements", "label", "options", "rule", "scope", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rule": ApplicationLayoutRule.from_dict(obj["rule"]) if obj.get("rule") is not None else None,
            "scope": obj.get("scope"),
            "type": obj.get("type")
        })
        return _obj
