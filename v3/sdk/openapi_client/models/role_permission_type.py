...
class RolePermissionType(str, Enum):
    ...
    OKTA_DOT_GOVERNANCE_DOT_ACCESS_CERTIFICATIONS_DOT_MANAGE = 'okta.governance.accessCertifications.manage'
    OKTA_DOT_GOVERNANCE_DOT_ACCESS_REQUESTS_DOT_MANAGE = 'okta.governance.accessRequests.manage'
    ...
    OKTA_DOT_USERS_DOT_CREDENTIALS_DOT_EXPIRE_PASSWORD = 'okta.users.credentials.expirePassword'
    OKTA_DOT_USERS_DOT_CREDENTIALS_DOT_MANAGE = 'okta.users.credentials.manage'
    OKTA_DOT_USERS_DOT_CREDENTIALS_DOT_RESET_FACTORS = 'okta.users.credentials.resetFactors'
    OKTA_DOT_USERS_DOT_CREDENTIALS_DOT_RESET_PASSWORD = 'okta.users.credentials.resetPassword'
    ...
    OKTA_DOT_USERS_DOT_LIFECYCLE_DOT_CLEAR_SESSIONS = 'okta.users.lifecycle.clearSessions'
