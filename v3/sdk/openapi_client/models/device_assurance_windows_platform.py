...
class DeviceAssuranceWindowsPlatform(DeviceAssurance):
    ...
    third_party_signal_providers: Optional[DeviceAssuranceWindowsPlatformAllOfThirdPartySignalProviders] = Field(None, alias="thirdPartySignalProviders")
    __properties: ClassVar[List[str]] = ["createdBy", "createdDate", "id", "lastUpdatedBy", "lastUpdatedDate", "name", "platform", "_links", "diskEncryptionType", "jailbreak", "osVersion", "screenLockType", "secureHardwarePresent", "thirdPartySignalProviders"]
