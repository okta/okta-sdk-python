...
class UserCondition(BaseModel):
    ...
    """ # noqa: E501
    exclude: Optional[conlist(StrictStr)] = Field(None, description="Users to be excluded")
    include: Optional[conlist(StrictStr)] = Field(None, description="Users to be included")
