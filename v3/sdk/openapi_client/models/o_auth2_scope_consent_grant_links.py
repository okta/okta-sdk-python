...
class OAuth2ScopeConsentGrantLinks(BaseModel):
    ...
    app: Optional[HrefObject] = Field(None, description="Link to app")
    client: Optional[HrefObject] = Field(None, description="Link to client")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "app": HrefObject.from_dict(obj["app"]) if obj.get("app") is not None else None,
            "client": HrefObject.from_dict(obj["client"]) if obj.get("client") is not None else None
        })
        return _obj
