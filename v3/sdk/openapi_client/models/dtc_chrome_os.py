...
class DTCChromeOS(BaseModel):
    ...
    """ # noqa: E501
    allow_screen_lock: Optional[StrictBool] = Field(None, alias="allowScreenLock", description="Indicates whether the AllowScreenLock enterprise policy is enabled")
    ...
    key_trust_level: Optional[KeyTrustLevelOSMode] = Field(None, alias="keyTrustLevel")
