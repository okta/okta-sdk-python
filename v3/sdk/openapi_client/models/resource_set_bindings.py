...
class ResourceSetBindings(BaseModel):
    ...
    ResourceSetBindings
    """ # noqa: E501
    roles: Optional[conlist(ResourceSetBindingRole)] = None
    links: Optional[ResourceSetBindingResponseLinks] = Field(None, alias="_links")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "roles": [ResourceSetBindingRole.from_dict(_item) for _item in obj["roles"]] if obj.get("roles") is not None else None,
