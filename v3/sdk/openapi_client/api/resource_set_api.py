...
class ResourceSetApi:
    ...
    def add_members_to_binding(
        ...
        _param = self._add_members_to_binding_serialize(
    ...
    def add_members_to_binding_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResourceSetBindingResponse]:
        """Add more Members to a binding
    ...
    def add_resource_set_resource(
        ...
        _param = self._add_resource_set_resource_serialize(
            resource_set_id=resource_set_id,
            instance=instance,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def create_resource_set(
        ...
        _param = self._create_resource_set_serialize(
            instance=instance,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def create_resource_set_with_http_info(
        self,
        instance: CreateResourceSetRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_resource_set_without_preload_content(
        self,
        instance: CreateResourceSetRequest,
        _request_timeout: Union[
            None,
    ...
    def create_resource_set_binding(
        ...
        _param = self._create_resource_set_binding_serialize(
            resource_set_id=resource_set_id,
            instance=instance,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def delete_resource_set(
        ...
        _param = self._delete_resource_set_serialize(
            resource_set_id=resource_set_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def delete_resource_set_resource(
        ...
        _param = self._delete_resource_set_resource_serialize(
            resource_set_id=resource_set_id,
    ...
    def get_member_of_binding(
        ...
        _param = self._get_member_of_binding_serialize(
            resource_set_id=resource_set_id,
            role_id_or_label=role_id_or_label,
            member_id=member_id,
            _request_auth=_request_auth,
    ...
    def get_member_of_binding_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResourceSetBindingMember]:
        """Retrieve a Member of a binding
    ...
    def get_resource_set(
        ...
        _param = self._get_resource_set_serialize(
            resource_set_id=resource_set_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def list_bindings(
        ...
        _param = self._list_bindings_serialize(
            resource_set_id=resource_set_id,
            after=after,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def list_bindings_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResourceSetBindings]:
        """List all Bindings
    ...
    def list_members_of_binding(
        ...
        _param = self._list_members_of_binding_serialize(
            resource_set_id=resource_set_id,
            role_id_or_label=role_id_or_label,
            after=after,
            _request_auth=_request_auth,
    ...
    def list_members_of_binding_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResourceSetBindingMembers]:
        """List all Members of a binding
    ...
    def list_resource_set_resources(
        ...
        _param = self._list_resource_set_resources_serialize(
            resource_set_id=resource_set_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def list_resource_set_resources_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResourceSetResources]:
        """List all Resources of a Resource Set
    ...
    def list_resource_sets(
        ...
        _param = self._list_resource_sets_serialize(
            after=after,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def list_resource_sets_with_http_info(
        self,
        after: Annotated[Optional[StrictStr], Field(description="The cursor to use for pagination. It is an opaque string that specifies your current location in the list and is obtained from the `Link` response header. See [Pagination](/#pagination) for more information.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def list_resource_sets_without_preload_content(
        self,
        after: Annotated[Optional[StrictStr], Field(description="The cursor to use for pagination. It is an opaque string that specifies your current location in the list and is obtained from the `Link` response header. See [Pagination](/#pagination) for more information.")] = None,
        _request_timeout: Union[
            None,
    ...
    def replace_resource_set(
        ...
        _param = self._replace_resource_set_serialize(
            resource_set_id=resource_set_id,
            instance=instance,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def unassign_member_from_binding(
        ...
        _param = self._unassign_member_from_binding_serialize(
            resource_set_id=resource_set_id,
            role_id_or_label=role_id_or_label,
            member_id=member_id,
            _request_auth=_request_auth,
