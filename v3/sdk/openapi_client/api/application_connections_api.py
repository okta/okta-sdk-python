...
class ApplicationConnectionsApi:
    ...
    def activate_default_provisioning_connection_for_application(
        ...
        _param = self._activate_default_provisioning_connection_for_application_serialize(
            app_id=app_id,
    ...
    def deactivate_default_provisioning_connection_for_application(
        ...
        _param = self._deactivate_default_provisioning_connection_for_application_serialize(
            app_id=app_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def get_default_provisioning_connection_for_application(
        ...
        _param = self._get_default_provisioning_connection_for_application_serialize(
            app_id=app_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def get_default_provisioning_connection_for_application_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProvisioningConnection]:
        """Retrieve the default Provisioning Connection
    ...
    def update_default_provisioning_connection_for_application(
        ...
        _param = self._update_default_provisioning_connection_for_application_serialize(
            app_id=app_id,
