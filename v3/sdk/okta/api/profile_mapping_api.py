...
class ProfileMappingApi:
    ...
    def get_profile_mapping(
        ...
        _param = self._get_profile_mapping_serialize(
    ...
    def list_profile_mappings(
        ...
        _param = self._list_profile_mappings_serialize(
            after=after,
            limit=limit,
            source_id=source_id,
            target_id=target_id,
    ...
    @validate_call
    def list_profile_mappings_with_http_info(
        self,
        after: Annotated[Optional[StrictStr], Field(description="Mapping `id` that specifies the pagination cursor for the next page of mappings")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Specifies the number of results per page (maximum 200)")] = None,
        source_id: Annotated[Optional[StrictStr], Field(description="The UserType or App Instance `id` that acts as the source of expressions in a mapping. If this parameter is included, all returned mappings have this as their `source.id`.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ListProfileMappings]]:
        """List all Profile Mappings
    ...
    @validate_call
    def list_profile_mappings_without_preload_content(
        self,
        after: Annotated[Optional[StrictStr], Field(description="Mapping `id` that specifies the pagination cursor for the next page of mappings")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Specifies the number of results per page (maximum 200)")] = None,
        source_id: Annotated[Optional[StrictStr], Field(description="The UserType or App Instance `id` that acts as the source of expressions in a mapping. If this parameter is included, all returned mappings have this as their `source.id`.")] = None,
    ...
    def update_profile_mapping(
        ...
        _param = self._update_profile_mapping_serialize(
            mapping_id=mapping_id,
