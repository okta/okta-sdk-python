...
class VerifyUserFactorResponseLinks(BaseModel):
    """
    VerifyUserFactorResponseLinks
    """ # noqa: E501
    var_self: Optional[HrefObjectSelfLink] = Field(default=None, alias="self")
    poll: Optional[HrefObject] = None
    cancel: Optional[HrefObject] = None
    __properties: ClassVar[List[str]] = ["self", "poll", "cancel"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "poll": HrefObject.from_dict(obj["poll"]) if obj.get("poll") is not None else None,
