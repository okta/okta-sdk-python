...
class OAuth2Token(object):
    ...
    def __init__(self, embedded=None, links=None, client_id=None, created=None, expires_at=None, id=None, issuer=None, last_updated=None, scopes=None, status=None, user_id=None):  # noqa: E501
