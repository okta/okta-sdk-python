...
class SwaApplicationSettingsApplication(object):
    ...
    def __init__(self, button_field=None, login_url_regex=None, password_field=None, url=None, username_field=None):  # noqa: E501
