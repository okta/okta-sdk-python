...
class WsFederationApplicationSettingsApplication(object):
    ...
    def __init__(self, attribute_statements=None, audience_restriction=None, authn_context_class_ref=None, group_filter=None, group_name=None, group_value_format=None, name_id_format=None, realm=None, site_url=None, username_attribute=None, w_reply_override=None, w_reply_url=None):  # noqa: E501
