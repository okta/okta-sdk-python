...
class SwaThreeFieldApplicationSettingsApplication(object):
    ...
    def __init__(self, button_selector=None, extra_field_selector=None, extra_field_value=None, login_url_regex=None, password_selector=None, target_url=None, user_name_selector=None):  # noqa: E501
