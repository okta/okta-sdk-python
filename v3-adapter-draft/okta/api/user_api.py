...
class User(object):
    ...
    def assign_role_to_user(self, body, user_id, **kwargs):  # noqa: E501
        ...
        :param str user_id: (required)
        :param str disable_notifications:
        :return: Role
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def deactivate_user(self, user_id, **kwargs):  # noqa: E501
        ...
        Deactivates a user.  This operation can only be performed on users that do not have a `DEPROVISIONED` status.  Deactivation of a user is an asynchronous operation.  The user will have the `transitioningToStatus` property with a value of `DEPROVISIONED` during deactivation to indicate that the user hasn't completed the asynchronous operation.  The user will have a status of `DEPROVISIONED` when the deactivation process is complete.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
