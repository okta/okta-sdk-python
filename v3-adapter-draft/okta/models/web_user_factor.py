...
class WebUserFactor(UserFactor):
    ...
    @property
    def profile(self):
        """Gets the profile of this WebUserFactor.  # noqa: E501


        :return: The profile of this WebUserFactor.  # noqa: E501
        :rtype: WebUserFactorProfile
        """
        return self._profile

    @profile.setter
    def profile(self, profile):
        """Sets the profile of this WebUserFactor.


        :param profile: The profile of this WebUserFactor.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WebUserFactor, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WebUserFactor):
            return False
