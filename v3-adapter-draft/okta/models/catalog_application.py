...
class CatalogApplication(object):
    ...
    def __init__(self, id=None, name=None, display_name=None, description=None, status=None, last_updated=None, category=None, verification_status=None, website=None, sign_on_modes=None, features=None, links=None):  # noqa: E501
