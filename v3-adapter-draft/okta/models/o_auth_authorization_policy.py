...
class OAuthAuthorizationPolicy(Policy):
    ...
    def set_attributes(self, *args, **kwargs):  # noqa: E501
        """OAuthAuthorizationPolicy - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OAuthAuthorizationPolicy, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OAuthAuthorizationPolicy):
            return False
