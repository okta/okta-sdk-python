...
class UserRequestSchema(BaseModel):
    ...
    UserRequestSchema
    """ # noqa: E501
    external_id: Optional[Annotated[str, Field(strict=True, max_length=512)]] = Field(default=None, description="The external ID of the user in the identity source", alias="externalId")
