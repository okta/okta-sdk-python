...
class IdPCsrLinks(BaseModel):
    """
    IdPCsrLinks
    """  # noqa: E501
    var_self: Optional[HrefObjectSelfLink] = Field(default=None, alias="self")
    publish: Optional[HrefObject] = Field(default=None, description="Publish the CSR")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["self", "publish"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "publish": HrefObject.from_dict(obj["publish"]) if obj.get("publish") is not None else None
        })
