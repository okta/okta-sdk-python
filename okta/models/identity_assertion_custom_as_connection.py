...
class IdentityAssertionCustomASConnection(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["authorizationServer", "connectionType", "id", "orn", "protocolType", "resourceIndicator", "scopeCondition", "scopes", "status", "_links"]

    @field_validator('connection_type')
    def connection_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['IDENTITY_ASSERTION_CUSTOM_AS']):
            raise ValueError("must be one of enum values ('IDENTITY_ASSERTION_CUSTOM_AS')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "authorizationServer": CustomAuthorizationServer.from_dict(obj["authorizationServer"]) if obj.get("authorizationServer") is not None else None,
