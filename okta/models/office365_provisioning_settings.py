...
class Office365ProvisioningSettings(BaseModel):
    ...
    admin_password: StrictStr = Field(
        description="Microsoft Office 365 global administrator password", alias="adminPassword"
    )
    admin_username: StrictStr = Field(
        description="Microsoft Office 365 global administrator username", alias="adminUsername"
    )
