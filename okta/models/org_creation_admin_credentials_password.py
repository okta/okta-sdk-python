...
class OrgCreationAdminCredentialsPassword(BaseModel):
    ...
    see [Configure the password authenticator](https://help.okta.com/okta_help.htm?type=oie&id=ext-configure-password) in
    the help documentation.
    """  # noqa: E501
    value: Optional[SecretStr] = Field(
        default=None, description="Password value (which is validated by the password policy)"
    )
