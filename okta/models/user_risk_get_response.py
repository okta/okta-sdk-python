...
class UserRiskGetResponse(BaseModel):
    ...
    __discriminator_property_name: ClassVar[str] = 'riskLevel'

    # discriminator mappings
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'HIGH': 'UserRiskLevelExists', 'LOW': 'UserRiskLevelExists', 'MEDIUM': 'UserRiskLevelExists',
    ...
    UserRiskLevelExists, UserRiskLevelExists, UserRiskLevelNone]]:
        ...
        if object_type == 'UserRiskLevelExists':
            return import_module("okta.models.user_risk_level_exists").UserRiskLevelExists.from_dict(obj)
        if object_type == 'UserRiskLevelExists':
            return import_module("okta.models.user_risk_level_exists").UserRiskLevelExists.from_dict(obj)
        if object_type == 'UserRiskLevelExists':
            return import_module("okta.models.user_risk_level_exists").UserRiskLevelExists.from_dict(obj)
