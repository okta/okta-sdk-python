...
class AuthenticationMethodChainMethod(VerificationMethod):
    ...
    reauthenticate_in: Optional[StrictStr] = Field(
        ...
        "For example, `PT2H30M` for two and a half hours. Don't set this parameter if you're setting the "
        ...
        _obj = cls.model_validate(
            {
                ...
                "chains": (
                    [
                        AuthenticationMethodChain.from_dict(_item)
                        for _item in obj["chains"]
                    ]
                    if obj.get("chains") is not None
                    else None
                ),
