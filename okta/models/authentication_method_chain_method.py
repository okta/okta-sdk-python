...
class AuthenticationMethodChainMethod(VerificationMethod):
    ...
    chains: Optional[List[AuthenticationMethodChain]] = Field(
        default=None,
        description="Authentication method chains. Only supports 5 items in the array. Each chain can support maximum 3 "
                    "steps."
    )
    reauthenticate_in: Optional[StrictStr] = Field(
        default=None,
        description="Specifies how often the user is prompted for authentication using duration format for the time "
                    "period. For example, `PT2H30M` for two and a half hours. Don't set this parameter if you're setting "
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "type": obj.get("type"),
                "chains": [AuthenticationMethodChain.from_dict(_item) for _item in obj["chains"]] if obj.get(
                    "chains"
