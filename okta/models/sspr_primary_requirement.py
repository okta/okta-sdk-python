...
class SsprPrimaryRequirement(BaseModel):
    ...
    def methods_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['push', 'sms', 'voice', 'email', 'otp']):
                raise ValueError("each list item must be one of ('push', 'sms', 'voice', 'email', 'otp')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "methodConstraints": [AuthenticatorMethodConstraint.from_dict(_item) for _item in
                                      obj["methodConstraints"]] if obj.get("methodConstraints") is not None else None,
