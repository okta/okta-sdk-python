...
class GroupPushMapping(BaseModel):
    ...
    created: Optional[datetime] = Field(
        default=None, description="Timestamp when the group push mapping was created"
    )
    ...
    id: Optional[StrictStr] = Field(
        default=None, description="The ID of the group push mapping"
    )
