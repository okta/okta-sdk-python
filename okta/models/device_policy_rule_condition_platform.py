...
class DevicePolicyRuleConditionPlatform(BaseModel):
    ...
    supported_mdm_frameworks: Optional[List[DevicePolicyMDMFramework]] = Field(
        default=None, alias="supportedMDMFrameworks"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "supportedMDMFrameworks": obj.get("supportedMDMFrameworks"),
                "types": obj.get("types"),
            }
        )
        return _obj
