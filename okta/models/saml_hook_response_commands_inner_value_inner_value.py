...
class SAMLHookResponseCommandsInnerValueInnerValue(BaseModel):
    ...
    Simple value (integer or string)  `\"value\": 300` or `\"value\": \"replacementString\"`  #### Attribute value (object)
    ` \"value\": {     \"authContextClassRef\": \"replacementValue\"   }`  #### AttributeValues array value (object)  `
    \"value\": {     \"attributes\": {       \"NameFormat\": \"urn:oasis:names:tc:SAML:2.0:attrname-format:basic\"     },
     \"attributeValues\": [       {\"attributes\": {         \"xsi:type\": \"xs:string\"       },       \"value\": \"4321\"}
           ]     }`
    """
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        try:
            instance = SAMLHookResponseCommandsInnerValueInnerValue.model_construct()
        ...
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when setting `actual_instance` in SAMLHookResponseCommandsInnerValueInnerValue with "
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when deserializing the JSON string into SAMLHookResponseCommandsInnerValueInnerValue "
