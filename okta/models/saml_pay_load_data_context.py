...
class SAMLPayLoadDataContext(BaseModel):
    ...
    protocol: Optional[SAMLPayLoadDataContextAllOfProtocol] = None
    __properties: ClassVar[List[str]] = ["request", "session", "user", "protocol"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "protocol": (
                    SAMLPayLoadDataContextAllOfProtocol.from_dict(obj["protocol"])
