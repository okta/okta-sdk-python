...
class SwaApplicationSettings(ApplicationSettings):
    ...
    swagger_types['app'] = 'SwaApplicationSettingsApplication'
    ...
    def set_attributes(self, app=None, **kwargs):  # noqa: E501
        """SwaApplicationSettings - a model defined in Swagger"""  # noqa: E501
        config = {}
    ...
    @property
    def app(self):
        """Gets the app of this SwaApplicationSettings.  # noqa: E501


        :return: The app of this SwaApplicationSettings.  # noqa: E501
        :rtype: SwaApplicationSettingsApplication
        """
        return self._app

    @app.setter
    def app(self, app):
        """Sets the app of this SwaApplicationSettings.


        :param app: The app of this SwaApplicationSettings.  # noqa: E501
    ...
    def as_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SwaApplicationSettings, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SwaApplicationSettings):
            return False
