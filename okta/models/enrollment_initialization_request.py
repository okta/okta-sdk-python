...
class EnrollmentInitializationRequest(BaseModel):
    ...
    yubico_transport_key_jwk: Optional[ECKeyJWK] = Field(
        default=None, alias="yubicoTransportKeyJWK"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of yubico_transport_key_jwk
        if self.yubico_transport_key_jwk:
            if not isinstance(self.yubico_transport_key_jwk, dict):
                _dict["yubicoTransportKeyJWK"] = self.yubico_transport_key_jwk.to_dict()
            else:
                _dict["yubicoTransportKeyJWK"] = self.yubico_transport_key_jwk
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "enrollmentRpIds": obj.get("enrollmentRpIds"),
                "fulfillmentProvider": obj.get("fulfillmentProvider"),
                "userId": obj.get("userId"),
                "yubicoTransportKeyJWK": (
                    ECKeyJWK.from_dict(obj["yubicoTransportKeyJWK"])
                    if obj.get("yubicoTransportKeyJWK") is not None
                    else None
                ),
            }
        )
