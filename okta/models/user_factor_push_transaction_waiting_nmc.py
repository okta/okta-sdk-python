...
class UserFactorPushTransactionWaitingNMC(UserFactorPushTransaction):
    ...
    __properties: ClassVar[List[str]] = ["factorResult", "profile", "_embedded", "_links"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "_embedded": NumberFactorChallengeEmbeddedLinks.from_dict(obj["_embedded"]) if obj.get(
                    "_embedded"
                ) is not None else None,
                "_links": UserFactorPushTransactionWaitingNMCAllOfLinks.from_dict(obj["_links"]) if obj.get(
                    "_links"
                ) is not None else None
            }
        )
