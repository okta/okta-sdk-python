...
class UserFactorPushTransactionWaitingNMC(UserFactorPushTransaction):
    ...
    embedded: Optional[NumberFactorChallengeEmbeddedLinks] = Field(
        default=None, alias="_embedded"
    )
    links: Optional[UserFactorPushTransactionWaitingNMCAllOfLinks] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "_embedded": (
                    NumberFactorChallengeEmbeddedLinks.from_dict(obj["_embedded"])
                    if obj.get("_embedded") is not None
                    else None
                ),
                "_links": (
                    UserFactorPushTransactionWaitingNMCAllOfLinks.from_dict(
                        obj["_links"]
                    )
