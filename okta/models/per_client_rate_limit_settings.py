...
class PerClientRateLimitSettings(BaseModel):
    ...
    use_case_mode_overrides: Optional[
        PerClientRateLimitSettingsUseCaseModeOverrides
    ] = Field(default=None, alias="useCaseModeOverrides")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of use_case_mode_overrides
        if self.use_case_mode_overrides:
            if not isinstance(self.use_case_mode_overrides, dict):
                _dict["useCaseModeOverrides"] = self.use_case_mode_overrides.to_dict()
            else:
                _dict["useCaseModeOverrides"] = self.use_case_mode_overrides
        ...
        _obj = cls.model_validate(
            {
                ...
                "useCaseModeOverrides": (
                    PerClientRateLimitSettingsUseCaseModeOverrides.from_dict(
                        obj["useCaseModeOverrides"]
                    )
                    if obj.get("useCaseModeOverrides") is not None
                    else None
                ),
            }
        )
