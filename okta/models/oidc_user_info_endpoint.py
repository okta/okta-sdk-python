...
class OidcUserInfoEndpoint(BaseModel):
    """
    Endpoint for getting identity information about the user. For more information on the `/userinfo` endpoint, see [OpenID
    ...
    url: Optional[StrictStr] = Field(
        default=None, description="URL of the resource server's `/userinfo` endpoint"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"binding": obj.get("binding"), "url": obj.get("url")}
        )
        return _obj
