...
class OINApplication(BaseModel):
    ...
    label: Optional[StrictStr] = Field(
        default=None, description="User-defined display name for app"
    )
    licensing: Optional[ApplicationLicensing] = None
    name: Optional[StrictStr] = Field(
        default=None, description="The key name for the OIN app definition"
    )
    ...
    sign_on_mode: Optional[StrictStr] = Field(
        default=None, description="Authentication mode for the app", alias="signOnMode"
    )
