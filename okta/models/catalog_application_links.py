...
class CatalogApplicationLinks(BaseModel):
    ...
    Application Language](https://datatracker.ietf.org/doc/html/draft-kelly-json-hal-06) specification
    """  # noqa: E501

    logo: Optional[List[HrefObjectLogoLink]] = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "logo": (
                    [HrefObjectLogoLink.from_dict(_item) for _item in obj["logo"]]
