...
class TestInfoScimTestConfiguration(BaseModel):
    ...
    spec_test_results: Annotated[str, Field(strict=True, max_length=512)] = Field(
        description="The Runscope URL to your SCIM server specification test results. See [Test your SCIM API]("
        "https://developer.okta.com/docs/guides/build-provisioning-integration/test-scim-api/).",
        alias="specTestResults",
    )
    crud_test_results: Annotated[str, Field(strict=True, max_length=512)] = Field(
        description="The Runscope URL to your Okta SCIM CRUD test results. See [Test your Okta SCIM integration]("
        "https://developer.okta.com/docs/guides/scim-provisioning-integration-test/main/).",
        alias="crudTestResults",
    )
    entitlements_test_results: Optional[
        Annotated[str, Field(strict=True, max_length=512)]
    ] = Field(
        default=None,
        description="The Runscope URL to your entitlements test results",
        alias="entitlementsTestResults",
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "specTestResults": obj.get("specTestResults"),
                "crudTestResults": obj.get("crudTestResults"),
