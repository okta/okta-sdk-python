...
class CreateGroupPushMappingRequest(BaseModel):
    ...
    target_group_name: Optional[StrictStr] = Field(
        ...
        "group. If the group already exists, it links to the existing group. Required if `targetGroupId` is not "
        "provided.",
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "appConfig": (
                    AppConfig.from_dict(obj["appConfig"])
                    if obj.get("appConfig") is not None
                    else None
                ),
