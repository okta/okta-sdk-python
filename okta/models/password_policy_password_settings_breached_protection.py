...
class PasswordPolicyPasswordSettingsBreachedProtection(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.delegated_workflow_id is None and "delegated_workflow_id" in self.model_fields_set:
            _dict['delegatedWorkflowId'] = None

        # set to None if expire_after_days (nullable) is None
        # and model_fields_set contains the field
        if self.expire_after_days is None and "expire_after_days" in self.model_fields_set:
