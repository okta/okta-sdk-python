...
class UserRiskPutResponse(BaseModel):
    ...
    reason: Optional[StrictStr] = Field(
        default=None, description="Describes the risk level for the user"
    )
    ...
    __properties: ClassVar[List[str]] = ["reason", "riskLevel", "_links"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "_links": (
                    UserRiskGetResponseLinks.from_dict(obj["_links"])
