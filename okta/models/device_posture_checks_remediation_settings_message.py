...
class DevicePostureChecksRemediationSettingsMessage(BaseModel):
    ...
    default_i18n_key: Optional[StrictStr] = Field(
        default=None,
        description="Default i18n key for the message. This property is only relevant if type is set to `BUILTIN`. If type "
        "is set to `CUSTOM`, this field is ignored.",
        alias="defaultI18nKey",
    )
    custom_text: Optional[StrictStr] = Field(
        default=None, description="Custom text for the message", alias="customText"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "defaultI18nKey": obj.get("defaultI18nKey"),
