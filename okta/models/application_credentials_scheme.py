...
class ApplicationCredentialsScheme(object):
    ...
    def set_attributes(self):  # noqa: E501
        """ApplicationCredentialsScheme - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ApplicationCredentialsScheme, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApplicationCredentialsScheme):
            return False
