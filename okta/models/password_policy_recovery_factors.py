...
class PasswordPolicyRecoveryFactors(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "okta_call": PasswordPolicyRecoveryFactorSettings.from_dict(obj["okta_call"]) if obj.get(
                    "okta_call"
                ) is not None else None,
                "okta_email": PasswordPolicyRecoveryEmail.from_dict(obj["okta_email"]) if obj.get(
                    "okta_email"
                ) is not None else None,
                "okta_sms": PasswordPolicyRecoveryFactorSettings.from_dict(obj["okta_sms"]) if obj.get(
                    "okta_sms"
                ) is not None else None,
                "recovery_question": PasswordPolicyRecoveryQuestion.from_dict(obj["recovery_question"]) if obj.get(
                    "recovery_question"
                ) is not None else None
            }
        )
