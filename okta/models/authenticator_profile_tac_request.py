...
class AuthenticatorProfileTacRequest(BaseModel):
    ...
    ttl: Optional[StrictStr] = Field(
        ...
        "activated. The configured value must be between 10 minutes (`10`) and 10 days (`14400`), inclusive. The "
        "actual allowed range depends on the org-level authenticator configuration.",
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"multiUse": obj.get("multiUse"), "ttl": obj.get("ttl")}
        )
        return _obj
