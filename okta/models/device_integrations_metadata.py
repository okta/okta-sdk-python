...
class DeviceIntegrationsMetadata(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, DeviceIntegrationsMetadataOneOf):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `DeviceIntegrationsMetadataOneOf`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, DeviceIntegrationsMetadataOneOf1):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `DeviceIntegrationsMetadataOneOf1`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, DeviceIntegrationsMetadataOneOf2):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `DeviceIntegrationsMetadataOneOf2`"
            )
        else:
            match += 1
        if match > 1:
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            instance.actual_instance = DeviceIntegrationsMetadataOneOf.from_json(
                json_str
            )
            match += 1
        ...
        try:
            instance.actual_instance = DeviceIntegrationsMetadataOneOf1.from_json(
                json_str
            )
            match += 1
        except (ValidationError, ValueError) as e:
        ...
        try:
            instance.actual_instance = DeviceIntegrationsMetadataOneOf2.from_json(
                json_str
            )
            match += 1
        except (ValidationError, ValueError) as e:
