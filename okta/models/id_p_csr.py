...
class IdPCsr(BaseModel):
    ...
    csr: Optional[StrictStr] = Field(
        default=None, description="Base64-encoded CSR in DER format"
    )
    id: Optional[StrictStr] = Field(
        default=None, description="Unique identifier for the CSR"
    )
    kty: Optional[StrictStr] = Field(
        default=None, description="Cryptographic algorithm family for the CSR's keypair"
    )
    links: Optional[IdPCsrLinks] = Field(default=None, alias="_links")
        ...
        _obj = cls.model_validate(
            {
                ...
                "kty": obj.get("kty"),
                "_links": (
                    IdPCsrLinks.from_dict(obj["_links"])
