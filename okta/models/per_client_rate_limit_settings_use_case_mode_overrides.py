...
class PerClientRateLimitSettingsUseCaseModeOverrides(BaseModel):
    """
    A map of Per-Client Rate Limit Use Case to the applicable PerClientRateLimitMode. Overrides the `defaultMode` property
    for the specified use cases.
    """  # noqa: E501

    login_page: Optional[PerClientRateLimitMode] = Field(
        default=None, alias="LOGIN_PAGE"
    )
    oauth2_authorize: Optional[PerClientRateLimitMode] = Field(
        default=None, alias="OAUTH2_AUTHORIZE"
    )
    oie_app_intent: Optional[PerClientRateLimitMode] = Field(
        default=None, alias="OIE_APP_INTENT"
    )
