...
class InlineHookOAuthClientSecretConfigCreate(BaseModel):
    """
    InlineHookOAuthClientSecretConfigCreate
    """ # noqa: E501
    client_secret: Optional[StrictStr] = Field(default=None, description="A private value provided by the service used to authenticate the identity of the app to the service", alias="clientSecret")
    method: Optional[StrictStr] = Field(default=None, description="The method of the Okta inline hook request. Only accepts `POST`.")
