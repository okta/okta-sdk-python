...
class ScimScimServerConfigChangePassword(BaseModel):
    """
    Password change options
    """  # noqa: E501

    supported: Optional[StrictBool] = Field(
        default=False, description="Specifies if password change is supported"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "supported": (
                    obj.get("supported") if obj.get("supported") is not None else False
                )
            }
        )
        return _obj
