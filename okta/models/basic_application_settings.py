...
class BasicApplicationSettings(ApplicationSettings):
    ...
    swagger_types['app'] = 'BasicApplicationSettingsApplication'
    ...
    def set_attributes(self, app=None, **kwargs):  # noqa: E501
        """BasicApplicationSettings - a model defined in Swagger"""  # noqa: E501
        config = {}
    ...
    @property
    def app(self):
        """Gets the app of this BasicApplicationSettings.  # noqa: E501


        :return: The app of this BasicApplicationSettings.  # noqa: E501
        :rtype: BasicApplicationSettingsApplication
        """
        return self._app

    @app.setter
    def app(self, app):
        """Sets the app of this BasicApplicationSettings.


        :param app: The app of this BasicApplicationSettings.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BasicApplicationSettings, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BasicApplicationSettings):
            return False
