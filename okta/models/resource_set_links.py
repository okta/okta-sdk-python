...
class ResourceSetLinks(BaseModel):
    """
    ResourceSetLinks
    """ # noqa: E501
    var_self: Optional[HrefObjectSelfLink] = Field(default=None, alias="self")
    resources: Optional[HrefObjectResourceSetResourcesLink] = None
    bindings: Optional[HrefObjectBindingsLink] = None
    __properties: ClassVar[List[str]] = ["self", "resources", "bindings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resources": HrefObjectResourceSetResourcesLink.from_dict(obj["resources"]) if obj.get("resources") is not None else None,
