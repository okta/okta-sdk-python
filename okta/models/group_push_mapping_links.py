...
class GroupPushMappingLinks(BaseModel):
    ...
    source_group: Optional[HrefObjectGroupLink] = Field(
        default=None, alias="sourceGroup"
    )
    target_group: Optional[HrefObjectGroupLink] = Field(
        default=None, alias="targetGroup"
    )
    __properties: ClassVar[List[str]] = ["app", "sourceGroup", "targetGroup"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "sourceGroup": (
                    HrefObjectGroupLink.from_dict(obj["sourceGroup"])
                    if obj.get("sourceGroup") is not None
                    else None
                ),
                "targetGroup": (
                    HrefObjectGroupLink.from_dict(obj["targetGroup"])
                    if obj.get("targetGroup") is not None
                    else None
                ),
            }
        )
