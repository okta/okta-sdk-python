...
class AttackProtectionAuthenticatorSettings(BaseModel):
    ...
    verify_knowledge_second_when2fa_required: Optional[StrictBool] = Field(
        default=False,
        description="If true, requires users to verify a possession factor before verifying a knowledge factor when the "
                    "assurance requires two-factor authentication (2FA).",
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "verifyKnowledgeSecondWhen2faRequired": obj.get("verifyKnowledgeSecondWhen2faRequired") if obj.get(
