...
class BulkGroupMembershipsUpsertRequestBody(BaseModel):
    ...
    memberships: Optional[
        Annotated[List[IdentitySourceGroupMembershipsUpsertProfileInner], Field(min_length=1, max_length=200)]] = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "memberships": [IdentitySourceGroupMembershipsUpsertProfileInner.from_dict(_item) for _item in
