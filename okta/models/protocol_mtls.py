...
class ProtocolMtls(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["credentials", "endpoints", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['MTLS']):
            raise ValueError("must be one of enum values ('MTLS')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "credentials": MtlsCredentials.from_dict(obj["credentials"]) if obj.get("credentials") is not None else None,
                "endpoints": MtlsEndpoints.from_dict(obj["endpoints"]) if obj.get("endpoints") is not None else None,
                "type": obj.get("type")
            }
        )
        return _obj
