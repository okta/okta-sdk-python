...
class UserFactorPush(UserFactor):
    """
    UserFactorPush
    """  # noqa: E501
    profile: Optional[UserFactorPushProfile] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "profile": UserFactorPushProfile.from_dict(obj["profile"]) if obj.get("profile") is not None else None,
