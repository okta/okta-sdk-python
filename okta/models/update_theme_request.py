...
class UpdateThemeRequest(BaseModel):
    ...
    email_template_touch_point_variant: EmailTemplateTouchPointVariant = Field(
    ...
    error_page_touch_point_variant: ErrorPageTouchPointVariant = Field(
    ...
    primary_color_hex: StrictStr = Field(
        description="Primary color hex code", alias="primaryColorHex"
    )
    ...
    secondary_color_hex: StrictStr = Field(
        description="Secondary color hex code", alias="secondaryColorHex"
    )
    sign_in_page_touch_point_variant: SignInPageTouchPointVariant = Field(
        alias="signInPageTouchPointVariant"
    )
