...
class LogStreamPutSchema(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[LogStreamAwsPutSchema, LogStreamSplunkPutSchema]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[LogStreamAwsPutSchema, LogStreamSplunkPutSchema]]:
