...
class OAuth2ClientSecretRequestBody(BaseModel):
    """
    ...
    status: Optional[StrictStr] = Field(
        default=None, description="Status of the OAuth 2.0 Client Secret"
    )
    __properties: ClassVar[List[str]] = ["client_secret", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"client_secret": obj.get("client_secret"), "status": obj.get("status")}
        )
        return _obj
