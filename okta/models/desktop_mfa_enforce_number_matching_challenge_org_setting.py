...
class DesktopMFAEnforceNumberMatchingChallengeOrgSetting(BaseModel):
    ...
    desktop_mfa_enforce_number_matching_challenge_enabled: Optional[StrictBool] = Field(
        default=False,
        description="Indicates whether or not the Desktop MFA Enforce Number Matching Challenge push notifications feature "
                    "is enabled",
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "desktopMFAEnforceNumberMatchingChallengeEnabled": obj.get(
                    "desktopMFAEnforceNumberMatchingChallengeEnabled"
                ) if obj.get("desktopMFAEnforceNumberMatchingChallengeEnabled") is not None else False
            }
        )
        return _obj
