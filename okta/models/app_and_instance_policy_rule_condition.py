...
class AppAndInstancePolicyRuleCondition(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "exclude": [AppAndInstanceConditionEvaluatorAppOrInstance.from_dict(_item) for _item in
                            obj["exclude"]] if obj.get("exclude") is not None else None,
                "include": [AppAndInstanceConditionEvaluatorAppOrInstance.from_dict(_item) for _item in
                            obj["include"]] if obj.get("include") is not None else None
            }
        )
        return _obj
