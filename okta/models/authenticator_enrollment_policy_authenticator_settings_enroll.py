...
class AuthenticatorEnrollmentPolicyAuthenticatorSettingsEnroll(BaseModel):
    ...
    var_self: Optional[AuthenticatorEnrollmentPolicyAuthenticatorStatus] = Field(
        default=AuthenticatorEnrollmentPolicyAuthenticatorStatus.NOT_ALLOWED,
        alias="self",
    )
    grace_period: Optional[EnrollmentPolicyAuthenticatorGracePeriod] = Field(
        default=None, alias="gracePeriod"
    )
