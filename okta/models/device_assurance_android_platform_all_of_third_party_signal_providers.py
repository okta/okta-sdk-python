...
class DeviceAssuranceAndroidPlatformAllOfThirdPartySignalProviders(BaseModel):
    ...
    android_device_trust: Optional[AndroidDeviceTrust] = Field(
        default=None, alias="androidDeviceTrust"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of android_device_trust
        if self.android_device_trust:
            if not isinstance(self.android_device_trust, dict):
                _dict["androidDeviceTrust"] = self.android_device_trust.to_dict()
            else:
                _dict["androidDeviceTrust"] = self.android_device_trust
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "androidDeviceTrust": (
                    AndroidDeviceTrust.from_dict(obj["androidDeviceTrust"])
                    if obj.get("androidDeviceTrust") is not None
                    else None
                ),
                "devicePostureIdP": (
