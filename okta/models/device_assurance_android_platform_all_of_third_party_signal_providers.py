...
class DeviceAssuranceAndroidPlatformAllOfThirdPartySignalProviders(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "androidDeviceTrust": AndroidDeviceTrust.from_dict(obj["androidDeviceTrust"]) if obj.get(
                    "androidDeviceTrust"
                ) is not None else None,
                "devicePostureIdP": DevicePostureIdP.from_dict(obj["devicePostureIdP"]) if obj.get(
                    "devicePostureIdP"
                ) is not None else None
            }
        )
