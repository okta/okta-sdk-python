...
class AuthenticatorEnrollmentPolicyRule(PolicyRule):
    """
    AuthenticatorEnrollmentPolicyRule
    """  # noqa: E501
    actions: Optional[AuthenticatorEnrollmentPolicyRuleActions] = None
    conditions: Optional[AuthenticatorEnrollmentPolicyRuleConditions] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "actions": AuthenticatorEnrollmentPolicyRuleActions.from_dict(obj["actions"]) if obj.get("actions") is not None else None,
            "conditions": AuthenticatorEnrollmentPolicyRuleConditions.from_dict(obj["conditions"]) if obj.get("conditions") is not None else None
        })
        return _obj
