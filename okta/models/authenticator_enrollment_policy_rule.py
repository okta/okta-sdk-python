        ...
        _obj = cls.model_validate(
            {
                ...
                "actions": AuthenticatorEnrollmentPolicyRuleActions.from_dict(obj["actions"]) if obj.get(
                    "actions"
                ) is not None else None,
                "conditions": AuthenticatorEnrollmentPolicyRuleConditions.from_dict(obj["conditions"]) if obj.get(
                    "conditions"
                ) is not None else None
            }
        )
