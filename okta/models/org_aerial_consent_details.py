...
class OrgAerialConsentDetails(BaseModel):
    """
    OrgAerialConsentDetails
    """  # noqa: E501

    account_id: StrictStr = Field(
        description="The unique ID of the Aerial account", alias="accountId"
    )
    ...
    granted_date: Optional[StrictStr] = Field(
        default=None, description="Date when grant was created", alias="grantedDate"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "grantedDate": obj.get("grantedDate"),
                "_links": (
                    LinksAerialConsentGranted.from_dict(obj["_links"])
