...
class UserFactorSMSProfile(BaseModel):
    ...
    phone_number: Optional[Annotated[str, Field(strict=True, max_length=15)]] = Field(
        default=None,
        description="Phone number of the factor. You should format phone numbers to use the [E.164 standard]("
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"phoneNumber": obj.get("phoneNumber")})
        return _obj
