...
class RiscIdentifierChangedEvent(BaseModel):
    ...
    new_value: Optional[StrictStr] = Field(
        default=None, description="The new identifier value", alias="new-value"
    )
    subject: SecurityEventSubject
    __properties: ClassVar[List[str]] = ["event_timestamp", "new-value", "subject"]
