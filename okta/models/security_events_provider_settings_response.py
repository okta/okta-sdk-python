...
class SecurityEventsProviderSettingsResponse(BaseModel):
    ...
    issuer: Optional[Annotated[str, Field(strict=True, max_length=700)]] = Field(
        default=None, description="Issuer URL"
    )
    ...
    well_known_url: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = (
        Field(
            default=None,
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if well_known_url (nullable) is None
        # and model_fields_set contains the field
        if self.well_known_url is None and "well_known_url" in self.model_fields_set:
            _dict["well_known_url"] = None
