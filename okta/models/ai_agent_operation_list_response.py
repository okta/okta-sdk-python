...
class AIAgentOperationListResponse(BaseModel):
    ...
    links: Optional[AIAgentOperationListResponseLinks] = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": (
                    [AIAgentOperationResponse.from_dict(_item) for _item in obj["data"]]
                    if obj.get("data") is not None
                    else None
                ),
                "_links": (
                    AIAgentOperationListResponseLinks.from_dict(obj["_links"])
