...
class EntitlementTypesInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "endpoint", "attributes", "mappings"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "attributes": EntitlementTypesInnerAttributes.from_dict(obj["attributes"]) if obj.get(
                    "attributes"
                ) is not None else None,
                "mappings": EntitlementTypesInnerMappings.from_dict(obj["mappings"]) if obj.get(
                    "mappings"
                ) is not None else None
            }
        )
