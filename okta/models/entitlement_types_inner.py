...
class EntitlementTypesInner(BaseModel):
    ...
    description: Optional[StrictStr] = Field(
        default=None, description="Description of the entitlement type"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "attributes": (
                    EntitlementTypesInnerAttributes.from_dict(obj["attributes"])
                    if obj.get("attributes") is not None
                    else None
                ),
                "mappings": (
                    EntitlementTypesInnerMappings.from_dict(obj["mappings"])
