...
class Protocol(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "algorithms": ProtocolAlgorithms.from_dict(obj["algorithms"]) if obj.get("algorithms") is not None else None,
            "credentials": IdentityProviderCredentials.from_dict(obj["credentials"]) if obj.get("credentials") is not None else None,
            "endpoints": ProtocolEndpoints.from_dict(obj["endpoints"]) if obj.get("endpoints") is not None else None,
            "issuer": ProtocolEndpoint.from_dict(obj["issuer"]) if obj.get("issuer") is not None else None,
            "relayState": ProtocolRelayState.from_dict(obj["relayState"]) if obj.get("relayState") is not None else None,
            "scopes": obj.get("scopes"),
            "settings": ProtocolSettings.from_dict(obj["settings"]) if obj.get("settings") is not None else None,
            "type": obj.get("type")
        })
        return _obj
