...
class SecurityEventSubject(BaseModel):
    ...
    device: Optional[Dict[str, Any]] = Field(
        default=None, description="The device involved with the event"
    )
    user: Optional[Dict[str, Any]] = Field(
        default=None, description="The user involved with the event"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"device": obj.get("device"), "user": obj.get("user")}
        )
        return _obj
