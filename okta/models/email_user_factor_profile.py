...
class EmailUserFactorProfile(object):
    ...
    @property
    def email(self):
        """Gets the email of this EmailUserFactorProfile.  # noqa: E501


        :return: The email of this EmailUserFactorProfile.  # noqa: E501
        :rtype: str
        """
        return self._email
    ...
    def email(self, email):
        """Sets the email of this EmailUserFactorProfile.


        :param email: The email of this EmailUserFactorProfile.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EmailUserFactorProfile, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EmailUserFactorProfile):
            return False
