...
class ProvisioningConnectionProfile(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'OAUTH2': 'ProvisioningConnectionProfileOauth','TOKEN': 'ProvisioningConnectionProfileToken','UNKNOWN': 'ProvisioningConnectionProfileUnknown'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[ProvisioningConnectionProfileOauth, ProvisioningConnectionProfileToken, ProvisioningConnectionProfileUnknown]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[ProvisioningConnectionProfileOauth, ProvisioningConnectionProfileToken, ProvisioningConnectionProfileUnknown]]:
