...
class BehaviorRuleASN(BehaviorRule):
    """
    BehaviorRuleASN
    """ # noqa: E501
    settings: Optional[BehaviorRuleSettingsAnomalousASN] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "settings": BehaviorRuleSettingsAnomalousASN.from_dict(obj["settings"]) if obj.get("settings") is not None else None
        })
        return _obj
