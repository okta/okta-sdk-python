...
class RoleAssignedUsers(BaseModel):
    """
    RoleAssignedUsers
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [RoleAssignedUser.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None,
            "_links": LinksNextForRoleAssignments.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
