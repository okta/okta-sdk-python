...
class WsFederationApplication(Application):
    ...
    name: Optional[StrictStr] = "template_wsfed"
        ...
        _obj = cls.model_validate(
            {
                ...
                "credentials": (
                    ApplicationCredentials.from_dict(obj["credentials"])
                    if obj.get("credentials") is not None
                    else None
                ),
                "name": (
                    obj.get("name") if obj.get("name") is not None else "template_wsfed"
                ),
                "settings": (
                    WsFederationApplicationSettings.from_dict(obj["settings"])
