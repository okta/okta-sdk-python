...
class AuthenticatorEnrollmentPolicy(Policy):
    ...
    __properties: ClassVar[List[str]] = [
        "created", "description", "id", "lastUpdated", "name",
        ...
        _obj = cls.model_validate(
            {
                ...
                "conditions": AuthenticatorEnrollmentPolicyConditions.from_dict(obj["conditions"]) if obj.get(
                    "conditions"
                ) is not None else None,
                "settings": AuthenticatorEnrollmentPolicySettings.from_dict(obj["settings"]) if obj.get(
                    "settings"
                ) is not None else None
            }
        )
