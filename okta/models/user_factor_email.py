...
class UserFactorEmail(UserFactor):
    """
    UserFactorEmail
    """ # noqa: E501
    profile: Optional[UserFactorEmailProfile] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "profile": UserFactorEmailProfile.from_dict(obj["profile"]) if obj.get("profile") is not None else None,
