...
class OAuth2Settings(BaseModel):
    ...
    client_id: StrictStr = Field(
        description="The OAuth 2.0 client identifier", alias="clientId"
    )
    client_secret: StrictStr = Field(
        description="The OAuth 2.0 client secret", alias="clientSecret"
    )
    scopes: Optional[List[StrictStr]] = Field(
        default=None, description="List of OAuth 2.0 scopes"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "authorizeEndpoint": obj.get("authorizeEndpoint"),
