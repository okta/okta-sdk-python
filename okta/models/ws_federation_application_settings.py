...
class WsFederationApplicationSettings(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["emOptInStatus", "identityStoreId", "implicitAssignment", "inlineHookId", "notes", "notifications", "app"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "app": WsFederationApplicationSettingsApplication.from_dict(obj["app"]) if obj.get("app") is not None else None
        })
        return _obj
