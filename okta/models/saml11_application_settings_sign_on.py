...
class Saml11ApplicationSettingsSignOn(BaseModel):
    ...
    sso_acs_url_override: Optional[StrictStr] = Field(
        default=None,
        description="Assertion Consumer Services (ACS) URL value for the Service Provider (SP). This URL is always used "
                    "for Identity Provider (IdP) initiated sign-on requests.",
