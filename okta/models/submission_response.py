...
class SubmissionResponse(BaseModel):
    ...
    description: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]] = Field(default=None, description="A general description of your application and the benefits provided to your customers")
    ...
    logo: Optional[StrictStr] = Field(default=None, description="URL to an uploaded application logo. This logo appears next to your app integration name in the OIN catalog. You must first [Upload an OIN Integration logo](/openapi/okta-management/management/tag/YourOinIntegrations/#tag/YourOinIntegrations/operation/uploadSubmissionLogo) to obtain the logo URL before you can specify this value.")
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]] = Field(default=None, description="The app integration name. This is the main title used for your integration in the OIN catalog.")
