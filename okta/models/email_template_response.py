...
class EmailTemplateResponse(BaseModel):
    ...
    name: Optional[StrictStr] = Field(
        default=None, description="The name of this email template"
    )
    embedded: Optional[EmailTemplateResponseEmbedded] = Field(
        ...
        _obj = cls.model_validate(
            {
                "name": obj.get("name"),
                "_embedded": (
                    EmailTemplateResponseEmbedded.from_dict(obj["_embedded"])
                    if obj.get("_embedded") is not None
                    else None
                ),
                "_links": (
                    EmailTemplateResponseLinks.from_dict(obj["_links"])
