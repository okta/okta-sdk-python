...
class TokenPayLoadDataAccess(BaseModel):
    ...
    claims: Optional[Dict[str, Any]] = Field(
        default=None,
        description="Claims included in the token. Consists of name-value pairs for each included claim. For descriptions of "
        "the claims that you can include, see the Okta [OpenID Connect and OAuth 2.0 API reference]("
        "/openapi/okta-oauth/guides/overview/#claims).",
    )
    token: Optional[BaseTokenToken] = None
    scopes: Optional[Dict[str, Any]] = Field(
        default=None,
        description="The scopes contained in the token. For descriptions of the scopes that you can include, see the Okta ["
        "OpenID Connect and OAuth 2.0 API reference](/openapi/okta-oauth/guides/overview/#scopes).",
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "token": (
                    BaseTokenToken.from_dict(obj["token"])
