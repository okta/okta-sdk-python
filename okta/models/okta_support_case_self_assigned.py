...
class OktaSupportCaseSelfAssigned(BaseModel):
    """
    Customer allows Okta Support access to self-assigned cases. Support cases are self-assigned when an Okta Support team
    member creates and assigns the case to themselves.
    """  # noqa: E501
