...
class EnrollmentActivationResponse(BaseModel):
    ...
    authenticator_enrollment_ids: Optional[List[StrictStr]] = Field(
        default=None, description="List of IDs for preregistered WebAuthn factors in Okta",
        alias="authenticatorEnrollmentIds"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "authenticatorEnrollmentIds": obj.get("authenticatorEnrollmentIds"),
