...
class BulkGroupUpsertRequestBodyProfilesInner(BaseModel):
    ...
    external_id: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(
        default=None, description="The external ID of the group that needs to be created or updated in Okta",
        alias="externalId"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "profile": IdentitySourceGroupProfileForUpsert.from_dict(obj["profile"]) if obj.get(
                    "profile"
