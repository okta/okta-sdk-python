...
class AuthenticatorEnrollmentPolicyAuthenticatorSettings(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "constraints": AuthenticatorEnrollmentPolicyAuthenticatorSettingsConstraints.from_dict(obj["constraints"]) if obj.get("constraints") is not None else None,
            "enroll": AuthenticatorEnrollmentPolicyAuthenticatorSettingsEnroll.from_dict(obj["enroll"]) if obj.get("enroll") is not None else None,
            "key": obj.get("key")
        })
        return _obj
