...
class ChangePasswordRequest(BaseModel):
    ...
    new_password: Optional[PasswordCredential] = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "newPassword": (
                    PasswordCredential.from_dict(obj["newPassword"])
                    if obj.get("newPassword") is not None
                    else None
                ),
                "oldPassword": (
                    PasswordCredential.from_dict(obj["oldPassword"])
