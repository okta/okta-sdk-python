...
class BundleEntitlement(BaseModel):
    """
    An entitlement in a governance bundle
    """  # noqa: E501

    description: Optional[StrictStr] = Field(
        default=None, description="The description of the role"
    )
    ...
    role: Optional[StrictStr] = Field(default=None, description="The role key")
    links: Optional[BundleEntitlementLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["description", "id", "name", "role", "_links"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "role": obj.get("role"),
                "_links": (
                    BundleEntitlementLinks.from_dict(obj["_links"])
