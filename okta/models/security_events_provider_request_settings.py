...
class SecurityEventsProviderRequestSettings(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = SecurityEventsProviderRequestSettings.model_construct()
        error_messages = []
        match = 0
        ...
        if not isinstance(v, SecurityEventsProviderSettingsSSFCompliant):
            error_messages.append(f"Error! Input type `{type(v)}` is not `SecurityEventsProviderSettingsSSFCompliant`")
        else:
            match += 1
        ...
        if not isinstance(v, SecurityEventsProviderSettingsNonSSFCompliant):
            error_messages.append(f"Error! Input type `{type(v)}` is not `SecurityEventsProviderSettingsNonSSFCompliant`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            instance.actual_instance = SecurityEventsProviderSettingsSSFCompliant.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into SecurityEventsProviderSettingsNonSSFCompliant
        try:
            instance.actual_instance = SecurityEventsProviderSettingsNonSSFCompliant.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
