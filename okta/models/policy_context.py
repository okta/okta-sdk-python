...
class PolicyContext(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["device", "groups", "ip", "risk", "user", "zones"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "groups": PolicyContextGroups.from_dict(obj["groups"]) if obj.get("groups") is not None else None,
            "ip": obj.get("ip"),
            "risk": PolicyContextRisk.from_dict(obj["risk"]) if obj.get("risk") is not None else None,
            "user": PolicyContextUser.from_dict(obj["user"]) if obj.get("user") is not None else None,
