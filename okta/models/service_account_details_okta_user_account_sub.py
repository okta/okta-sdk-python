...
class ServiceAccountDetailsOktaUserAccountSub(BaseModel):
    ...
    email: Optional[StrictStr] = Field(
        default=None, description="The email address for the Okta user"
    )
    okta_user_id: StrictStr = Field(
        description="The ID of the Okta user to manage as a service account",
        alias="oktaUserId",
    )
    __properties: ClassVar[List[str]] = ["credentials", "email", "oktaUserId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "credentials": (
                    OktaUserServiceAccountCredentials.from_dict(obj["credentials"])
