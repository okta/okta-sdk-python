...
class TelephonyResponseCommandsInner(BaseModel):
    ...
    type: Optional[StrictStr] = Field(
        default=None,
        description="The location where you specify the command. For the telephony inline hook, there's only one command, "
                    "`com.okta.telephony.action`."
    )
    value: Optional[List[TelephonyResponseCommandsInnerValueInner]] = Field(
        default=None,
        description="The status of the telephony operation along with optional additional information about the provider, "
                    "transaction ID and any other transaction metadata."
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "type": obj.get("type"),
                "value": [TelephonyResponseCommandsInnerValueInner.from_dict(_item) for _item in obj["value"]] if obj.get(
                    "value"
