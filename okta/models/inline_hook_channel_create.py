...
class InlineHookChannelCreate(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[InlineHookChannelHttpCreate, InlineHookChannelOAuthCreate]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[InlineHookChannelHttpCreate, InlineHookChannelOAuthCreate]]:
        """Create an instance of InlineHookChannelCreate from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type == 'InlineHookChannelHttpCreate':
            return import_module("okta.models.inline_hook_channel_http_create").InlineHookChannelHttpCreate.from_dict(obj)
