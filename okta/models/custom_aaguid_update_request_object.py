...
class CustomAAGUIDUpdateRequestObject(BaseModel):
    ...
    attestation_root_certificates: Optional[
        List[AttestationRootCertificatesRequestInner]
    ] = Field(
        default=None,
        description="Contains the certificate and information about it",
        alias="attestationRootCertificates",
    )
    ...
    name: Optional[StrictStr] = Field(
        default=None, description="The product name associated with this AAGUID."
    )
        ...
        _obj = cls.model_validate(
            {
                "attestationRootCertificates": (
                    [
                        AttestationRootCertificatesRequestInner.from_dict(_item)
