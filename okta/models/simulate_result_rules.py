...
class SimulateResultRules(BaseModel):
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['MATCH', 'UNMATCHED', 'UNDEFINED']):
            raise ValueError("must be one of enum values ('MATCH', 'UNMATCHED', 'UNDEFINED')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "conditions": SimulateResultConditions.from_dict(obj["conditions"]) if obj.get("conditions") is not None else None
        })
        return _obj
