...
class ApplicationSettingsNotificationsVpnNetwork(BaseModel):
    ...
    def connection_validate_enum(cls, value):
        ...
        if value not in set(['DISABLED', 'ANYWHERE', 'ON_NETWORK', 'OFF_NETWORK', 'ZONE']):
            raise ValueError("must be one of enum values ('DISABLED', 'ANYWHERE', 'ON_NETWORK', 'OFF_NETWORK', 'ZONE')")
        return value
