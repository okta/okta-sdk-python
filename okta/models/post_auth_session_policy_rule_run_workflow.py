...
class PostAuthSessionPolicyRuleRunWorkflow(BaseModel):
    """
    ...
    def action_validate_enum(cls, value):
        ...
        if value not in set(['RUN_WORKFLOW']):
            raise ValueError("must be one of enum values ('RUN_WORKFLOW')")
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "workflow": EntityRiskPolicyRuleActionRunWorkflowWorkflow.from_dict(obj["workflow"]) if obj.get(
                    "workflow"
