...
class RegistrationInlineHookPPDataAllOfDataContextUser(BaseModel):
    ...
    profile: Optional[Dict[str, Any]] = Field(
        default=None, description="The user to update's current attributes"
    )
    id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["passwordChanged", "_links", "profile", "id"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "_links": (
                    BaseContextUserLinks.from_dict(obj["_links"])
