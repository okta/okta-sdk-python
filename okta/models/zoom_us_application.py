...
class ZoomUsApplication(BaseModel):
    ...
    def name_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['zoomus']):
            raise ValueError("must be one of enum values ('zoomus')")
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "settings": ZoomUsApplicationSettings.from_dict(obj["settings"]) if obj.get("settings") is not None else None
            }
        )
        return _obj
