...
class UserImportRequestData(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "action": UserImportRequestDataAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
            "appUser": UserImportRequestDataAppUser.from_dict(obj["appUser"]) if obj.get("appUser") is not None else None,
            "context": UserImportRequestDataContext.from_dict(obj["context"]) if obj.get("context") is not None else None,
