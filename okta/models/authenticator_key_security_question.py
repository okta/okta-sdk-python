...
class AuthenticatorKeySecurityQuestion(AuthenticatorSimple):
    """
    AuthenticatorKeySecurityQuestion
    """  # noqa: E501
    settings: Optional[AuthenticatorKeyPhoneAllOfSettings] = None
    __properties: ClassVar[List[str]] = [
        "created", "id", "key", "lastUpdated", "name", "status", "type", "_links", "settings"
    ]
        ...
        _obj = cls.model_validate(
            {
                ...
                "settings": AuthenticatorKeyPhoneAllOfSettings.from_dict(obj["settings"]) if obj.get(
                    "settings"
