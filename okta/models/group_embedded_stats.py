...
class GroupEmbeddedStats(BaseModel):
    ...
    users_count: Optional[StrictInt] = Field(
        default=None, description="Number of users in the group", alias="usersCount"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "appsCount": obj.get("appsCount"),
                "groupPushMappingsCount": obj.get("groupPushMappingsCount"),
