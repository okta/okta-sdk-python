...
class DevicePostureChecksRemediationSettings(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "link": DevicePostureChecksRemediationSettingsLink.from_dict(obj["link"]) if obj.get(
                    "link"
                ) is not None else None,
                "message": DevicePostureChecksRemediationSettingsMessage.from_dict(obj["message"]) if obj.get(
                    "message"
                ) is not None else None
            }
        )
