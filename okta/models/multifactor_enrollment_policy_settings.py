...
class MultifactorEnrollmentPolicySettings(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "authenticators": [MultifactorEnrollmentPolicyAuthenticatorSettings.from_dict(_item) for _item in obj["authenticators"]] if obj.get("authenticators") is not None else None,
            "type": obj.get("type")
        })
        return _obj
