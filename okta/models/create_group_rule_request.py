...
class CreateGroupRuleRequest(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['group_rule']):
            raise ValueError("must be one of enum values ('group_rule')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actions": GroupRuleAction.from_dict(obj["actions"]) if obj.get("actions") is not None else None,
            "conditions": GroupRuleConditions.from_dict(obj["conditions"]) if obj.get("conditions") is not None else None,
            "name": obj.get("name"),
            "type": obj.get("type")
        })
        return _obj
