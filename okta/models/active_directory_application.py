...
from okta.models.active_directory_application_settings import (
...
class ActiveDirectoryApplication(Application):
    """
    ...
    name: Optional[StrictStr] = Field(
        default=None,
        description="Unique key for the Active Directory app definition. Always 'active_directory' for AD apps.",
    )
    settings: Optional[ActiveDirectoryApplicationSettings] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "name": obj.get("name"),
                "settings": (
                    ActiveDirectoryApplicationSettings.from_dict(obj["settings"])
