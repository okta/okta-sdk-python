        ...
        _obj = cls.model_validate(
            {
                ...
                "actions": PostAuthSessionPolicyRuleAllOfActions.from_dict(obj["actions"]) if obj.get(
                    "actions"
                ) is not None else None,
                "conditions": PostAuthSessionPolicyRuleAllOfConditions.from_dict(obj["conditions"]) if obj.get(
                    "conditions"
                ) is not None else None
            }
        )
