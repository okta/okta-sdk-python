...
class AuthenticatorKeyDuo(AuthenticatorSimple):
    """
    AuthenticatorKeyDuo
    """  # noqa: E501
    provider: Optional[AuthenticatorKeyDuoAllOfProvider] = None
    __properties: ClassVar[List[str]] = [
        "created", "id", "key", "lastUpdated", "name", "status", "type", "_links", "provider"
    ]
        ...
        _obj = cls.model_validate(
            {
                ...
                "provider": AuthenticatorKeyDuoAllOfProvider.from_dict(obj["provider"]) if obj.get(
                    "provider"
