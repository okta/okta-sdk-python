...
class SimulatePolicyEvaluations(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["evaluated", "policyType", "result", "status", "undefined"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "evaluated": SimulatePolicyEvaluationsEvaluated.from_dict(obj["evaluated"]) if obj.get(
                    "evaluated"
                ) is not None else None,
                "policyType": obj.get("policyType"),
                "result": SimulatePolicyResult.from_dict(obj["result"]) if obj.get("result") is not None else None,
                "status": obj.get("status"),
                "undefined": SimulatePolicyEvaluationsUndefined.from_dict(obj["undefined"]) if obj.get(
                    "undefined"
                ) is not None else None
            }
        )
