...
class PasswordPolicyPasswordSettingsAge(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "expireWarnDays": obj.get("expireWarnDays") if obj.get("expireWarnDays") is not None else 0,
            "historyCount": obj.get("historyCount") if obj.get("historyCount") is not None else 0,
            "maxAgeDays": obj.get("maxAgeDays") if obj.get("maxAgeDays") is not None else 0,
