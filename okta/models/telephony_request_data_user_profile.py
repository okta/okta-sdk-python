...
class TelephonyRequestDataUserProfile(BaseModel):
    ...
    login: Optional[StrictStr] = Field(
        default=None, description="The user's Okta login"
    )
    user_id: Optional[StrictStr] = Field(
        default=None, description="The user's Okta user ID", alias="userId"
    )
    __properties: ClassVar[List[str]] = ["firstName", "lastName", "login", "userId"]
