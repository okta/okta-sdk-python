...
class FeatureStage(object):
    ...
    @property
    def state(self):
        """Gets the state of this FeatureStage.  # noqa: E501


        :return: The state of this FeatureStage.  # noqa: E501
        :rtype: FeatureStageState
        """
        return self._state

    @state.setter
    def state(self, state):
        """Sets the state of this FeatureStage.


        :param state: The state of this FeatureStage.  # noqa: E501
    ...
    @property
    def value(self):
        """Gets the value of this FeatureStage.  # noqa: E501


        :return: The value of this FeatureStage.  # noqa: E501
        :rtype: FeatureStageValue
        """
        return self._value

    @value.setter
    def value(self, value):
        """Sets the value of this FeatureStage.


        :param value: The value of this FeatureStage.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FeatureStage, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FeatureStage):
            return False
