...
class SAMLPayLoadData(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.assertion:
            if not isinstance(self.assertion, dict):
                _dict['assertion'] = self.assertion.to_dict()
            else:
                _dict['assertion'] = self.assertion
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "context": SAMLPayLoadDataContext.from_dict(obj["context"]) if obj.get("context") is not None else None,
                "assertion": SAMLPayLoadDataAssertion.from_dict(obj["assertion"]) if obj.get(
                    "assertion"
