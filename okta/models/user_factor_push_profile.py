...
class UserFactorPushProfile(BaseModel):
    ...
    version: Optional[StrictStr] = Field(default=None, description="Installed version of Okta Verify")
    __properties: ClassVar[List[str]] = ["credentialId", "deviceToken", "deviceType", "name", "platform", "version"]
