...
class OrgGeneralSettingLinks(BaseModel):
    ...
    okta_support: Optional[OrgGeneralSettingLinksOktaSupport] = Field(default=None, alias="oktaSupport")
    preferences: Optional[OrgGeneralSettingLinksPreferences] = None
    upload_logo: Optional[OrgGeneralSettingLinksUploadLogo] = Field(default=None, alias="uploadLogo")
    __properties: ClassVar[List[str]] = ["contacts", "logo", "oktaCommunication", "oktaSupport", "preferences", "uploadLogo"]
