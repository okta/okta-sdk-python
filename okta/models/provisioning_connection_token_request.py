...
class ProvisioningConnectionTokenRequest(BaseModel):
    ...
    base_url: Optional[StrictStr] = Field(
        default=None,
        description="Only used for the Zscaler 2.0 (`zscalerbyz`) app. The base URL for the Zscaler 2.0 target app, "
                    "which also contains the Zscaler ID.",
        alias="baseUrl"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "profile": ProvisioningConnectionTokenRequestProfile.from_dict(obj["profile"]) if obj.get(
                    "profile"
