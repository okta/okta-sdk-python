...
class TokenResponse(BaseModel):
    ...
    access_token: Optional[StrictStr] = Field(
        default=None, description="An access token."
    )
    ...
    expires_in: Optional[StrictInt] = Field(
        default=None, description="The expiration time of the access token in seconds."
    )
    ...
    scope: Optional[StrictStr] = Field(
        default=None, description="The scopes contained in the access token."
    )
