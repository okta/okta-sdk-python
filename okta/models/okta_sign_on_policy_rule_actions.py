...
class OktaSignOnPolicyRuleActions(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of signon
        if self.signon:
            if not isinstance(self.signon, dict):
                _dict["signon"] = self.signon.to_dict()
            else:
                _dict["signon"] = self.signon
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "signon": (
                    OktaSignOnPolicyRuleSignonActions.from_dict(obj["signon"])
