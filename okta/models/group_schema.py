...
class GroupSchema(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "definitions": GroupSchemaDefinitions.from_dict(obj["definitions"]) if obj.get("definitions") is not None else None,
            "description": obj.get("description"),
            "id": obj.get("id"),
            "lastUpdated": obj.get("lastUpdated"),
            "name": obj.get("name"),
            "properties": UserSchemaProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "title": obj.get("title"),
            "type": obj.get("type"),
