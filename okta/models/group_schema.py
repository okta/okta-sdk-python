...
from okta.models import group_schema_definitions\
    as group_schema_definitions
...
class GroupSchema(
    ...
    """
    A class for GroupSchema objects.
    """
        ...
        if config:
            ...
            if "definitions" in config:
                if isinstance(config["definitions"],
                              group_schema_definitions.GroupSchemaDefinitions):
                    self.definitions = config["definitions"]
                elif config["definitions"] is not None:
                    self.definitions = group_schema_definitions.GroupSchemaDefinitions(
                        config["definitions"]
                    )
                else:
