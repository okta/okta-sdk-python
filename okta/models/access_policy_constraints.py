...
class AccessPolicyConstraints(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "knowledge": KnowledgeConstraint.from_dict(obj["knowledge"]) if obj.get("knowledge") is not None else None,
                "possession": PossessionConstraint.from_dict(obj["possession"]) if obj.get(
                    "possession"
