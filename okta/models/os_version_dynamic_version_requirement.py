...
class OSVersionDynamicVersionRequirement(BaseModel):
    """
    <x-lifecycle-container><x-lifecycle class=\"ea\"></x-lifecycle></x-lifecycle-container>Contains the necessary properties
    for a dynamic version requirement
    """  # noqa: E501
    ...
    distance_from_latest_major: Optional[
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(["MINIMUM", "EXACT", "EXACT_ANY_SUPPORTED"]):
            raise ValueError(
                "must be one of enum values ('MINIMUM', 'EXACT', 'EXACT_ANY_SUPPORTED')"
            )
        return value
