...
class EmailTemplateEmbedded(BaseModel):
    """
    EmailTemplateEmbedded
    """  # noqa: E501

    settings: Optional[EmailSettings] = None
    customization_count: Optional[StrictInt] = Field(
        default=None, alias="customizationCount"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "settings": (
                    EmailSettings.from_dict(obj["settings"])
