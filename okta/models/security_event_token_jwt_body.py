...
class SecurityEventTokenJwtBody(BaseModel):
    """
    JSON Web Token body payload for a Security Event Token sent by the SSF Transmitter. For examples and more information,
    see [SSF Transmitter SET payload structures](https://developer.okta.com/docs/reference/ssf-transmitter-sets).
    """  # noqa: E501
    ...
    iss: StrictStr = Field(description="Token issuer")
    jti: StrictStr = Field(description="Token ID")
    __properties: ClassVar[List[str]] = ["aud", "events", "iat", "iss", "jti"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "aud": obj.get("aud"),
                "events": SecurityEventTokenJwtEvents.from_dict(obj["events"]) if obj.get("events") is not None else None,
                "iat": obj.get("iat"),
                "iss": obj.get("iss"),
                "jti": obj.get("jti")
            }
