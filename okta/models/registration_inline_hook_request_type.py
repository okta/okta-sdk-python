...
class RegistrationInlineHookRequestType(str, Enum):
    """
    ...
    allowed enum values
    """
    PROGRESSIVE_DOT_PROFILE = "progressive.profile"
    SELF_DOT_SERVICE_DOT_REGISTRATION = "self.service.registration"
