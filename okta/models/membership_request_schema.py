...
class MembershipRequestSchema(BaseModel):
    ...
    member_external_id: Optional[Annotated[str, Field(strict=True, max_length=255)]] = (
        Field(
            default=None,
            description="The external ID of the user to be added as a member of the group in Okta",
            alias="memberExternalId",
        )
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"memberExternalId": obj.get("memberExternalId")})
        return _obj
