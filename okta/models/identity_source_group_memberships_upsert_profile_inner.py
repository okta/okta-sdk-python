...
class IdentitySourceGroupMembershipsUpsertProfileInner(BaseModel):
    ...
    """ # noqa: E501
    group_external_id: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="The external ID of the group whose memberships need to be inserted or updated in Okta", alias="groupExternalId")
