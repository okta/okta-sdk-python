...
class GovernanceBundlesResponse(BaseModel):
    ...
    bundles: Optional[List[GovernanceBundle]] = Field(
        default=None, description="List of governance bundles"
    )
    links: Optional[GovernanceBundlesResponseLinks] = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "bundles": (
                    [GovernanceBundle.from_dict(_item) for _item in obj["bundles"]]
                    if obj.get("bundles") is not None
                    else None
                ),
                "_links": (
                    GovernanceBundlesResponseLinks.from_dict(obj["_links"])
