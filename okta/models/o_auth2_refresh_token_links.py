...
class OAuth2RefreshTokenLinks(BaseModel):
    """
    ...
    revoke: Optional[OAuth2RefreshTokenLinksAllOfRevoke] = None
    ...
    authorization_server: Optional[AuthorizationServerResourceHrefObject] = Field(default=None, description="Link to the Token authorization server resource", alias="authorizationServer")
    __properties: ClassVar[List[str]] = ["self", "app", "revoke", "client", "user", "authorizationServer"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "revoke": OAuth2RefreshTokenLinksAllOfRevoke.from_dict(obj["revoke"]) if obj.get("revoke") is not None else None,
