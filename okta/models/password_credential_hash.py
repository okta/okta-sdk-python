...
class PasswordCredentialHash(BaseModel):
    ...
    work_factor: Optional[Annotated[int, Field(le=20, strict=True, ge=1)]] = Field(
        default=None, description="Governs the strength of the hash and the time required to compute it. Only required for BCRYPT algorithm.", alias="workFactor")
    __properties: ClassVar[List[str]] = ["algorithm", "digestAlgorithm",
                                         "iterationCount", "keySize", "salt", "saltOrder", "value", "workFactor"]
