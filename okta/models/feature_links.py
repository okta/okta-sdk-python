...
class FeatureLinks(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["self", "dependents", "dependencies"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.dependents:
            if not isinstance(self.dependents, dict):
                _dict['dependents'] = self.dependents.to_dict()
            else:
                _dict['dependents'] = self.dependents
        ...
        _obj = cls.model_validate(
            {
                ...
                "dependents": FeatureLinksAllOfDependents.from_dict(obj["dependents"]) if obj.get(
                    "dependents"
                ) is not None else None,
                "dependencies": FeatureLinksAllOfDependencies.from_dict(obj["dependencies"]) if obj.get(
                    "dependencies"
                ) is not None else None
            }
        )
