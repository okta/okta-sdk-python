...
class ApiTokenNetwork(BaseModel):
    ...
    connection: Optional[StrictStr] = Field(
        default=None, description="The connection type of the Network Condition"
    )
    include: Optional[List[StrictStr]] = Field(
        default=None, description="List of included IP network zones"
    )
    exclude: Optional[List[StrictStr]] = Field(
        default=None, description="List of excluded IP network zones"
    )
    __properties: ClassVar[List[str]] = ["connection", "include", "exclude"]
