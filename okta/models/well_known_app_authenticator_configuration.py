...
class WellKnownAppAuthenticatorConfiguration(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.supported_methods:
            for _item in self.supported_methods:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "appAuthenticatorEnrollEndpoint": obj.get(
                    "appAuthenticatorEnrollEndpoint"
                ),
                ...
                "orgId": obj.get("orgId"),
                "settings": (
                    WellKnownAppAuthenticatorConfigurationSettings.from_dict(
                        obj["settings"]
                    )
                ...
                "supportedMethods": (
                    [
                        SupportedMethods.from_dict(_item)
                        for _item in obj["supportedMethods"]
                    ]
                    if obj.get("supportedMethods") is not None
                    else None
                ),
                "type": obj.get("type"),
            }
