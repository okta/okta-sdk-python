...
class SAMLPayLoadDataAssertionClaimsValue(BaseModel):
    ...
    attribute_values: Optional[
        List[SAMLPayLoadDataAssertionClaimsValueAttributeValuesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "attributes": (
                    SAMLPayLoadDataAssertionClaimsValueAttributes.from_dict(
                        obj["attributes"]
                    )
                ...
                "attributeValues": (
                    [
                        SAMLPayLoadDataAssertionClaimsValueAttributeValuesInner.from_dict(
                            _item
                        )
