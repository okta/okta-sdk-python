...
class SAMLPayLoadDataAssertionClaimsValue(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "attributes": SAMLPayLoadDataAssertionClaimsValueAttributes.from_dict(obj["attributes"]) if obj.get(
                    "attributes"
                ) is not None else None,
                "attributeValues": [SAMLPayLoadDataAssertionClaimsValueAttributeValuesInner.from_dict(_item) for _item in
                                    obj["attributeValues"]] if obj.get("attributeValues") is not None else None
            }
        )
        return _obj
