...
class BulkGroupUpsertRequestBody(BaseModel):
    ...
    """  # noqa: E501
    profiles: Optional[
        Annotated[List[BulkGroupUpsertRequestBodyProfilesInner], Field(min_length=1, max_length=200)]] = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "profiles": [BulkGroupUpsertRequestBodyProfilesInner.from_dict(_item) for _item in
                             obj["profiles"]] if obj.get("profiles") is not None else None
            }
        )
        return _obj
