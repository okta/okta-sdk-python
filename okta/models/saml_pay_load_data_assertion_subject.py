...
class SAMLPayLoadDataAssertionSubject(BaseModel):
    ...
    name_id: Optional[StrictStr] = Field(
        default=None, description="The unique identifier of the user", alias="nameId"
    )
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.confirmation:
            if not isinstance(self.confirmation, dict):
                ...
                _dict["confirmation"] = self.confirmation
        ...
        _obj = cls.model_validate(
            {
                ...
                "confirmation": (
                    SAMLPayLoadDataAssertionSubjectConfirmation.from_dict(
                        obj["confirmation"]
                    )
