...
class LinksGovernanceResources(BaseModel):
    """
    Specifies link relations (see [Web Linking](https://www.rfc-editor.org/rfc/rfc8288)) available for the resources using
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "resources": HrefObjectGovernanceResourcesLink.from_dict(obj["resources"]) if obj.get(
                    "resources"
