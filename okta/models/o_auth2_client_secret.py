...
class OAuth2ClientSecret(BaseModel):
    ...
    client_secret: Optional[StrictStr] = Field(
        default=None, description="The OAuth 2.0 client secret string"
    )
    ...
    id: Optional[StrictStr] = Field(
        default=None, description="The unique ID of the OAuth Client Secret"
    )
    ...
    secret_hash: Optional[StrictStr] = Field(
        default=None, description="OAuth 2.0 client secret string hash"
    )
    status: Optional[StrictStr] = Field(
        default="ACTIVE", description="Status of the OAuth 2.0 Client Secret"
    )
