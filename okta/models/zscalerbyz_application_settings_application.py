...
class ZscalerbyzApplicationSettingsApplication(BaseModel):
    ...
    site_domain: Optional[StrictStr] = Field(
        default=None, description="Your Zscaler domain", alias="siteDomain"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"siteDomain": obj.get("siteDomain")})
        return _obj
