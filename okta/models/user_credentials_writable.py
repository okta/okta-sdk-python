...
class UserCredentialsWritable(BaseModel):
    """
    ...
    provider: Optional[AuthenticationProviderWritable] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "provider": AuthenticationProviderWritable.from_dict(obj["provider"]) if obj.get(
                    "provider"
                ) is not None else None,
                "recovery_question": RecoveryQuestionCredential.from_dict(obj["recovery_question"]) if obj.get(
                    "recovery_question"
                ) is not None else None
            }
        )
