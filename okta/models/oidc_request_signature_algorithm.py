...
class OidcRequestSignatureAlgorithm(BaseModel):
    """
    Signature Algorithm settings for signing authorization requests sent to the IdP > **Note:**  The `algorithm` property
    is ignored when you disable request signatures (`scope` set as `NONE`).
    """  # noqa: E501
