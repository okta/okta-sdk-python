...
class GovernanceBundle(BaseModel):
    ...
    description: Optional[StrictStr] = Field(
        default=None, description="Description of the governance bundle"
    )
    id: Optional[StrictStr] = Field(default=None, description="Governance bundle ID")
    name: Optional[StrictStr] = Field(
        default=None, description="Name of the governance bundle"
    )
    orn: Optional[StrictStr] = Field(
        default=None,
        description="The governance bundle resource, in [ORN format]("
        "https://developer.okta.com/docs/api/openapi/okta-management/guides/roles/#okta-resource-name-orn)",
    )
    status: Optional[StrictStr] = Field(
        default=None, description="Status of the governance bundle"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "_links": (
                    GovernanceBundleLinks.from_dict(obj["_links"])
