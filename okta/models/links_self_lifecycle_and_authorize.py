...
class LinksSelfLifecycleAndAuthorize(BaseModel):
    """
    ...
    authorize: Optional[HrefObjectAuthorizeLink] = None
    __properties: ClassVar[List[str]] = ["self", "activate", "deactivate", "authorize"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "authorize": HrefObjectAuthorizeLink.from_dict(obj["authorize"]) if obj.get("authorize") is not None else None
        })
        return _obj
