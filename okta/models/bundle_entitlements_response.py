...
class BundleEntitlementsResponse(BaseModel):
    ...
    entitlements: Optional[List[BundleEntitlement]] = Field(
        default=None, description="List of bundle entitlements"
    )
    links: Optional[BundleEntitlementsResponseLinks] = Field(
        ...
        _obj = cls.model_validate(
            {
                "entitlements": (
                    [
                        BundleEntitlement.from_dict(_item)
                        for _item in obj["entitlements"]
                    ]
                    if obj.get("entitlements") is not None
                    else None
                ),
                "_links": (
                    BundleEntitlementsResponseLinks.from_dict(obj["_links"])
