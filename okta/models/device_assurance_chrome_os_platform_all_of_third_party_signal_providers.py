...
class DeviceAssuranceChromeOSPlatformAllOfThirdPartySignalProviders(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of dtc
        if self.dtc:
            if not isinstance(self.dtc, dict):
                _dict['dtc'] = self.dtc.to_dict()
            else:
                _dict['dtc'] = self.dtc
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "dtc": DTCChromeOS.from_dict(obj["dtc"]) if obj.get("dtc") is not None else None,
