...
class CapabilitiesInboundProvisioningObject(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "importRules": CapabilitiesImportRulesObject.from_dict(obj["importRules"]) if obj.get(
                    "importRules"
                ) is not None else None,
                "importSettings": CapabilitiesImportSettingsObject.from_dict(obj["importSettings"]) if obj.get(
                    "importSettings"
                ) is not None else None
            }
        )
