...
class CreateUserRequest(BaseModel):
    ...
    group_ids: Optional[List[StrictStr]] = Field(
        default=None, description="The list of group IDs of groups that the user is added to at the time of creation",
        alias="groupIds"
    )
    profile: UserProfile
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "credentials": UserCredentialsWritable.from_dict(obj["credentials"]) if obj.get(
                    "credentials"
