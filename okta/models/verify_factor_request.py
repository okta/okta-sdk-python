...
class VerifyFactorRequest(BaseModel):
    ...
    registration_data: Optional[StrictStr] = Field(
        default=None, alias="registrationData"
    )
    state_token: Optional[StrictStr] = Field(default=None, alias="stateToken")
    authenticator_data: Optional[StrictStr] = Field(
        default=None, alias="authenticatorData"
    )
