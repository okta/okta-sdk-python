...
class GroupRule(object):
    ...
    def actions(self):
        if 'actions' not in self._map:
            self._map['actions'] = {}
        return GroupRuleAction(self._map['actions'], self._client)
    ...
    def conditions(self):
        ...
        return GroupRuleConditions(self._map['conditions'], self._client)
    ...
    def status(self):
        if 'status' not in self._map:
            self._map['status'] = {}
        return GroupRuleStatus(self._map['status'], self._client)
