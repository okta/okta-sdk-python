...
class OAuth2RefreshTokenScopeLinks(BaseModel):
    ...
    scope: Optional[OfflineAccessScopeResourceHrefObject] = Field(
        default=None, description="Link to Scope resource"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "scope": (
                    OfflineAccessScopeResourceHrefObject.from_dict(obj["scope"])
