...
class LogAuthenticationContext(BaseModel):
    ...
    authentication_step: Optional[StrictInt] = Field(default=None, description="The zero-based step number in the authentication pipeline. Currently unused and always set to `0`.", alias="authenticationStep")
    ...
    external_session_id: Optional[StrictStr] = Field(default=None, description="A proxy for the actor's [session ID](https://cheatsheetseries.owasp.org/cheatsheets/Session_Management_Cheat_Sheet.html)", alias="externalSessionId")
    interface: Optional[StrictStr] = Field(default=None, description="The third-party user interface that the actor authenticates through, if any.")
