...
class SamlRequestSignatureAlgorithm(BaseModel):
    """
    XML digital Signature Algorithm settings for signing `<AuthnRequest>` messages sent to the IdP > **Note:**  The
    `algorithm` property is ignored when you disable request signatures (`scope` set as `NONE`).
    """  # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"algorithm": obj.get("algorithm"), "scope": obj.get("scope")}
        )
        return _obj
