...
class AuthorizationServerPolicyPeopleCondition(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "groups": AuthorizationServerPolicyRuleGroupCondition.from_dict(obj["groups"]) if obj.get(
                    "groups"
                ) is not None else None,
                "users": AuthorizationServerPolicyRuleUserCondition.from_dict(obj["users"]) if obj.get(
                    "users"
                ) is not None else None
            }
        )
