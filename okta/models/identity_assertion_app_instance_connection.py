...
class IdentityAssertionAppInstanceConnection(BaseModel):
    ...
    authorization_server: Optional[AppInstanceAuthorizationServer] = Field(
        default=None, alias="authorizationServer"
    )
    ...
    def connection_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["IDENTITY_ASSERTION_APP_INSTANCE"]):
            raise ValueError(
                "must be one of enum values ('IDENTITY_ASSERTION_APP_INSTANCE')"
            )
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "authorizationServer": (
                    AppInstanceAuthorizationServer.from_dict(obj["authorizationServer"])
