...
class EnrollmentPolicyAuthenticatorGracePeriod(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['BY_DATE_TIME']):
            raise ValueError("must be one of enum values ('BY_DATE_TIME')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[ByDateTimeAuthenticatorGracePeriodExpiry]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[ByDateTimeAuthenticatorGracePeriodExpiry]]:
