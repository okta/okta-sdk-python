...
class DomainLinks(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "brand": DomainLinksAllOfBrand.from_dict(obj["brand"]) if obj.get("brand") is not None else None,
            "certificate": DomainLinksAllOfCertificate.from_dict(obj["certificate"]) if obj.get("certificate") is not None else None,
