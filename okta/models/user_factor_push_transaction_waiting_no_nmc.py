...
class UserFactorPushTransactionWaitingNoNMC(UserFactorPushTransaction):
    ...
    links: Optional[UserFactorPushTransactionWaitingNoNMCAllOfLinks] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "profile": (
                    UserFactorPushTransactionRejectedAllOfProfile.from_dict(
                        obj["profile"]
                    )
                ...
                "_links": (
                    UserFactorPushTransactionWaitingNoNMCAllOfLinks.from_dict(
                        obj["_links"]
                    )
