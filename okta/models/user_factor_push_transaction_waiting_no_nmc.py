        ...
        _obj = cls.model_validate(
            {
                ...
                "profile": UserFactorPushTransactionRejectedAllOfProfile.from_dict(obj["profile"]) if obj.get(
                    "profile"
                ) is not None else None,
                "_links": UserFactorPushTransactionWaitingNoNMCAllOfLinks.from_dict(obj["_links"]) if obj.get(
                    "_links"
                ) is not None else None
            }
        )
