...
class OktaIpChangeEvent(BaseModel):
    """
    IP changed for the subject's session
    """  # noqa: E501

    current_ip_address: StrictStr = Field(
    ...
    previous_ip_address: StrictStr = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "current_ip_address": obj.get("current_ip_address"),
                "event_timestamp": obj.get("event_timestamp"),
                "initiating_entity": obj.get("initiating_entity"),
                "previous_ip_address": obj.get("previous_ip_address"),
                "reason_admin": (
