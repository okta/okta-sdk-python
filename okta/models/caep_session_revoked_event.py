...
class CaepSessionRevokedEvent(BaseModel):
    ...
    last_known_ip: Optional[StrictStr] = Field(default=None, description="Last known IP of the session")
    last_known_user_agent: Optional[StrictStr] = Field(default=None, description="Last known User Agent of the session")
