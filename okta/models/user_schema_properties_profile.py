...
class UserSchemaPropertiesProfile(BaseModel):
    ...
    all_of: Optional[List[UserSchemaPropertiesProfileItem]] = Field(
        default=None, alias="allOf"
    )
        ...
        _obj = cls.model_validate(
            {
                "allOf": (
                    [
                        UserSchemaPropertiesProfileItem.from_dict(_item)
                        for _item in obj["allOf"]
                    ]
