...
class CSRLinks(BaseModel):
    ...
    of a CSR object using the [JSON Hypertext Application Language](
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.publish:
            if not isinstance(self.publish, dict):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "publish": HrefCsrPublishLink.from_dict(obj["publish"]) if obj.get("publish") is not None else None,
