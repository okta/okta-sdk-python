...
class AuthenticatorEnrollmentLinks(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["self", "user", "authenticator"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "user": (
                    LinksUserAuthenticatorsUser.from_dict(obj["user"])
                    if obj.get("user") is not None
                    else None
                ),
                "authenticator": (
                    LinksAuthenticatorAuthenticator.from_dict(obj["authenticator"])
