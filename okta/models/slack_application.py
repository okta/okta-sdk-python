...
class SlackApplication(BaseModel):
    """
    Schema for the Slack app (key name: `slack`)  To create a Slack app, use the [Create an Application](
    /openapi/okta-management/management/tag/Application/#tag/Application/operation/createApplication) request with the
    following parameters in the request body. > **Note:** The Slack app only supports `BROWSER_PLUGIN` and `SAML_2_0`
    sign-on modes.
    """  # noqa: E501
        ...
        _obj = cls.model_validate(
            {
                ...
                "name": obj.get("name") if obj.get("name") is not None else "slack",
                ...
                "settings": (
                    SlackApplicationSettings.from_dict(obj["settings"])
