...
class DeviceSignalCollectionPolicyRule(PolicyRule):
    """
    DeviceSignalCollectionPolicyRule
    """ # noqa: E501
    actions: Optional[DeviceSignalCollectionPolicyRuleActions] = None
    conditions: Optional[DeviceSignalCollectionPolicyRuleConditions] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "actions": DeviceSignalCollectionPolicyRuleActions.from_dict(obj["actions"]) if obj.get("actions") is not None else None,
            "conditions": DeviceSignalCollectionPolicyRuleConditions.from_dict(obj["conditions"]) if obj.get("conditions") is not None else None
        })
        return _obj
