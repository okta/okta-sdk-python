        ...
        _obj = cls.model_validate(
            {
                ...
                "actions": DeviceSignalCollectionPolicyRuleActions.from_dict(obj["actions"]) if obj.get(
                    "actions"
                ) is not None else None,
                "conditions": DeviceSignalCollectionPolicyRuleConditions.from_dict(obj["conditions"]) if obj.get(
                    "conditions"
                ) is not None else None
            }
        )
