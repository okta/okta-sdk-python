...
class UserSchemaBaseProperties(BaseModel):
    ...
    """ # noqa: E501
    city: Optional[UserSchemaAttribute] = Field(default=None, description="City or locality component of the user's address (`locality`)")
    cost_center: Optional[UserSchemaAttribute] = Field(default=None, description="Name of a cost center assigned to the user", alias="costCenter")
    country_code: Optional[UserSchemaAttribute] = Field(default=None, description="Country name component of the user's address (`country`.) This property uses [ISO 3166-1 alpha 2 \"short\" code format](https://tools.ietf.org/html/draft-ietf-scim-core-schema-22#ref-ISO3166).", alias="countryCode")
    department: Optional[UserSchemaAttribute] = Field(default=None, description="Name of the user's department")
    display_name: Optional[UserSchemaAttribute] = Field(default=None, description="Name of the user, suitable for display to end users", alias="displayName")
    division: Optional[UserSchemaAttribute] = Field(default=None, description="Name of the user's division")
    email: Optional[UserSchemaAttribute] = Field(default=None, description="Primary email address of the user. This property is formatted according to [RFC 5322 Section 3.2.3](https://datatracker.ietf.org/doc/html/rfc5322#section-3.2.3).")
    employee_number: Optional[UserSchemaAttribute] = Field(default=None, description="Organization or company assigned unique identifier for the user", alias="employeeNumber")
    first_name: Optional[UserSchemaAttribute] = Field(default=None, description="Given name of the user (`givenName`)", alias="firstName")
    honorific_prefix: Optional[UserSchemaAttribute] = Field(default=None, description="Honorific prefix(es) of the user or title in most Western languages", alias="honorificPrefix")
    honorific_suffix: Optional[UserSchemaAttribute] = Field(default=None, description="Honorific suffix(es) of the user", alias="honorificSuffix")
    last_name: Optional[UserSchemaAttribute] = Field(default=None, description="Family name of the user (`familyName`)", alias="lastName")
    locale: Optional[UserSchemaAttribute] = Field(default=None, description="User's default location for purposes of localizing items such as currency, date time format, numerical representations, and so on.  A locale value is a concatenation of the ISO 639-1 two-letter language code, an underscore, and the ISO 3166-1 two-letter country code. For example: `en_US` specifies the language English and country US. This value is `en_US` by default.")
    ...
    manager_id: Optional[UserSchemaAttribute] = Field(default=None, description="The `id` of the user's manager", alias="managerId")
    middle_name: Optional[UserSchemaAttribute] = Field(default=None, description="Middle name(s) of the user", alias="middleName")
    mobile_phone: Optional[UserSchemaAttribute] = Field(default=None, description="Mobile phone number of the user", alias="mobilePhone")
    nick_name: Optional[UserSchemaAttribute] = Field(default=None, description="Casual way to address the user in real life", alias="nickName")
    organization: Optional[UserSchemaAttribute] = Field(default=None, description="Name of the user's organization")
    postal_address: Optional[UserSchemaAttribute] = Field(default=None, description="Mailing address component of the user's address", alias="postalAddress")
    preferred_language: Optional[UserSchemaAttribute] = Field(default=None, description="User's preferred written or spoken languages. This property is formatted according to [RFC 7231 Section 5.3.5](https://tools.ietf.org/html/rfc7231#section-5.3.5).", alias="preferredLanguage")
    primary_phone: Optional[UserSchemaAttribute] = Field(default=None, description="Primary phone number of the user, such as home number", alias="primaryPhone")
    profile_url: Optional[UserSchemaAttribute] = Field(default=None, description="URL of the user's online profile (for example, a web page.) This property is formatted according to the [Relative Uniform Resource Locators specification](https://tools.ietf.org/html/draft-ietf-scim-core-schema-22#ref-ISO3166).", alias="profileUrl")
    second_email: Optional[UserSchemaAttribute] = Field(default=None, description="Secondary email address of the user typically used for account recovery. This property is formatted according to [RFC 5322 Section 3.2.3](https://datatracker.ietf.org/doc/html/rfc5322#section-3.2.3).", alias="secondEmail")
    state: Optional[UserSchemaAttribute] = Field(default=None, description="State or region component of the user's address (`region`)")
    street_address: Optional[UserSchemaAttribute] = Field(default=None, description="Full street address component of the user's address", alias="streetAddress")
    timezone: Optional[UserSchemaAttribute] = Field(default=None, description="User's time zone. This property is formatted according to the [IANA Time Zone database format](https://tools.ietf.org/html/rfc6557).")
    title: Optional[UserSchemaAttribute] = Field(default=None, description="User's title, such as \"Vice President\"")
    user_type: Optional[UserSchemaAttribute] = Field(default=None, description="Used to describe the organization to the user relationship such as \"Employee\" or \"Contractor\".  **Note:** The `userType` field is an arbitrary string value and isn't related to the newer [User Types](https://developer.okta.com/docs/api/openapi/okta-management/management/tag/UserType/) feature.", alias="userType")
    zip_code: Optional[UserSchemaAttribute] = Field(default=None, description="ZIP code or postal code component of the user's address (`postalCode`)", alias="zipCode")
