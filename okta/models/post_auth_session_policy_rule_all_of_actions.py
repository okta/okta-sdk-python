...
class PostAuthSessionPolicyRuleAllOfActions(BaseModel):
    ...
    post_auth_session: Optional[
        PostAuthSessionPolicyRuleAllOfActionsPostAuthSession
    ] = Field(default=None, alias="postAuthSession")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of post_auth_session
        if self.post_auth_session:
            if not isinstance(self.post_auth_session, dict):
                _dict["postAuthSession"] = self.post_auth_session.to_dict()
            else:
                _dict["postAuthSession"] = self.post_auth_session
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "postAuthSession": (
                    PostAuthSessionPolicyRuleAllOfActionsPostAuthSession.from_dict(
                        obj["postAuthSession"]
                    )
                    if obj.get("postAuthSession") is not None
                    else None
                )
            }
        )
