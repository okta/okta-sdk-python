...
class ProvisioningConnectionResponse(BaseModel):
    ...
    links: Optional[LinksSelfLifecycleAndAuthorize] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["authScheme", "baseUrl", "profile", "status", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "profile": ProvisioningConnectionResponseProfile.from_dict(obj["profile"]) if obj.get("profile") is not None else None,
