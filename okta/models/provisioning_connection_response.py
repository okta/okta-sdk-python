...
class ProvisioningConnectionResponse(BaseModel):
    ...
    auth_scheme: Optional[ProvisioningConnectionTokenAuthScheme] = Field(
        default=None, alias="authScheme"
    )
    base_url: Optional[StrictStr] = Field(
        default=None, description="Base URL", alias="baseUrl"
    )
    profile: ProvisioningConnectionResponseProfile
    status: ProvisioningConnectionStatus
    links: Optional[LinksSelfLifecycleAndAuthorize] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "profile": (
                    ProvisioningConnectionResponseProfile.from_dict(obj["profile"])
                    if obj.get("profile") is not None
                    else None
                ),
                "status": obj.get("status"),
                "_links": (
                    LinksSelfLifecycleAndAuthorize.from_dict(obj["_links"])
