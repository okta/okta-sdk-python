...
class OpenIdConnectApplicationSettings(BaseModel):
    ...
    __properties: ClassVar[List[str]] = [
        ...
        "implicitAssignment", "inlineHookId", "notes", "notifications", "oauthClient"
    ]
        ...
        _obj = cls.model_validate(
            {
                ...
                "oauthClient": OpenIdConnectApplicationSettingsClient.from_dict(obj["oauthClient"]) if obj.get(
                    "oauthClient"
                ) is not None else None
            }
        )
