...
class BaseContextUserProfile(BaseModel):
    ...
    locale: Optional[StrictStr] = Field(
        ...
        description="The user's default location for purposes of localizing items such as currency, date time format, "
                    ...
                    "https://en.wikipedia.org/wiki/List_of_ISO_639_language_codes) two-letter language code, "
                    "an underscore, and the [ISO 3166-1](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) two-letter "
                    "country code. For example, `en_US` specifies the language English and country US. This value is "
                    "`en_US` by default."
    )
    time_zone: Optional[StrictStr] = Field(default=None, description="The user's timezone", alias="timeZone")
    __properties: ClassVar[List[str]] = ["login", "firstName", "lastName", "locale", "timeZone"]
