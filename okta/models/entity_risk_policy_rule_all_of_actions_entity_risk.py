...
class EntityRiskPolicyRuleAllOfActionsEntityRisk(BaseModel):
    ...
    actions: Optional[List[EntityRiskPolicyRuleActionsObject]] = Field(
        default=None,
        description="The `entityRisk` object's `actions` array can be empty or contain one of two `action` object value "
                    "pairs. This object determines the specific response to a risk event."
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "actions": [EntityRiskPolicyRuleActionsObject.from_dict(_item) for _item in obj["actions"]] if obj.get(
                    "actions"
