...
class UserFactorTokenHardware(UserFactor):
    """
    UserFactorTokenHardware
    """  # noqa: E501
    profile: Optional[UserFactorTokenProfile] = None
    verify: Optional[UserFactorTokenHardwareAllOfVerify] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "profile": UserFactorTokenProfile.from_dict(obj["profile"]) if obj.get("profile") is not None else None,
            ...
            "verify": UserFactorTokenHardwareAllOfVerify.from_dict(obj["verify"]) if obj.get("verify") is not None else None
        })
        return _obj
