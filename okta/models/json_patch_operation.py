...
class JsonPatchOperation(BaseModel):
    ...
    path: Optional[StrictStr] = Field(
        default=None, description="The resource path of the attribute to update"
    )
    value: Optional[Dict[str, Any]] = Field(
        default=None, description="The update operation value"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"op": obj.get("op"), "path": obj.get("path"), "value": obj.get("value")}
        )
        return _obj
