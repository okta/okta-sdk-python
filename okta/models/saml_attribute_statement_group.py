...
class SamlAttributeStatementGroup(BaseModel):
    ...
    type: Optional[StrictStr] = Field(
        default=None, description="The type of attribute statements object"
    )
    ...
    def filter_type_validate_enum(cls, value):
        ...
        if value not in set(["STARTS_WITH", "EQUALS", "CONTAINS", "REGEX"]):
            raise ValueError(
                "must be one of enum values ('STARTS_WITH', 'EQUALS', 'CONTAINS', 'REGEX')"
            )
        return value
