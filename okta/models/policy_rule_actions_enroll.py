...
class PolicyRuleActionsEnroll(object):
    ...
    @property
    def _self(self):
        """Gets the _self of this PolicyRuleActionsEnroll.  # noqa: E501


        :return: The _self of this PolicyRuleActionsEnroll.  # noqa: E501
        :rtype: PolicyRuleActionsEnrollSelf
        """
        return self.__self

    @_self.setter
    def _self(self, _self):
        """Sets the _self of this PolicyRuleActionsEnroll.


        :param _self: The _self of this PolicyRuleActionsEnroll.  # noqa: E501
    ...
    def as_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PolicyRuleActionsEnroll, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PolicyRuleActionsEnroll):
            return False
