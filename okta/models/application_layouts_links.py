...
class ApplicationLayoutsLinks(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "general": [HrefObject.from_dict(_item) for _item in obj["general"]] if obj.get(
                    "general"
                ) is not None else None,
                "signOn": [HrefObject.from_dict(_item) for _item in obj["signOn"]] if obj.get(
                    "signOn"
                ) is not None else None,
                "provisioning": [HrefObject.from_dict(_item) for _item in obj["provisioning"]] if obj.get(
                    "provisioning"
                ) is not None else None
            }
        )
