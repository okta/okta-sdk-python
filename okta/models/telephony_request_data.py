        ...
        _obj = cls.model_validate(
            {
                ...
                "messageProfile": TelephonyRequestDataMessageProfile.from_dict(obj["messageProfile"]) if obj.get(
                    "messageProfile"
                ) is not None else None,
                "userProfile": TelephonyRequestDataUserProfile.from_dict(obj["userProfile"]) if obj.get(
                    "userProfile"
                ) is not None else None
            }
        )
