...
class Sso(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "oidc": (
                    Oidc.from_dict(obj["oidc"]) if obj.get("oidc") is not None else None
                ),
                "saml": (
                    Saml.from_dict(obj["saml"]) if obj.get("saml") is not None else None
                ),
            }
        )
        return _obj
