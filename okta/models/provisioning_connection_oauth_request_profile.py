...
class ProvisioningConnectionOauthRequestProfile(BaseModel):
    ...
    client_id: Optional[StrictStr] = Field(
        default=None,
        description="Only used for the Okta Org2Org (`okta_org2org`) app. The unique client identifier for the OAuth 2.0 "
        ...
        _obj = cls.model_validate(
            {
                ...
                "settings": Office365ProvisioningSettings.from_dict(obj["settings"]) if obj.get(
                    "settings"
                ) is not None else None,
                "signing": Org2OrgProvisioningOAuthSigningSettings.from_dict(obj["signing"]) if obj.get(
                    "signing"
                ) is not None else None
            }
        )
