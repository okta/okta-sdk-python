...
class AuthenticatorKeyCustomApp(AuthenticatorSimple):
    ...
    agree_to_terms: Optional[StrictBool] = Field(
        ...
        "the terms when creating a new `custom_app` authenticator. Other authenticators don't require this field.",
        alias="agreeToTerms",
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "type": obj.get("type"),
                "_links": (
                    AuthenticatorLinks.from_dict(obj["_links"])
                    if obj.get("_links") is not None
                    else None
                ),
                "agreeToTerms": obj.get("agreeToTerms"),
                "provider": (
                    AuthenticatorKeyCustomAppAllOfProvider.from_dict(obj["provider"])
                    if obj.get("provider") is not None
                    else None
                ),
                "settings": (
                    AuthenticatorKeyCustomAppAllOfSettings.from_dict(obj["settings"])
