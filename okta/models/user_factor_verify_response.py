...
class UserFactorVerifyResponse(BaseModel):
    """
    ...
    factor_message: Optional[StrictStr] = Field(
        ...
        alias="factorMessage")
    factor_result: Optional[UserFactorVerifyResult] = Field(default=None, alias="factorResult")
    profile: Optional[Dict[str, Dict[str, Any]]] = None
    embedded: Optional[Dict[str, Optional[Dict[str, Any]]]] = Field(default=None, alias="_embedded")
    links: Optional[UserFactorLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["expiresAt", "factorMessage", "factorResult", "profile", "_embedded", "_links"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if factor_message (nullable) is None
        # and model_fields_set contains the field
        if self.factor_message is None and "factor_message" in self.model_fields_set:
            _dict['factorMessage'] = None
