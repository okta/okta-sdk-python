...
class AAGUIDGroupObject(BaseModel):
    ...
    aaguids: Optional[List[StrictStr]] = Field(
        ...
        description="A list of YubiKey hardware FIDO2 AAGUIDs. The available [AAGUIDs]("
                    "https://support.yubico.com/hc/en-us/articles/360016648959-YubiKey-Hardware-FIDO2-AAGUIDs) are "
                    "provided by the FIDO Alliance Metadata Service."
    )
