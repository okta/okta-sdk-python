...
class NetworkZone(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[DynamicNetworkZone, EnhancedDynamicNetworkZone, IPNetworkZone]]:
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[DynamicNetworkZone, EnhancedDynamicNetworkZone, IPNetworkZone]]:
        ...
        if object_type == 'DynamicNetworkZone':
            return import_module("okta.models.dynamic_network_zone").DynamicNetworkZone.from_dict(obj)
        if object_type == 'EnhancedDynamicNetworkZone':
            return import_module("okta.models.enhanced_dynamic_network_zone").EnhancedDynamicNetworkZone.from_dict(obj)
