...
class Success(BaseModel):
    ...
    success_message: Optional[List[SuccessSuccessMessageInner]] = Field(
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in success_message (list)
        _items = []
        if self.success_message:
            for _item in self.success_message:
                if _item:
        ...
        _obj = cls.model_validate(
            {
                "successMessage": (
                    [
                        SuccessSuccessMessageInner.from_dict(_item)
                        for _item in obj["successMessage"]
                    ]
                    if obj.get("successMessage") is not None
                    else None
                ),
