...
class CustomAAGUIDResponseObject(BaseModel):
    ...
    attestation_root_certificates: Optional[
        List[AttestationRootCertificatesResponseInner]
    ] = Field(default=None, alias="attestationRootCertificates")
    ...
    name: Optional[StrictStr] = Field(
        default=None, description="The product name associated with the AAGUID"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.attestation_root_certificates:
            ...
            _dict["attestationRootCertificates"] = _items
        # override the default output from pydantic by calling `to_dict()` of authenticator_characteristics
        if self.authenticator_characteristics:
            if not isinstance(self.authenticator_characteristics, dict):
                _dict["authenticatorCharacteristics"] = (
                    self.authenticator_characteristics.to_dict()
                )
            else:
                _dict["authenticatorCharacteristics"] = (
                    self.authenticator_characteristics
                )
        ...
        _obj = cls.model_validate(
            {
                ...
                "attestationRootCertificates": (
                    [
                        AttestationRootCertificatesResponseInner.from_dict(_item)
                        for _item in obj["attestationRootCertificates"]
                    ]
                    if obj.get("attestationRootCertificates") is not None
                    else None
                ),
                "authenticatorCharacteristics": (
                    AAGUIDAuthenticatorCharacteristics.from_dict(
                        obj["authenticatorCharacteristics"]
                    )
                    if obj.get("authenticatorCharacteristics") is not None
                    else None
                ),
                "name": obj.get("name"),
                "_links": (
