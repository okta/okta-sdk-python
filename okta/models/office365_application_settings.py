...
class Office365ApplicationSettings(BaseModel):
    """
    ...
    sign_on: Optional[OINSaml11ApplicationSettingsSignOn] = Field(default=None, alias="signOn")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "app": Office365ApplicationSettingsApplication.from_dict(obj["app"]) if obj.get("app") is not None else None,
            "signOn": OINSaml11ApplicationSettingsSignOn.from_dict(obj["signOn"]) if obj.get("signOn") is not None else None
        })
        return _obj
