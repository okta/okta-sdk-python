...
class TokenPayLoadDataContextAllOfProtocol(BaseModel):
    ...
    issuer: Optional[TokenPayLoadDataContextAllOfProtocolIssuer] = None
    client: Optional[TokenPayLoadDataContextAllOfProtocolClient] = None
    __properties: ClassVar[List[str]] = ["type", "request", "OriginalGrant", "issuer", "client"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of original_grant
        if self.original_grant:
            if not isinstance(self.original_grant, dict):
                _dict['OriginalGrant'] = self.original_grant.to_dict()
            else:
                _dict['OriginalGrant'] = self.original_grant
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "type": obj.get("type"),
                "request": TokenProtocolRequest.from_dict(obj["request"]) if obj.get("request") is not None else None,
                "OriginalGrant": TokenPayLoadDataContextAllOfProtocolOriginalGrant.from_dict(
                    obj["OriginalGrant"]
                ) if obj.get("OriginalGrant") is not None else None,
                "issuer": TokenPayLoadDataContextAllOfProtocolIssuer.from_dict(obj["issuer"]) if obj.get(
                    "issuer"
                ) is not None else None,
                "client": TokenPayLoadDataContextAllOfProtocolClient.from_dict(obj["client"]) if obj.get(
                    "client"
                ) is not None else None
            }
        )
