...
class TokenPayLoadDataContextAllOfProtocol(BaseModel):
    ...
    type: Optional[StrictStr] = Field(
        default=None, description="The type of authentication protocol used"
    )
    request: Optional[TokenProtocolRequest] = None
    original_grant: Optional[TokenPayLoadDataContextAllOfProtocolOriginalGrant] = Field(
        default=None, alias="OriginalGrant"
    )
        ...
        _obj = cls.model_validate(
            {
                "type": obj.get("type"),
                "request": (
                    TokenProtocolRequest.from_dict(obj["request"])
                    if obj.get("request") is not None
                    else None
                ),
                "OriginalGrant": (
                    TokenPayLoadDataContextAllOfProtocolOriginalGrant.from_dict(
                        obj["OriginalGrant"]
                    )
                    if obj.get("OriginalGrant") is not None
                    else None
                ),
                "issuer": (
                    TokenPayLoadDataContextAllOfProtocolIssuer.from_dict(obj["issuer"])
                    if obj.get("issuer") is not None
                    else None
                ),
                "client": (
                    TokenPayLoadDataContextAllOfProtocolClient.from_dict(obj["client"])
