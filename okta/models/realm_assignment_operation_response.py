...
class RealmAssignmentOperationResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "assignmentOperation": RealmAssignmentOperationResponseAllOfAssignmentOperation.from_dict(obj["assignmentOperation"]) if obj.get("assignmentOperation") is not None else None,
