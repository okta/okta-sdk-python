...
class RealmAssignmentOperationResponse(BaseModel):
    ...
    completed: Optional[datetime] = Field(
        default=None, description="Timestamp of when the operation completed"
    )
    ...
    started: Optional[datetime] = Field(
        default=None, description="Timestamp of when the operation started"
    )
    ...
    assignment_operation: Optional[
        RealmAssignmentOperationResponseAllOfAssignmentOperation
    ] = Field(default=None, alias="assignmentOperation")
    ...
    realm_id: Optional[StrictStr] = Field(
        default=None, description="ID of the realm", alias="realmId"
    )
    realm_name: Optional[StrictStr] = Field(
        default=None, description="Name of the realm", alias="realmName"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of assignment_operation
        if self.assignment_operation:
            if not isinstance(self.assignment_operation, dict):
                _dict["assignmentOperation"] = self.assignment_operation.to_dict()
            else:
                _dict["assignmentOperation"] = self.assignment_operation
        ...
        _obj = cls.model_validate(
            {
                ...
                "type": obj.get("type"),
                "assignmentOperation": (
                    RealmAssignmentOperationResponseAllOfAssignmentOperation.from_dict(
                        obj["assignmentOperation"]
                    )
                    if obj.get("assignmentOperation") is not None
                    else None
                ),
                "numUserMoved": obj.get("numUserMoved"),
