...
class RealmAssignmentOperationResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = [
        "completed", "created", "id", "started", "status",
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['COMPLETED', 'SCHEDULED', 'IN_PROGRESS', 'FAILED']):
            raise ValueError("must be one of enum values ('COMPLETED', 'SCHEDULED', 'IN_PROGRESS', 'FAILED')")
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "type": obj.get("type"),
                "assignmentOperation": RealmAssignmentOperationResponseAllOfAssignmentOperation.from_dict(
                    obj["assignmentOperation"]
                ) if obj.get("assignmentOperation") is not None else None,
