...
class TacAuthenticatorEnrollment(BaseModel):
    ...
    id: Optional[StrictStr] = Field(
        default=None, description="A unique identifier of the authenticator enrollment"
    )
    ...
    status: Optional[StrictStr] = Field(
        default=None, description="Status of the enrollment"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "profile": (
                    AuthenticatorProfileTacResponsePost.from_dict(obj["profile"])
                ...
                "type": obj.get("type"),
                "_links": (
                    AuthenticatorEnrollmentLinks.from_dict(obj["_links"])
