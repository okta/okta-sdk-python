...
class MtlsTrustCredentials(BaseModel):
    ...
    Annotated[int, Field(
        ...
        description="Time in minutes to cache the certificate revocation information  > **Note:** This property isn't "
                    ...
                    "requests. Specifying this property in your API requests doesn't cause errors since the property has "
                    "no effect. > > See [Deprecation Notice - Smart Card IdP Legacy CRL Cache Setting]("
