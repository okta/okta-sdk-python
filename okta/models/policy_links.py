...
class PolicyLinks(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["self", "activate", "deactivate", "rules", "mappings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rules": HrefObjectRulesLink.from_dict(obj["rules"]) if obj.get("rules") is not None else None,
