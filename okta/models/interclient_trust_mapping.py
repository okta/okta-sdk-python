...
class InterclientTrustMapping(BaseModel):
    ...
    app_instance_id: Optional[StrictStr] = Field(
        default=None, description="The app ID of the target app", alias="appInstanceId"
    )
    ...
    id: Optional[StrictStr] = Field(
        default=None, description="The unique ID of the interclient trust mapping"
    )
    ...
    org_id: Optional[StrictStr] = Field(
        default=None, description="ID of the org", alias="orgId"
    )
