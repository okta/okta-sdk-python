...
class DeviceIntegrationsMetadataOneOf(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "serviceAccountName", "serviceAccountEmail"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['CHROME']):
            raise ValueError("must be one of enum values ('CHROME')")
        return value
