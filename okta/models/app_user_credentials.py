...
class AppUserCredentials(BaseModel):
    ...
    /openapi/okta-management/management/tag/Application/#tag/Application/operation/getApplication!c=200&path=0/signOnMode
    &t=response) (`signOnMode`) or [authentication schemes](
    ...
    user_name: Optional[Annotated[str,
    Field(
        min_length=1,
        strict=True,
        max_length=100
        ...
        description="The user's username in the app  > **Note:** The [userNameTemplate]("
                    "/openapi/okta-management/management/tag/Application/#tag/Application/operation/createApplication!path"
                    "=0/credentials/userNameTemplate&t=request) in the application object defines the default username "
                    "generated when a user is assigned to that app. > If you attempt to assign a username or password to "
                    "an app with an incompatible [authentication scheme]("
                    "/openapi/okta-management/management/tag/Application/#tag/Application/operation/createApplication!path"
                    "=0/credentials/scheme&t=request), the following error is returned: > \"Credentials should not be set "
                    "on this resource based on the scheme.\"",
        alias="userName"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "password": AppUserPasswordCredential.from_dict(obj["password"]) if obj.get(
                    "password"
