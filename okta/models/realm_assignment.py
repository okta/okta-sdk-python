...
class RealmAssignment(BaseModel):
    ...
    created: Optional[datetime] = Field(
        default=None, description="Timestamp when the realm assignment was created"
    )
    ...
    id: Optional[StrictStr] = Field(
        default=None, description="Unique ID of the realm assignment"
    )
    ...
    priority: Optional[StrictInt] = Field(
        default=None,
        description="The priority of the realm assignment. The lower the number, the higher the priority. This helps resolve "
        "conflicts between realm assignments. > **Note:** When you create realm assignments in bulk, "
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "actions": (
                    Actions.from_dict(obj["actions"])
                    if obj.get("actions") is not None
                    else None
                ),
                "conditions": (
                    Conditions.from_dict(obj["conditions"])
