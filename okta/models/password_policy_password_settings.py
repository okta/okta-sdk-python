...
class PasswordPolicyPasswordSettings(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.age:
            if not isinstance(self.age, dict):
        ...
        if self.lockout:
            if not isinstance(self.lockout, dict):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "age": (
                    PasswordPolicyPasswordSettingsAge.from_dict(obj["age"])
                    if obj.get("age") is not None
                    else None
                ),
                "complexity": (
                    PasswordPolicyPasswordSettingsComplexity.from_dict(
                        obj["complexity"]
                    )
