...
class RoleGovernanceResources(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "resources": [RoleGovernanceResource.from_dict(_item) for _item in obj["resources"]] if obj.get(
                    "resources"
                ) is not None else None,
                "_links": AIAgentOperationListResponseLinks.from_dict(obj["_links"]) if obj.get(
                    "_links"
                ) is not None else None
            }
        )
