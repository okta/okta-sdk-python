...
class BehaviorRuleVelocity(BehaviorRule):
    """
    BehaviorRuleVelocity
    """ # noqa: E501
    settings: Optional[BehaviorRuleSettingsVelocity] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "settings": BehaviorRuleSettingsVelocity.from_dict(obj["settings"]) if obj.get("settings") is not None else None
        })
        return _obj
