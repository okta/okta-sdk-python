...
class OAuth2ResourceServerJsonWebKey(BaseModel):
    ...
    created: Optional[StrictStr] = Field(
        default=None, description="Timestamp when the JSON Web Key was created"
    )
    e: Optional[StrictStr] = Field(
        default=None, description="RSA key value (exponent) for key binding"
    )
    id: Optional[StrictStr] = Field(
        default=None, description="The unique ID of the JSON Web Key"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "use": obj.get("use"),
                "_links": (
                    OAuthResourceServerKeyLinks.from_dict(obj["_links"])
