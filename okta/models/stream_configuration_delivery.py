...
class StreamConfigurationDelivery(BaseModel):
    ...
    authorization_header: Optional[
        Annotated[str, Field(strict=True, max_length=8192)]
    ] = Field(
        default=None,
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if authorization_header (nullable) is None
        # and model_fields_set contains the field
        if (
            self.authorization_header is None
            and "authorization_header" in self.model_fields_set
        ):
            _dict["authorization_header"] = None
