...
class UserFactorActivateResponse(BaseModel):
    ...
    links: Optional[UserFactorActivateResponseLinks] = Field(
    ...
    def factor_type_validate_enum(cls, value):
        ...
        if value not in set(
            ["call", "email", "sms", "push", "token:software:totp", "u2f", "webauthn"]
        ):
            raise ValueError(
        ...
        _obj = cls.model_validate(
            {
                ...
                "_links": (
                    UserFactorActivateResponseLinks.from_dict(obj["_links"])
