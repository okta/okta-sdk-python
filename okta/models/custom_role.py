...
class CustomRole(BaseModel):
    ...
    label: Optional[StrictStr] = Field(
        default=None, description="Label for the role assignment"
    )
    ...
    resource_set: Optional[StrictStr] = Field(
        default=None, description="Resource set ID", alias="resource-set"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "resource-set": obj.get("resource-set"),
                "role": obj.get("role"),
                "status": obj.get("status"),
                "type": obj.get("type"),
                "_links": (
                    LinksCustomRoleResponse.from_dict(obj["_links"])
