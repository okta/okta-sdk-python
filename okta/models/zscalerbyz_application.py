...
class ZscalerbyzApplication(BaseModel):
    ...
    following parameters in the request body. > **Note:** The Zscaler 2.0 app only supports `BROWSER_PLUGIN` and `SAML_2_0`
    sign-on modes.
    """  # noqa: E501
        ...
        _obj = cls.model_validate(
            {
                ...
                "name": (
                    obj.get("name") if obj.get("name") is not None else "zscalerbyz"
                ),
                ...
                "settings": (
                    ZscalerbyzApplicationSettings.from_dict(obj["settings"])
