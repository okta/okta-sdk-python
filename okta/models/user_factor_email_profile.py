...
class UserFactorEmailProfile(BaseModel):
    ...
    email: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(
        default=None,
        description="Email address of the user. This must be either the primary or secondary email address associated with "
        "the Okta user account.  > **Note:** For Identity Engine orgs, you can only enroll the primary email "
        "address of the user.",
    )
