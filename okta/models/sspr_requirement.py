...
class SsprRequirement(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of step_up
        if self.step_up:
            if not isinstance(self.step_up, dict):
                _dict["stepUp"] = self.step_up.to_dict()
            else:
                _dict["stepUp"] = self.step_up
        ...
        _obj = cls.model_validate(
            {
                ...
                "stepUp": (
                    SsprStepUpRequirement.from_dict(obj["stepUp"])
                    if obj.get("stepUp") is not None
                    else None
                ),
            }
        )
