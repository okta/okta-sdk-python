...
class LifecyclePublishBody(object):
    ...
    def set_attributes(self, **kwargs):  # noqa: E501
        """LifecyclePublishBody - a model defined in Swagger"""  # noqa: E501
    ...
    def as_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LifecyclePublishBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LifecyclePublishBody):
            return False
