...
class PasswordImportResponse(BaseModel):
    ...
    commands: Optional[List[PasswordImportResponseCommandsInner]] = Field(
        default=None,
        description="The `commands` object specifies whether Okta accepts the end user's sign-in credentials as valid or "
                    "not. For the password import inline hook, you typically only return one `commands` object with one "
                    "array element in it."
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "commands": [PasswordImportResponseCommandsInner.from_dict(_item) for _item in obj["commands"]] if obj.get(
                    "commands"
