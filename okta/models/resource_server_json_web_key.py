...
class ResourceServerJsonWebKey(BaseModel):
    ...
    use the active key to encrypt the access token minted by the authorization server. Okta supports only RSA keys with
    'use: enc'.
    """  # noqa: E501

    e: Optional[StrictStr] = Field(
        default=None, description="The key exponent of a RSA key"
    )
    kid: Optional[StrictStr] = Field(
        default=None, description="The unique identifier of the key"
    )
    kty: Optional[JsonWebKeyType] = None
    n: Optional[StrictStr] = Field(
        default=None, description="The modulus of the RSA key"
    )
    status: Optional[JsonWebKeyStatus] = None
    use: Optional[JsonWebKeyUse] = None
    __properties: ClassVar[List[str]] = ["e", "kid", "kty", "n", "status", "use"]
