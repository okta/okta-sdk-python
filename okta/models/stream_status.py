...
class StreamStatus(BaseModel):
    ...
    status: Optional[StrictStr] = Field(
        default=None, description="The status of the SSF Stream configuration"
    )
    stream_id: Optional[StrictStr] = Field(
        default=None,
        description="The ID of the SSF Stream configuration. This corresponds to the value in the query parameter of the "
        "request.",
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"status": obj.get("status"), "stream_id": obj.get("stream_id")}
        )
        return _obj
