...
class TrendMicroApexOneServiceApplication(BaseModel):
    ...
    following parameters in the request body. > **Note:** The Trend Micro Apex One as a Service app only supports `SAML_2_0`
    sign-on mode.
    """  # noqa: E501
        ...
        _obj = cls.model_validate(
            {
                ...
                "settings": (
                    TrendMicroApexOneServiceApplicationSettings.from_dict(
                        obj["settings"]
                    )
