...
class EntityRiskPolicyRuleConditions(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "entityRisk": EntityRiskScorePolicyRuleCondition.from_dict(obj["entityRisk"]) if obj.get(
                    "entityRisk"
                ) is not None else None,
                "people": PolicyPeopleCondition.from_dict(obj["people"]) if obj.get("people") is not None else None,
                "riskDetectionTypes": RiskDetectionTypesPolicyRuleCondition.from_dict(obj["riskDetectionTypes"]) if obj.get(
                    "riskDetectionTypes"
                ) is not None else None
            }
        )
