...
class EntitlementValuesResponse(BaseModel):
    ...
    entitlement_values: Optional[List[EntitlementValue]] = Field(
        ...
        alias="entitlementValues",
    )
    links: Optional[EntitlementValuesResponseLinks] = Field(
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in entitlement_values (list)
        _items = []
        if self.entitlement_values:
            for _item in self.entitlement_values:
                if _item:
                    _items.append(_item.to_dict())
            _dict["entitlementValues"] = _items
        ...
        _obj = cls.model_validate(
            {
                "entitlementValues": (
                    [
                        EntitlementValue.from_dict(_item)
                        for _item in obj["entitlementValues"]
                    ]
                    if obj.get("entitlementValues") is not None
                    else None
                ),
                "_links": (
                    EntitlementValuesResponseLinks.from_dict(obj["_links"])
