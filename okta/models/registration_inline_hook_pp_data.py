...
class RegistrationInlineHookPPData(RegistrationInlineHookRequest):
    """
    ...
    data: Optional[RegistrationInlineHookPPDataAllOfData] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": (
                    RegistrationInlineHookPPDataAllOfData.from_dict(obj["data"])
