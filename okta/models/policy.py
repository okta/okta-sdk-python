...
class Policy(BaseModel):
    ...
    ProfileEnrollmentPolicy]]:
        ...
        if object_type == 'DeviceSignalCollectionPolicy':
            return import_module("okta.models.device_signal_collection_policy").DeviceSignalCollectionPolicy.from_dict(obj)
        if object_type == 'EntityRiskPolicy':
            return import_module("okta.models.entity_risk_policy").EntityRiskPolicy.from_dict(obj)
        ...
        if object_type == 'AuthenticatorEnrollmentPolicy':
            return import_module("okta.models.authenticator_enrollment_policy").AuthenticatorEnrollmentPolicy.from_dict(obj)
        ...
        if object_type == 'PostAuthSessionPolicy':
            return import_module("okta.models.post_auth_session_policy").PostAuthSessionPolicy.from_dict(obj)
