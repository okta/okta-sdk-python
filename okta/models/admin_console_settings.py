...
class AdminConsoleSettings(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "sessionIdleTimeoutMinutes": obj.get("sessionIdleTimeoutMinutes") if obj.get(
                    "sessionIdleTimeoutMinutes"
                ) is not None else 15,
                "sessionMaxLifetimeMinutes": obj.get("sessionMaxLifetimeMinutes") if obj.get(
                    "sessionMaxLifetimeMinutes"
                ) is not None else 720
            }
        )
        return _obj
