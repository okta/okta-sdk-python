...
class UserFactorWebAuthnProfile(BaseModel):
    ...
    authenticator_name: Optional[StrictStr] = Field(
        default=None,
        description="Human-readable name of the authenticator  > **Note:** This name is set from the AAGUID metadata during "
        "enrollment. It can't be changed in the Admin Console or by using any Okta APIs.",
