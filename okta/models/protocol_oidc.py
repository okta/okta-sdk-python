...
class ProtocolOidc(BaseModel):
    ...
    okta_idp_org_url: Optional[StrictStr] = Field(
        default=None, description="URL of the IdP org", alias="oktaIdpOrgUrl"
    )
    scopes: Optional[List[StrictStr]] = Field(
        default=None,
        description="OpenID Connect and IdP-defined permission bundles to request delegated access from the user > **Note:** "
        "The [IdP type](https://developer.okta.com/docs/api/openapi/okta-management/management/tag"
    ...
    type: Optional[StrictStr] = Field(
        default=None, description="OpenID Connect Authorization Code flow"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "algorithms": (
                    OidcAlgorithms.from_dict(obj["algorithms"])
                    if obj.get("algorithms") is not None
                    else None
                ),
                "credentials": (
                    OAuthCredentials.from_dict(obj["credentials"])
                    if obj.get("credentials") is not None
                    else None
                ),
                "endpoints": (
                    OAuthEndpoints.from_dict(obj["endpoints"])
                ...
                "settings": (
                    OidcSettings.from_dict(obj["settings"])
