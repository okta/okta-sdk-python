...
class EntityRiskPolicyRuleActionsObject(BaseModel):
    """
    ...
    def action_validate_enum(cls, value):
        ...
        if value not in set(['RUN_WORKFLOW', 'TERMINATE_ALL_SESSIONS']):
            raise ValueError("must be one of enum values ('RUN_WORKFLOW', 'TERMINATE_ALL_SESSIONS')")
        return value
