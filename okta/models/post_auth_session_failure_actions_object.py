...
class PostAuthSessionFailureActionsObject(BaseModel):
    """
    ...
    def action_validate_enum(cls, value):
        ...
        if value not in set(['RUN_WORKFLOW', 'TERMINATE_SESSION']):
            raise ValueError("must be one of enum values ('RUN_WORKFLOW', 'TERMINATE_SESSION')")
        return value
