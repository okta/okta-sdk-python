...
class UserSchemaAttribute(BaseModel):
    ...
    UserSchemaAttribute
    """ # noqa: E501
    default: Optional[Any] = Field(default=None, description="If specified, assigns the value as the default value for the custom attribute. This is a nullable property. If you don't specify a value for this custom attribute during user creation or update, the `default` is used instead of setting the value to `null` or empty.")
    ...
    pattern: Optional[StrictStr] = Field(default=None, description="For `string` property types, specifies the regular expression used to validate the property")
    ...
    __properties: ClassVar[List[str]] = ["default", "description", "enum", "externalName", "externalNamespace", "format", "master", "maxLength", "minLength", "mutability", "oneOf", "pattern", "permissions", "required", "scope", "title", "type", "unique"]
