...
class Org2OrgApplication(BaseModel):
    ...
    following parameters in the request body. > **Notes:** > * The Okta Org2Org (`okta_org2org`) app isn't available in Okta
    Integrator Free Plan orgs. If you need to test this feature in your Integrator Free Plan org, contact your Okta account
    team. > * The Okta Org2Org app supports `SAML_2_0` and `AUTO_LOGIN` sign-on modes.
    """  # noqa: E501
        ...
        _obj = cls.model_validate(
            {
                ...
                "name": (
                    obj.get("name") if obj.get("name") is not None else "okta_org2org"
                ),
                "profile": obj.get("profile"),
                "signOnMode": (
                    obj.get("signOnMode")
                    if obj.get("signOnMode") is not None
                    else "SAML_2_0"
                ),
                ...
                "settings": (
                    Org2OrgApplicationSettings.from_dict(obj["settings"])
