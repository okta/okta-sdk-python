...
class UserFactorVerifyResponseWaiting(BaseModel):
    ...
    factor_result: Optional[UserFactorVerifyResultWaiting] = Field(
        default=None, alias="factorResult"
    )
    profile: Optional[Dict[str, Dict[str, Any]]] = None
    embedded: Optional[UserFactorVerifyResponseWaitingEmbedded] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "_embedded": (
                    UserFactorVerifyResponseWaitingEmbedded.from_dict(obj["_embedded"])
