...
class AuthenticatorMethodConstraint(BaseModel):
    """
    Limits the authenticators that can be used for a given method. Currently, only the `otp` method supports constraints,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "allowedAuthenticators": [AuthenticatorIdentity.from_dict(_item) for _item in
                                          obj["allowedAuthenticators"]] if obj.get(
