...
class UserFactorSecurityQuestion(UserFactor):
    """
    UserFactorSecurityQuestion
    """  # noqa: E501
    profile: Optional[UserFactorSecurityQuestionProfile] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "profile": UserFactorSecurityQuestionProfile.from_dict(obj["profile"]) if obj.get("profile") is not None else None,
