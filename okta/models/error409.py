...
class Error409(BaseModel):
    ...
    error_code: Optional[StrictStr] = Field(
        default=None, description="E0000254", alias="errorCode"
    )
    error_id: Optional[StrictStr] = Field(
        default=None, description="sampleH3iLB6bpBcbnV9E09Fy", alias="errorId"
    )
    error_link: Optional[StrictStr] = Field(
        default=None, description="E0000254", alias="errorLink"
    )
