...
class UserFactorVerifyResponseWaitingEmbedded(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserFactorVerifyResponseWaitingEmbedded from a JSON string"""
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.challenge:
            if not isinstance(self.challenge, dict):
                ...
                _dict["challenge"] = self.challenge
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserFactorVerifyResponseWaitingEmbedded from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "challenge": (
                    NumberFactorChallengeEmbeddedLinksChallenge.from_dict(
                        obj["challenge"]
                    )
                    if obj.get("challenge") is not None
                    else None
                )
            }
        )
