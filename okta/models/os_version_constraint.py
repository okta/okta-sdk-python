...
class OSVersionConstraint(BaseModel):
    ...
    dynamic_version_requirement: Optional[
        OSVersionConstraintDynamicVersionRequirement
    ] = Field(default=None, alias="dynamicVersionRequirement")
    ...
    def major_version_constraint_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["WINDOWS_11", "WINDOWS_10"]):
            raise ValueError("must be one of enum values ('WINDOWS_11', 'WINDOWS_10')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "dynamicVersionRequirement": (
                    OSVersionConstraintDynamicVersionRequirement.from_dict(
