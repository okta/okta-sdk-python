...
class AuthenticatorKeyDuoAllOfProvider(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['DUO']):
            raise ValueError("must be one of enum values ('DUO')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "type": obj.get("type"),
                "configuration": AuthenticatorKeyDuoAllOfProviderConfiguration.from_dict(obj["configuration"]) if obj.get(
                    "configuration"
