...
class GroupEmbeddedApp(BaseModel):
    ...
    id: Optional[StrictStr] = Field(
        default=None, description="The ID of the `AppInstance`"
    )
    name: Optional[StrictStr] = Field(
        default=None, description="The name of the `AppInstance`"
    )
    label: Optional[StrictStr] = Field(
        default=None, description="The user-facing display name of the `AppInstance`"
    )
