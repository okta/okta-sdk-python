...
class WellKnownOrgMetadataLinks(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.alternate:
            if not isinstance(self.alternate, dict):
                _dict['alternate'] = self.alternate.to_dict()
            else:
                _dict['alternate'] = self.alternate
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alternate": HrefObject.from_dict(obj["alternate"]) if obj.get("alternate") is not None else None,
            "organization": HrefObject.from_dict(obj["organization"]) if obj.get("organization") is not None else None
        })
        return _obj
