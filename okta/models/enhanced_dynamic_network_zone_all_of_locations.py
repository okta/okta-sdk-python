...
class EnhancedDynamicNetworkZoneAllOfLocations(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "include": EnhancedDynamicNetworkZoneAllOfLocationsInclude.from_dict(obj["include"]) if obj.get(
                    "include"
                ) is not None else None,
                "exclude": EnhancedDynamicNetworkZoneAllOfLocationsExclude.from_dict(obj["exclude"]) if obj.get(
                    "exclude"
                ) is not None else None
            }
        )
