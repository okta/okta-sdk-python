...
class SignInPageAllOfWidgetCustomizations(BaseModel):
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.post_auth_keep_me_signed_in_prompt:
            if not isinstance(self.post_auth_keep_me_signed_in_prompt, dict):
                _dict['postAuthKeepMeSignedInPrompt'] = self.post_auth_keep_me_signed_in_prompt.to_dict()
            else:
                _dict['postAuthKeepMeSignedInPrompt'] = self.post_auth_keep_me_signed_in_prompt
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "authenticatorPageCustomLinkLabel": obj.get("authenticatorPageCustomLinkLabel"),
            "authenticatorPageCustomLinkUrl": obj.get("authenticatorPageCustomLinkUrl"),
            ...
            "postAuthKeepMeSignedInPrompt": PostAuthKeepMeSignedInPrompt.from_dict(obj["postAuthKeepMeSignedInPrompt"]) if obj.get("postAuthKeepMeSignedInPrompt") is not None else None,
