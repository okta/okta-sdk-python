...
class RealmAssignmentOperationResponseAllOfAssignmentOperationConfiguration(BaseModel):
    ...
    id: Optional[StrictStr] = Field(
        default=None, description="ID of the realm assignment operation"
    )
    name: Optional[StrictStr] = Field(
        default=None, description="Name of the realm assignment operation"
    )
    __properties: ClassVar[List[str]] = ["actions", "conditions", "id", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "actions": (
                    RealmAssignmentOperationResponseAllOfAssignmentOperationConfigurationActions.from_dict(
                        obj["actions"]
                    )
