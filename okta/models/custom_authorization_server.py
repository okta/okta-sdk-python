...
class CustomAuthorizationServer(BaseModel):
    ...
    issuer_url: StrictStr = Field(
        description="Issuer URL for the authorization server", alias="issuerUrl"
    )
    logo: Optional[StrictStr] = Field(
        default=None, description="Image URL for the authorization server"
    )
    ...
    orn: StrictStr = Field(
        ...
        "-orn) of the authorization server"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "orn": obj.get("orn"),
                "_links": (
                    CustomAuthorizationServerLinks.from_dict(obj["_links"])
