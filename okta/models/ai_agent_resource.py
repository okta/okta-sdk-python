...
class AIAgentResource(BaseModel):
    """
    The AI agent resource associated with the operation. These properties are available after the operation completes
    successfully.
    """  # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "status", "type", "_links"]
