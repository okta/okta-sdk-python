...
class UIElement(BaseModel):
    ...
    scope: Optional[StrictStr] = Field(
        default=None,
        description="Specifies the property bound to the input field. It must follow the format "
                    "`#/properties/PROPERTY_NAME` where `PROPERTY_NAME` is a variable name for an attribute in `profile "
                    "editor`."
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "label": obj.get("label"),
                "options": UIElementOptions.from_dict(obj["options"]) if obj.get("options") is not None else None,
                "scope": obj.get("scope"),
                "type": obj.get("type")
            }
        )
