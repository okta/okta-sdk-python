...
class ContextPolicyRuleCondition(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["migrated", "platform", "rooted", "trustLevel", "expression"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "platform": DevicePolicyRuleConditionPlatform.from_dict(obj["platform"]) if obj.get(
                    "platform"
