...
class UserFactorYubikeyOtpToken(BaseModel):
    ...
    created: Optional[datetime] = Field(
        default=None, description="Timestamp when the token was created"
    )
    ...
    profile: Optional[Dict[str, Dict[str, Any]]] = Field(
        default=None, description="Specified profile information for token"
    )
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(
            ["BLOCKED", "UNASSIGNED", "ACTIVE", "REVOKED", "DELETED", "INACTIVE"]
        ):
            raise ValueError(
                "must be one of enum values ('BLOCKED', 'UNASSIGNED', 'ACTIVE', 'REVOKED', 'DELETED', 'INACTIVE')"
            )
        return value
