...
class UserFactorYubikeyOtpToken(BaseModel):
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['BLOCKED', 'UNASSIGNED', 'ACTIVE', 'REVOKED', 'DELETED', 'INACTIVE']):
            raise ValueError("must be one of enum values ('BLOCKED', 'UNASSIGNED', 'ACTIVE', 'REVOKED', 'DELETED', 'INACTIVE')")
        return value
