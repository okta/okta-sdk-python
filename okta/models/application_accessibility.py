...
class ApplicationAccessibility(BaseModel):
    ...
    login_redirect_url: Optional[StrictStr] = Field(
        default=None,
        description="Custom login page URL for the app > **Note:** The `loginRedirectUrl` property is deprecated in "
                    "Identity Engine. This property is used with the custom app login feature. Orgs that actively use this "
                    "feature can continue to do so. See [Okta-hosted sign-in (redirect authentication)]("
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "errorRedirectUrl": obj.get("errorRedirectUrl"),
                "loginRedirectUrl": obj.get("loginRedirectUrl"),
