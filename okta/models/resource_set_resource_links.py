...
class ResourceSetResourceLinks(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "self": (
                    ResourceSetResourceLinksSelf.from_dict(obj["self"])
                    if obj.get("self") is not None
                    else None
                ),
                "resource": (
                    ResourceSetResourceLinksResource.from_dict(obj["resource"])
                    if obj.get("resource") is not None
                    else None
                ),
                "groups": (
                    ResourceSetResourceLinksGroups.from_dict(obj["groups"])
                    if obj.get("groups") is not None
                    else None
                ),
                "users": (
                    ResourceSetResourceLinksUsers.from_dict(obj["users"])
