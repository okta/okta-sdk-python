...
class ProvisioningConditions(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "deprovisioned": ProvisioningDeprovisionedCondition.from_dict(obj["deprovisioned"]) if obj.get(
                    "deprovisioned"
                ) is not None else None,
                "suspended": ProvisioningSuspendedCondition.from_dict(obj["suspended"]) if obj.get(
                    "suspended"
                ) is not None else None
            }
        )
