...
class ScimScimServerConfig(BaseModel):
    ...
    change_password: Optional[ScimScimServerConfigChangePassword] = Field(
        default=None, alias="changePassword"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "patch": (
                    ScimScimServerConfigPatch.from_dict(obj["patch"])
                    if obj.get("patch") is not None
                    else None
                ),
                "changePassword": (
                    ScimScimServerConfigChangePassword.from_dict(obj["changePassword"])
