...
class EmailTemplateLinks(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "settings": HrefObject.from_dict(obj["settings"]) if obj.get("settings") is not None else None,
            "defaultContent": HrefObject.from_dict(obj["defaultContent"]) if obj.get("defaultContent") is not None else None,
            "customizations": HrefObject.from_dict(obj["customizations"]) if obj.get("customizations") is not None else None,
