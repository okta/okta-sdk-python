...
class Group(BaseModel):
    ...
    __properties: ClassVar[List[str]] = [
        "created", "id", "lastMembershipUpdated",
        ...
        _obj = cls.model_validate(
            {
                ...
                "id": obj.get("id"),
                "lastMembershipUpdated": obj.get("lastMembershipUpdated"),
                "lastUpdated": obj.get("lastUpdated"),
                "objectClass": obj.get("objectClass"),
                "profile": GroupProfile.from_dict(obj["profile"]) if obj.get("profile") is not None else None,
                "type": obj.get("type"),
                "_embedded": GroupEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None,
