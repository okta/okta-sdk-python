...
class UserImportResponse(BaseModel):
    ...
    commands: Optional[List[UserImportResponseCommandsInner]] = Field(
        default=None,
        description="The `commands` object is where you can provide commands to Okta. It is an array that allows you to send "
        ...
        _obj = cls.model_validate(
            {
                "commands": (
                    [
                        UserImportResponseCommandsInner.from_dict(_item)
                ...
                "error": (
                    UserImportResponseError.from_dict(obj["error"])
