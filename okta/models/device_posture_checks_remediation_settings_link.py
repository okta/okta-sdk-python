...
class DevicePostureChecksRemediationSettingsLink(BaseModel):
    ...
    default_url: Optional[StrictStr] = Field(
        default=None,
        description="Default URL for the link. This property is only relevant if type is set to `BUILTIN`. If type is set to "
        "`CUSTOM`, this field is ignored.",
        alias="defaultUrl",
    )
    custom_url: Optional[StrictStr] = Field(
        default=None, description="Custom URL for the link", alias="customUrl"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"defaultUrl": obj.get("defaultUrl"), "customUrl": obj.get("customUrl")}
        )
        return _obj
