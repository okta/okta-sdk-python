...
class AvailableActionProvider(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[WorkflowAvailableActionProvider]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[WorkflowAvailableActionProvider]]:
