...
class PrivilegedResourceFilters(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "appGroups": (
                    [AppGroup.from_dict(_item) for _item in obj["appGroups"]]
                    if obj.get("appGroups") is not None
                    else None
                ),
                "organizationalUnits": (
                    [
                        OrganizationalUnit.from_dict(_item)
                        for _item in obj["organizationalUnits"]
                    ]
                    if obj.get("organizationalUnits") is not None
                    else None
                ),
            }
        )
