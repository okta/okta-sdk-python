...
class UserGetSingletonAllOfEmbedded(BaseModel):
    ...
    blocks: Optional[List[UserBlock]] = Field(
        default=None, description="A list of access block details for the user account"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "blocks": (
                    [UserBlock.from_dict(_item) for _item in obj["blocks"]]
