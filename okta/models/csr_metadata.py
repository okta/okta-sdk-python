...
class CsrMetadata(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "subject": CsrMetadataSubject.from_dict(obj["subject"]) if obj.get("subject") is not None else None,
                "subjectAltNames": CsrMetadataSubjectAltNames.from_dict(obj["subjectAltNames"]) if obj.get(
                    "subjectAltNames"
