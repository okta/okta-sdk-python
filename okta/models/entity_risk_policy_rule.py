...
class EntityRiskPolicyRule(PolicyRule):
    """
    EntityRiskPolicyRule
    """ # noqa: E501
    actions: Optional[EntityRiskPolicyRuleAllOfActions] = None
    conditions: Optional[EntityRiskPolicyRuleConditions] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "actions": EntityRiskPolicyRuleAllOfActions.from_dict(obj["actions"]) if obj.get("actions") is not None else None,
            "conditions": EntityRiskPolicyRuleConditions.from_dict(obj["conditions"]) if obj.get("conditions") is not None else None
        })
        return _obj
