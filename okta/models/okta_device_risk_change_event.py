...
class OktaDeviceRiskChangeEvent(BaseModel):
    ...
    def current_level_validate_enum(cls, value):
        ...
        if value not in set(['low', 'medium', 'high', 'secure', 'none']):
            raise ValueError("must be one of enum values ('low', 'medium', 'high', 'secure', 'none')")
        return value
    ...
    def initiating_entity_validate_enum(cls, value):
        ...
        if value not in set(['admin', 'user', 'policy', 'system']):
            raise ValueError("must be one of enum values ('admin', 'user', 'policy', 'system')")
        return value
