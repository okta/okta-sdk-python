...
class BehaviorRuleSettingsAnomalousIP(BaseModel):
    ...
    """ # noqa: E501
    max_events_used_for_evaluation: Optional[Annotated[int, Field(le=100, strict=True, ge=0)]] = Field(default=50, alias="maxEventsUsedForEvaluation")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "maxEventsUsedForEvaluation": obj.get("maxEventsUsedForEvaluation") if obj.get("maxEventsUsedForEvaluation") is not None else 50,
