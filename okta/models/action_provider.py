...
class ActionProvider(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[WorkflowActionProvider]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[WorkflowActionProvider]]:
        ...
        raise ValueError(
            "ActionProvider failed to lookup discriminator value from "
            + json.dumps(obj)
