...
class OktaSignOnPolicyRule(PolicyRule):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "actions": OktaSignOnPolicyRuleActions.from_dict(obj["actions"]) if obj.get("actions") is not None else None,
            "conditions": OktaSignOnPolicyRuleConditions.from_dict(obj["conditions"]) if obj.get("conditions") is not None else None
        })
        return _obj
