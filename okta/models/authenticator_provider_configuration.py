...
class AuthenticatorProviderConfiguration(BaseModel):
    ...
    user_name_template: Optional[AuthenticatorProviderConfigurationUserNameTemplate] = (
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "authPort": obj.get("authPort"),
                "hostName": obj.get("hostName"),
                "instanceId": obj.get("instanceId"),
                "sharedSecret": obj.get("sharedSecret"),
                "userNameTemplate": (
                    AuthenticatorProviderConfigurationUserNameTemplate.from_dict(
