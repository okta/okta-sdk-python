...
class AIAgent(BaseModel):
    ...
    created: Optional[datetime] = Field(
        default=None, description="Timestamp when the AI agent was created"
    )
    id: Optional[StrictStr] = Field(
        default=None, description="Unique ID for the AI agent"
    )
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(["ACTIVE", "INACTIVE", "STAGED"]):
            raise ValueError(
                "must be one of enum values ('ACTIVE', 'INACTIVE', 'STAGED')"
            )
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "profile": (
                    AIAgentProfile.from_dict(obj["profile"])
