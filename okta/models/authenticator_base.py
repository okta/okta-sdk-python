...
class AuthenticatorBase(BaseModel):
    ...
    AuthenticatorBase
    """  # noqa: E501
    created: Optional[datetime] = Field(default=None, description="Timestamp when the authenticator was created")
    id: Optional[StrictStr] = Field(default=None, description="A unique identifier for the authenticator")
    key: Optional[AuthenticatorKeyEnum] = None
    last_updated: Optional[datetime] = Field(
        default=None,
        description="Timestamp when the authenticator was last modified",
        alias="lastUpdated")
    name: Optional[StrictStr] = Field(default=None, description="Display name of the authenticator")
    status: Optional[LifecycleStatus] = None
    type: Optional[AuthenticatorType] = None
    links: Optional[AuthenticatorLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["created", "id", "key", "lastUpdated", "name", "status", "type", "_links"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[AuthenticatorKeyCustomApp, AuthenticatorKeyDuo, AuthenticatorKeyExternalIdp, AuthenticatorKeyGoogleOtp, AuthenticatorKeyEmail, AuthenticatorKeyPassword, AuthenticatorKeyOktaVerify, AuthenticatorKeyOnprem,
                                                        AuthenticatorKeyPhone, AuthenticatorKeySecurityKey, AuthenticatorKeySecurityQuestion, AuthenticatorKeySmartCard, AuthenticatorKeySymantecVip, AuthenticatorKeyTac, AuthenticatorKeyWebauthn, AuthenticatorKeyYubikey, AuthenticatorSimple]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AuthenticatorKeyCustomApp, AuthenticatorKeyDuo, AuthenticatorKeyExternalIdp, AuthenticatorKeyGoogleOtp, AuthenticatorKeyEmail, AuthenticatorKeyPassword, AuthenticatorKeyOktaVerify, AuthenticatorKeyOnprem,
                                                              AuthenticatorKeyPhone, AuthenticatorKeySecurityKey, AuthenticatorKeySecurityQuestion, AuthenticatorKeySmartCard, AuthenticatorKeySymantecVip, AuthenticatorKeyTac, AuthenticatorKeyWebauthn, AuthenticatorKeyYubikey, AuthenticatorSimple]]:
        """Create an instance of AuthenticatorBase from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type == 'AuthenticatorKeyCustomApp':
            return import_module("okta.models.authenticator_key_custom_app").AuthenticatorKeyCustomApp.from_dict(obj)
        if object_type == 'AuthenticatorKeyDuo':
            return import_module("okta.models.authenticator_key_duo").AuthenticatorKeyDuo.from_dict(obj)
        if object_type == 'AuthenticatorKeyExternalIdp':
            return import_module("okta.models.authenticator_key_external_idp").AuthenticatorKeyExternalIdp.from_dict(obj)
        if object_type == 'AuthenticatorKeyGoogleOtp':
            return import_module("okta.models.authenticator_key_google_otp").AuthenticatorKeyGoogleOtp.from_dict(obj)
        if object_type == 'AuthenticatorKeyEmail':
            return import_module("okta.models.authenticator_key_email").AuthenticatorKeyEmail.from_dict(obj)
        if object_type == 'AuthenticatorKeyPassword':
            return import_module("okta.models.authenticator_key_password").AuthenticatorKeyPassword.from_dict(obj)
        if object_type == 'AuthenticatorKeyOktaVerify':
            return import_module("okta.models.authenticator_key_okta_verify").AuthenticatorKeyOktaVerify.from_dict(obj)
        if object_type == 'AuthenticatorKeyOnprem':
            return import_module("okta.models.authenticator_key_onprem").AuthenticatorKeyOnprem.from_dict(obj)
        if object_type == 'AuthenticatorKeyPhone':
            return import_module("okta.models.authenticator_key_phone").AuthenticatorKeyPhone.from_dict(obj)
        ...
        if object_type == 'AuthenticatorKeySymantecVip':
            return import_module("okta.models.authenticator_key_symantec_vip").AuthenticatorKeySymantecVip.from_dict(obj)
        if object_type == 'AuthenticatorKeyTac':
            return import_module("okta.models.authenticator_key_tac").AuthenticatorKeyTac.from_dict(obj)
        if object_type == 'AuthenticatorKeyWebauthn':
            return import_module("okta.models.authenticator_key_webauthn").AuthenticatorKeyWebauthn.from_dict(obj)
        ...
        if object_type == 'AuthenticatorSimple':
            return import_module("okta.models.authenticator_simple").AuthenticatorSimple.from_dict(obj)

        raise ValueError("AuthenticatorBase failed to lookup discriminator value from " +
