...
class PageRootLinks(BaseModel):
    ...
    preview: Optional[HrefObject] = None
    __properties: ClassVar[List[str]] = ["self", "default", "customized", "preview"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "default": HrefObject.from_dict(obj["default"]) if obj.get("default") is not None else None,
                "customized": HrefObject.from_dict(obj["customized"]) if obj.get("customized") is not None else None,
