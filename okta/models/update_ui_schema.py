...
class UpdateUISchema(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.ui_schema:
            if not isinstance(self.ui_schema, dict):
                _dict["uiSchema"] = self.ui_schema.to_dict()
            else:
                _dict["uiSchema"] = self.ui_schema
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "uiSchema": (
                    UISchemaObject.from_dict(obj["uiSchema"])
                    if obj.get("uiSchema") is not None
                    else None
                )
            }
        )
