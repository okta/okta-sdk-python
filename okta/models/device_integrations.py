...
class DeviceIntegrations(BaseModel):
    ...
    id: Optional[StrictStr] = Field(
        default=None, description="The ID of the device integration"
    )
    metadata: Optional[DeviceIntegrationsMetadata] = None
    name: Optional[DeviceIntegrationsName] = None
    platform: Optional[DeviceIntegrationsPlatform] = None
    status: Optional[DeviceIntegrationsStatus] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "id": obj.get("id"),
                "metadata": (
                    DeviceIntegrationsMetadata.from_dict(obj["metadata"])
