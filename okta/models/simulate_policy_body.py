...
class SimulatePolicyBody(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of policy_context
        if self.policy_context:
            if not isinstance(self.policy_context, dict):
                _dict["policyContext"] = self.policy_context.to_dict()
            else:
                _dict["policyContext"] = self.policy_context
