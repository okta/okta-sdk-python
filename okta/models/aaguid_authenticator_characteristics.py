...
class AAGUIDAuthenticatorCharacteristics(BaseModel):
    ...
    fips_compliant: Optional[StrictBool] = Field(
        default=None,
        description="Indicates whether the authenticator meets Federal Information Processing Standards (FIPS) compliance "
        "requirements",
        alias="fipsCompliant",
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "hardwareProtected": obj.get("hardwareProtected"),
