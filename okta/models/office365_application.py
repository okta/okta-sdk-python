...
class Office365Application(BaseModel):
    ...
    request with the following parameters in the request body. > **Note:** The Office 365 app only supports `BROWSER_PLUGIN`
    and `SAML_1_1` sign-on modes.
    """  # noqa: E501
    ...
    def sign_on_mode_validate_enum(cls, value):
        ...
        if value not in set(["BROWSER_PLUGIN", "SAML_1_1"]):
            raise ValueError(
                "must be one of enum values ('BROWSER_PLUGIN', 'SAML_1_1')"
            )
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "name": obj.get("name") if obj.get("name") is not None else "office365",
                ...
                "settings": (
                    Office365ApplicationSettings.from_dict(obj["settings"])
