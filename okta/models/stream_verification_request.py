...
class StreamVerificationRequest(BaseModel):
    ...
    state: Optional[StrictStr] = Field(
        default=None,
        description="An arbitrary string that Okta as a transmitter must echo back to the Event Receiver in the Verification "
        "Event's payload",
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"state": obj.get("state"), "stream_id": obj.get("stream_id")}
        )
        return _obj
