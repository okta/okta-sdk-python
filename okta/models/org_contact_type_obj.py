...
class OrgContactTypeObj(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Optional[
            Union[OrgBillingContactType, OrgTechnicalContactType]
        ] = None
    else:
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if not isinstance(v, OrgBillingContactType):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `OrgBillingContactType`"
            )
        else:
            return v
        ...
        if not isinstance(v, OrgTechnicalContactType):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `OrgTechnicalContactType`"
            )
        else:
            return v
    ...
    def to_dict(
        ...
        Union[Dict[str, Any], OrgBillingContactType, OrgTechnicalContactType]
    ]:
