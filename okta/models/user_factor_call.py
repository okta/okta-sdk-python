...
class UserFactorCall(UserFactor):
    """
    UserFactorCall
    """ # noqa: E501
    profile: Optional[UserFactorCallProfile] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "profile": UserFactorCallProfile.from_dict(obj["profile"]) if obj.get("profile") is not None else None,
