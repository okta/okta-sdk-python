...
class OrgTechnicalContactTypeLinks(BaseModel):
    ...
    Contact Type object using the [JSON Hypertext Application Language](
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.technical:
            if not isinstance(self.technical, dict):
                _dict["technical"] = self.technical.to_dict()
            else:
                _dict["technical"] = self.technical
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "technical": (
                    OrgTechnicalContactTypeLinksTechnical.from_dict(obj["technical"])
                    if obj.get("technical") is not None
                    else None
                )
            }
        )
