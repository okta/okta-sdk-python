...
class AuthorizationServerPolicyRuleConditions(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["grantTypes", "people", "scopes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "people": AuthorizationServerPolicyPeopleCondition.from_dict(obj["people"]) if obj.get("people") is not None else None,
