...
class ProtocolEndpoints(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "acs": ProtocolEndpoint.from_dict(obj["acs"]) if obj.get("acs") is not None else None,
            "authorization": ProtocolEndpoint.from_dict(obj["authorization"]) if obj.get("authorization") is not None else None,
            "jwks": ProtocolEndpoint.from_dict(obj["jwks"]) if obj.get("jwks") is not None else None,
            "metadata": ProtocolEndpoint.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "slo": ProtocolEndpoint.from_dict(obj["slo"]) if obj.get("slo") is not None else None,
            "sso": ProtocolEndpoint.from_dict(obj["sso"]) if obj.get("sso") is not None else None,
            "token": ProtocolEndpoint.from_dict(obj["token"]) if obj.get("token") is not None else None,
            "userInfo": ProtocolEndpoint.from_dict(obj["userInfo"]) if obj.get("userInfo") is not None else None
        })
        return _obj
