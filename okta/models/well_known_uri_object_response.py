...
class WellKnownURIObjectResponse(BaseModel):
    """
    WellKnownURIObjectResponse
    """  # noqa: E501

    representation: Optional[Dict[str, Any]] = Field(
        default=None, description="The well-known URI content in JSON format"
    )
    links: Optional[WellKnownURIArrayResponseLinks] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "_links": (
                    WellKnownURIArrayResponseLinks.from_dict(obj["_links"])
