...
class EmailPreview(EmailContentWithSender):
    ...
    swagger_types['links'] = 'EmailPreviewLinks'

    attribute_map = {
        'links': '_links'
    }
    if hasattr(EmailContentWithSender, "attribute_map"):
        attribute_map.update(EmailContentWithSender.attribute_map)
    ...
    def set_attributes(self, links=None, **kwargs):  # noqa: E501
        """EmailPreview - a model defined in Swagger"""  # noqa: E501
        config = {}
    ...
    @property
    def links(self):
        """Gets the links of this EmailPreview.  # noqa: E501


        :return: The links of this EmailPreview.  # noqa: E501
        :rtype: EmailPreviewLinks
        """
        return self._links

    @links.setter
    def links(self, links):
        """Sets the links of this EmailPreview.


        :param links: The links of this EmailPreview.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EmailPreview, dict):
