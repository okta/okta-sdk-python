        ...
        _obj = cls.model_validate(
            {
                ...
                "apple-app-site-association": HrefObject.from_dict(obj["apple-app-site-association"]) if obj.get(
                    "apple-app-site-association"
                ) is not None else None,
                "assetlinks.json": HrefObject.from_dict(obj["assetlinks.json"]) if obj.get(
                    "assetlinks.json"
                ) is not None else None,
