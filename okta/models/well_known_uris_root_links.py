...
class WellKnownURIsRootLinks(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["self", "apple-app-site-association", "assetlinks.json", "webauthn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "apple-app-site-association": HrefObject.from_dict(obj["apple-app-site-association"]) if obj.get("apple-app-site-association") is not None else None,
            "assetlinks.json": HrefObject.from_dict(obj["assetlinks.json"]) if obj.get("assetlinks.json") is not None else None,
