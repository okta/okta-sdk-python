...
class AuthenticatorKeyCustomAppAllOfProviderConfiguration(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "apns": AuthenticatorKeyCustomAppAllOfProviderConfigurationApns.from_dict(obj["apns"]) if obj.get(
                    "apns"
                ) is not None else None,
                "fcm": AuthenticatorKeyCustomAppAllOfProviderConfigurationFcm.from_dict(obj["fcm"]) if obj.get(
                    "fcm"
                ) is not None else None
            }
        )
