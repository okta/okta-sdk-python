...
class UserFactorPushTransactionRejectedAllOfLinks(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserFactorPushTransactionRejectedAllOfLinks from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserFactorPushTransactionRejectedAllOfLinks from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "factor": (
                    UserFactor.from_dict(obj["factor"])
