...
class SmsTemplate(BaseModel):
    ...
    translations: Optional[Dict[str, Any]] = Field(
        ...
        description="- Template translations are optionally provided when you want to localize the SMS messages. "
                    "Translations are provided as an object that contains `key:value` pairs: the language and the "
                    "translated Template text. The key portion is a two-letter country code that conforms to [ISO 639-1]("
