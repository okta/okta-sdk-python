...
class IdentityProviderCredentials(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "client": (
                    IdentityProviderCredentialsClient.from_dict(obj["client"])
                    if obj.get("client") is not None
                    else None
                ),
                "signing": (
                    IdentityProviderCredentialsSigning.from_dict(obj["signing"])
                    if obj.get("signing") is not None
                    else None
                ),
                "trust": (
                    IdentityProviderCredentialsTrust.from_dict(obj["trust"])
                    if obj.get("trust") is not None
                    else None
                ),
            }
        )
