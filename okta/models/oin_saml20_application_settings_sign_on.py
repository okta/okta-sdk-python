...
class OINSaml20ApplicationSettingsSignOn(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.audience_override is None and "audience_override" in self.model_fields_set:
            _dict['audienceOverride'] = None

        # set to None if default_relay_state (nullable) is None
        # and model_fields_set contains the field
        if self.default_relay_state is None and "default_relay_state" in self.model_fields_set:
            _dict['defaultRelayState'] = None

        # set to None if destination_override (nullable) is None
        # and model_fields_set contains the field
        if self.destination_override is None and "destination_override" in self.model_fields_set:
            _dict['destinationOverride'] = None

        # set to None if recipient_override (nullable) is None
        # and model_fields_set contains the field
        if self.recipient_override is None and "recipient_override" in self.model_fields_set:
            _dict['recipientOverride'] = None

        # set to None if sso_acs_url_override (nullable) is None
        # and model_fields_set contains the field
        if self.sso_acs_url_override is None and "sso_acs_url_override" in self.model_fields_set:
