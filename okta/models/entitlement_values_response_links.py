...
class EntitlementValuesResponseLinks(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["self", "bundle", "entitlements", "next"]
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.entitlements:
            if not isinstance(self.entitlements, dict):
                ...
                _dict['entitlements'] = self.entitlements
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bundle": BundleLink.from_dict(obj["bundle"]) if obj.get("bundle") is not None else None,
            "entitlements": EntitlementsLink.from_dict(obj["entitlements"]) if obj.get("entitlements") is not None else None,
