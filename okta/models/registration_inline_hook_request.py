...
class RegistrationInlineHookRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[RegistrationInlineHookPPData, RegistrationInlineHookSSRData]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[RegistrationInlineHookPPData, RegistrationInlineHookSSRData]]:
