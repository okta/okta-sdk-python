...
class SalesforceApplication(BaseModel):
    ...
    def sign_on_mode_validate_enum(cls, value):
        ...
        if value not in set(["BROWSER_PLUGIN", "BOOKMARK", "SAML_2_0"]):
            raise ValueError(
                "must be one of enum values ('BROWSER_PLUGIN', 'BOOKMARK', 'SAML_2_0')"
            )
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "name": (
                    obj.get("name") if obj.get("name") is not None else "salesforce"
                ),
                ...
                "settings": (
                    SalesforceApplicationSettings.from_dict(obj["settings"])
