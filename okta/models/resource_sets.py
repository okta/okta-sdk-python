...
class ResourceSets(BaseModel):
    ...
    resource_sets: Optional[List[ResourceSet]] = Field(
        default=None, alias="resource-sets"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in resource_sets (list)
        _items = []
        if self.resource_sets:
            for _item in self.resource_sets:
                if _item:
                    _items.append(_item.to_dict())
            _dict["resource-sets"] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "resource-sets": (
                    [ResourceSet.from_dict(_item) for _item in obj["resource-sets"]]
                    if obj.get("resource-sets") is not None
                    else None
                ),
                "_links": (
