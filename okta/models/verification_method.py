...
class VerificationMethod(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ASSURANCE': 'AssuranceMethod', 'AUTH_METHOD_CHAIN': 'AuthenticationMethodChainMethod',
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[AssuranceMethod, AuthenticationMethodChainMethod, IdProofingMethod]]:
