...
class TokenHookResponseCommandsInnerValueInner(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "op": obj.get("op"),
            "path": obj.get("path"),
            "value": TokenHookResponseCommandsInnerValueInnerValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
