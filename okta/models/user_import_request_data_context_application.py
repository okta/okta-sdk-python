...
class UserImportRequestDataContextApplication(BaseModel):
    ...
    label: Optional[StrictStr] = Field(
        default=None, description="The user-defined display name for the app"
    )
    status: Optional[StrictStr] = Field(
        default=None, description="The status of the app"
    )
    __properties: ClassVar[List[str]] = ["name", "id", "label", "status"]
