...
class LogEvent(BaseModel):
    ...
    display_message: Optional[StrictStr] = Field(default=None, description="The display message for an event", alias="displayMessage")
    event_type: Optional[StrictStr] = Field(default=None, description="The published event type. Event instances are categorized by action in the event type attribute. This attribute is key to navigating the System Log through expression filters. See [Event Types catalog](https://developer.okta.com/docs/reference/api/event-types/#catalog) for a complete list of System Log event types.", alias="eventType")
    legacy_event_type: Optional[StrictStr] = Field(default=None, description="Associated Events API Action `objectType` attribute value", alias="legacyEventType")
