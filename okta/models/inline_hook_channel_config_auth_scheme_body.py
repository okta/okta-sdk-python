...
class InlineHookChannelConfigAuthSchemeBody(BaseModel):
    ...
    key: Optional[StrictStr] = Field(
        default=None, description="The header name for the authorization server"
    )
    ...
    value: Optional[StrictStr] = Field(
        default=None,
        description="The header value. This secret value is passed to your external service endpoint. Your external service "
        "can check it as a security measure.",
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"key": obj.get("key"), "type": obj.get("type"), "value": obj.get("value")}
        )
        return _obj
