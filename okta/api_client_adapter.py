...
class ApiClientAdapter(ApiClient):
    ...
    async def execute(self, request):
        req_info, response, response_data, error = await self.rest_client.send_request(request)
        # use request instead of req_info for correct pagination
        return (request, response, response_data, error)
    ...
    async def __call_api(
        ...
        request, err = await self.create_request(method=method,
                                                 url=url,
