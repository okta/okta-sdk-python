    ...
    def __init__(
        ...
        if self.configuration.event_listeners is not None:
            if len(self.configuration.event_listeners["call_api_started"]) > 0:
                for listener in self.configuration.event_listeners["call_api_started"]:
                    self.call_api_started.connect(listener)
            if len(self.configuration.event_listeners["call_api_complete"]) > 0:
                for listener in self.configuration.event_listeners["call_api_complete"]:
    ...
    def call_api(
        ...
        try:
            ...
            response_data = self.rest_client.request(
                ...
                body=call_info.body,
                post_params=call_info.post_params,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(okta.models, klass)
