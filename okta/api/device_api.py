...
class DeviceApi(ApiClient):
    ...
    async def deactivate_device(
        ...
        method, url, header_params, body, post_params = self._deactivate_device_serialize(
            device_id=device_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def get_device(
        ...
        if Device is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, Device)
    ...
    async def list_device_users(
        ...
        method, url, header_params, body, post_params = self._list_device_users_serialize(
            device_id=device_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        if List[DeviceUser] is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, DeviceUser)
    ...
    async def list_devices(
        ...
        :type limit: int
        :param search: A SCIM filter expression that filters the results. Searches include all Device `profile` properties and the Device `id`, `status`, and `lastUpdated` properties.
        :type search: str
    ...
    async def unsuspend_device(
        ...
        method, url, header_params, body, post_params = self._unsuspend_device_serialize(
            device_id=device_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
