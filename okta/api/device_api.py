...
class DeviceApi(ApiClient):
    ...
    async def list_devices(
        ...
        expand: Annotated[Optional[StrictStr], Field(description="Includes associated user details and management status for the device in the `_embedded` attribute")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        if List[DeviceList] is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, DeviceList)
