...
class RoleAssignmentAUserApi(ApiClient):
    ...
    async def assign_role_to_user(
        ...
        method, url, header_params, body, post_params = self._assign_role_to_user_serialize(
            user_id=user_id,
        ...
        if AssignRoleToUser201Response is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, AssignRoleToUser201Response)
    ...
    async def get_role_assignment_governance_grant(
        ...
        method, url, header_params, body, post_params = self._get_role_assignment_governance_grant_serialize(
            user_id=user_id,
        ...
        if RoleGovernanceSource is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, RoleGovernanceSource)
    ...
    async def get_role_assignment_governance_grant_resources(
        ...
        method, url, header_params, body, post_params = self._get_role_assignment_governance_grant_resources_serialize(
            user_id=user_id,
            role_assignment_id=role_assignment_id,
            grant_id=grant_id,
            _request_auth=_request_auth,
        ...
        if RoleGovernanceResources is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, RoleGovernanceResources)
    ...
    async def get_user_assigned_role(
        ...
        method, url, header_params, body, post_params = self._get_user_assigned_role_serialize(
            user_id=user_id,
            role_assignment_id=role_assignment_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        if AssignRoleToGroup200Response is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, AssignRoleToGroup200Response)
    ...
    async def get_user_assigned_role_governance(
        ...
        method, url, header_params, body, post_params = self._get_user_assigned_role_governance_serialize(
            user_id=user_id,
            role_assignment_id=role_assignment_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        if RoleGovernance is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, RoleGovernance)
    ...
    async def list_assigned_roles_for_user(
        self,
        user_id: Annotated[StrictStr, Field(description="ID of an existing Okta user")],
        expand: Annotated[Optional[StrictStr], Field(description="An optional parameter used to return targets configured for the standard role assignment in the `embedded` property. Supported values: `targets/groups` or `targets/catalog/apps`")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        method, url, header_params, body, post_params = self._list_assigned_roles_for_user_serialize(
            user_id=user_id,
            expand=expand,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def list_users_with_role_assignments(
        self,
        after: Annotated[Optional[StrictStr], Field(description="Specifies the pagination cursor for the next page of targets")] = None,
        ...
        method, url, header_params, body, post_params = self._list_users_with_role_assignments_serialize(
            after=after,
            limit=limit,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        if RoleAssignedUsers is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, RoleAssignedUsers)
    ...
    async def unassign_role_from_user(
        ...
        method, url, header_params, body, post_params = self._unassign_role_from_user_serialize(
            user_id=user_id,
            role_assignment_id=role_assignment_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
