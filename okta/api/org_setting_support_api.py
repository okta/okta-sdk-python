...
class OrgSettingSupportApi(ApiClient):
    ...
    async def extend_okta_support(
        ...
        """ # noqa: E501
        warnings.warn("POST /api/v1/org/privacy/oktaSupport/extend is deprecated.", DeprecationWarning)
    ...
    async def get_aerial_consent(
        ...
        method, url, header_params, body, post_params = self._get_aerial_consent_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        if OrgAerialConsentDetails is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, OrgAerialConsentDetails)
    ...
    async def grant_aerial_consent(
        ...
        method, url, header_params, body, post_params = self._grant_aerial_consent_serialize(
    ...
    async def grant_okta_support(
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("POST /api/v1/org/privacy/oktaSupport/grant is deprecated.", DeprecationWarning)
    ...
    async def list_okta_support_cases(
        ...
        method, url, header_params, body, post_params = self._list_okta_support_cases_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        if OktaSupportCases is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, OktaSupportCases)
    ...
    async def revoke_aerial_consent(
        ...
        method, url, header_params, body, post_params = self._revoke_aerial_consent_serialize(
            org_aerial_consent=org_aerial_consent,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        if OrgAerialConsentRevoked is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, OrgAerialConsentRevoked)
    ...
    async def revoke_okta_support(
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("POST /api/v1/org/privacy/oktaSupport/revoke is deprecated.", DeprecationWarning)
    ...
    async def update_okta_support_case(
        ...
        method, url, header_params, body, post_params = self._update_okta_support_case_serialize(
        ...
        if OktaSupportCase is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, OktaSupportCase)
