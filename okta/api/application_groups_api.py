...
class ApplicationGroupsApi(ApiClient):
    ...
    async def assign_group_to_application(
        ...
        method, url, header_params, body, post_params = self._assign_group_to_application_serialize(
            app_id=app_id,
            group_id=group_id,
        ...
        if ApplicationGroupAssignment is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, ApplicationGroupAssignment)
    ...
    async def get_application_group_assignment(
        ...
        app_id: Annotated[StrictStr, Field(description="Application ID")],
        group_id: Annotated[StrictStr, Field(description="The `id` of the group")],
        expand: Annotated[Optional[StrictStr], Field(description="An optional query parameter to return the corresponding assigned [group](https://developer.okta.com/docs/api/openapi/okta-management/management/tag/Group/) or the group assignment metadata details in the `_embedded` property.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        method, url, header_params, body, post_params = self._get_application_group_assignment_serialize(
            app_id=app_id,
            group_id=group_id,
            expand=expand,
            _request_auth=_request_auth,
    ...
    async def list_application_group_assignments(
        ...
        after: Annotated[Optional[StrictStr], Field(description="Specifies the pagination cursor for the `next` page of results. Treat this as an opaque value obtained through the next link relationship. See [Pagination](https://developer.okta.com/docs/api/#pagination).")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True, ge=20)]], Field(description="Specifies the number of objects to return per page. If there are multiple pages of results, the Link header contains a `next` link that you need to use as an opaque value (follow it, don't parse it). See [Pagination](/#pagination).")] = None,
        expand: Annotated[Optional[StrictStr], Field(description="An optional query parameter to return the corresponding assigned [group](https://developer.okta.com/docs/api/openapi/okta-management/management/tag/Group/) or the group assignment metadata details in the `_embedded` property.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        method, url, header_params, body, post_params = self._list_application_group_assignments_serialize(
            app_id=app_id,
            q=q,
            after=after,
            limit=limit,
    ...
    async def unassign_application_from_group(
        ...
        method, url, header_params, body, post_params = self._unassign_application_from_group_serialize(
            app_id=app_id,
            group_id=group_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def update_group_assignment_to_application(
        ...
        method, url, header_params, body, post_params = self._update_group_assignment_to_application_serialize(
            app_id=app_id,
            group_id=group_id,
