...
class UserFactorApi(ApiClient):
    ...
    async def activate_factor(
        ...
        if UserFactorActivateResponse is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, UserFactorActivateResponse)
    ...
    async def enroll_factor(
        ...
        update_phone: Annotated[Optional[StrictBool], Field(description="If `true`, indicates that you are replacing the currently registered phone number for the specified user. This parameter is ignored if the existing phone number is used by an activated factor.")] = None,
        template_id: Annotated[Optional[StrictStr], Field(description="ID of an existing custom SMS template. See the [SMS Templates API](../Template). This parameter is only used by `sms` factors. If the provided ID doesn't exist, the default template is used instead.")] = None,
        token_lifetime_seconds: Annotated[Optional[Annotated[int, Field(le=86400, strict=True, ge=1)]], Field(description="Defines how long the token remains valid")] = None,
        activate: Annotated[Optional[StrictBool], Field(description="If `true`, the factor is immediately activated as part of the enrollment. An activation process isn't required. Currently auto-activation is supported by `sms`, `call`, `email` and `token:hotp` (Custom TOTP) factors.")] = None,
        accept_language: Annotated[Optional[StrictStr], Field(description="An ISO 639-1 two-letter language code that defines a localized message to send. This parameter is only used by `sms` factors. If a localized message doesn't exist or the `templateId` is incorrect, the default template is used instead.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        if UserFactor is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, UserFactor)
    ...
    async def get_factor_transaction_status(
        ...
        method, url, header_params, body, post_params = self._get_factor_transaction_status_serialize(
            user_id=user_id,
            factor_id=factor_id,
        ...
        if UserFactorPushTransaction is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, UserFactorPushTransaction)
    ...
    async def get_yubikey_otp_token_by_id(
        ...
        method, url, header_params, body, post_params = self._get_yubikey_otp_token_by_id_serialize(
            token_id=token_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        if UserFactorYubikeyOtpToken is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, UserFactorYubikeyOtpToken)
    ...
    async def list_supported_factors(
        ...
        method, url, header_params, body, post_params = self._list_supported_factors_serialize(
            user_id=user_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        if List[UserFactorSupported] is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, UserFactorSupported)
    ...
    async def list_supported_security_questions(
        ...
        method, url, header_params, body, post_params = self._list_supported_security_questions_serialize(
            user_id=user_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        if List[UserFactorSecurityQuestionProfile] is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, UserFactorSecurityQuestionProfile)
    ...
    async def list_yubikey_otp_tokens(
        self,
        after: Annotated[Optional[StrictStr], Field(description="Specifies the pagination cursor for the next page of tokens")] = None,
        expand: Annotated[Optional[StrictStr], Field(description="Embeds the [user](/openapi/okta-management/management/tag/User/) resource if the YubiKey token is assigned to a user and `expand` is set to `user`")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="The expression used to filter tokens")] = None,
        for_download: Annotated[Optional[StrictBool], Field(description="Returns tokens in a CSV to download instead of in the response. When you use this query parameter, the `limit` default changes to 1000.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True)]], Field(description="Specifies the number of results per page")] = None,
        sort_by: Annotated[Optional[StrictStr], Field(description="The value of how the tokens are sorted")] = None,
        sort_order: Annotated[Optional[StrictStr], Field(description="Specifies the sort order, either `ASC` or `DESC`")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        method, url, header_params, body, post_params = self._list_yubikey_otp_tokens_serialize(
            after=after,
            expand=expand,
            filter=filter,
    ...
    async def resend_enroll_factor(
        ...
        template_id: Annotated[Optional[StrictStr], Field(description="ID of an existing custom SMS template. See the [SMS Templates API](../Template). This parameter is only used by `sms` factors.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        method, url, header_params, body, post_params = self._resend_enroll_factor_serialize(
            user_id=user_id,
            factor_id=factor_id,
        ...
        if ResendUserFactor is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, ResendUserFactor)
    ...
    async def unenroll_factor(
        ...
        user_id: Annotated[StrictStr, Field(description="ID of an existing Okta user")],
        factor_id: Annotated[StrictStr, Field(description="ID of an existing user factor")],
        remove_recovery_enrollment: Annotated[Optional[StrictBool], Field(description="If `true`, removes the phone number as both a recovery method and a factor. This parameter is only used for the `sms` and `call` factors.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def upload_yubikey_otp_token_seed(
        ...
        method, url, header_params, body, post_params = self._upload_yubikey_otp_token_seed_serialize(
    ...
    async def verify_factor(
        ...
        user_agent: Annotated[Optional[StrictStr], Field(description="Type of user agent detected when the request is made. Required to verify `push` factors.")] = None,
        accept_language: Annotated[Optional[StrictStr], Field(description="An ISO 639-1 two-letter language code that defines a localized message to send. This parameter is only used by `sms` factors. If a localized message doesn't exist or the `templateId` is incorrect, the default template is used instead.")] = None,
        ...
        if UserFactorVerifyResponse is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, UserFactorVerifyResponse)
