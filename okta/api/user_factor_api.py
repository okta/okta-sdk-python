...
class UserFactorApi(ApiClient):
    ...
    async def get_factor_transaction_status(
        ...
        if VerifyUserFactorResponse is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, VerifyUserFactorResponse)
    ...
    async def list_supported_security_questions(
        ...
        if List[SecurityQuestion] is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, SecurityQuestion)
