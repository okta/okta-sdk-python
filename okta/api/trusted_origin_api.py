...
class TrustedOriginApi(ApiClient):
    ...
    async def create_trusted_origin(
        ...
        :type trusted_origin: TrustedOriginWrite
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    async def list_trusted_origins(
        self,
        q: Annotated[Optional[StrictStr], Field(description="A search string that prefix matches against the `name` and `origin`")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="[Filter](https://developer.okta.com/docs/api/#filter) trusted origins with a supported expression for a subset of properties. You can filter on the following properties: `name`, `origin`, `status`, and `type` (type of scopes). ")] = None,
        after: Annotated[Optional[StrictStr], Field(description="After cursor provided by a prior request")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True)]], Field(description="Specifies the number of results")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
