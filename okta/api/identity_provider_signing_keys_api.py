...
class IdentityProviderSigningKeysApi(ApiClient):
    ...
    async def clone_identity_provider_key(
        ...
        if IdPKeyCredential is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, IdPKeyCredential)
    ...
    async def generate_csr_for_identity_provider(
        ...
        if IdPCsr is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, IdPCsr)
    ...
    async def list_active_identity_provider_signing_key(
        ...
        method, url, header_params, body, post_params = self._list_active_identity_provider_signing_key_serialize(
            idp_id=idp_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
