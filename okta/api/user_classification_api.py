...
class UserClassificationApi(ApiClient):
    ...
    async def get_user_classification(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "UserClassification",
            '403': "Error",
            '404': "Error",
            '429': "Error",
        }

        method, url, header_params, body, post_params = self._get_user_classification_serialize(
            user_id=user_id,
        ...
        if error:
            if UserClassification is Success:
                return (None, error)
            else:
        ...
        if UserClassification is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, UserClassification)
    ...
    def _get_user_classification_serialize(
        ...
        return self.param_serialize(
            method='GET',
            resource_path='/api/v1/users/{userId}/classification',
    ...
    async def replace_user_classification(
        ...
        :param user_id: ID of an existing Okta user (required)
        :type user_id: str
        :param replace_user_classification: (required)
        :type replace_user_classification: ReplaceUserClassification
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        method, url, header_params, body, post_params = self._replace_user_classification_serialize(
            user_id=user_id,
    ...
    def _replace_user_classification_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if replace_user_classification is not None:
            _body_params = replace_user_classification
