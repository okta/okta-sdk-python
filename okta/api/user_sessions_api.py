...
class UserSessionsApi(ApiClient):
    ...
    async def revoke_user_sessions(
        ...
        oauth_tokens: Annotated[Optional[StrictBool], Field(description="Revokes issued OpenID Connect and OAuth refresh and access tokens")] = None,
        forget_devices: Annotated[Optional[StrictBool], Field(description="Clears the user's remembered factors for all devices. > **Note:** This parameter defaults to false in Classic Engine.")] = None,
