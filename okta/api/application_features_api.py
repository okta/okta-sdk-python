...
class ApplicationFeaturesApi(ApiClient):
    ...
    async def get_feature_for_application(
        ...
        method, url, header_params, body, post_params = self._get_feature_for_application_serialize(
            app_id=app_id,
        ...
        if ApplicationFeature is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, ApplicationFeature)
    ...
    async def list_features_for_application(
        ...
        method, url, header_params, body, post_params = self._list_features_for_application_serialize(
            app_id=app_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def update_feature_for_application(
        ...
        method, url, header_params, body, post_params = self._update_feature_for_application_serialize(
            app_id=app_id,
            feature_name=feature_name,
