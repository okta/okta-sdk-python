...
class RoleECustomPermissionApi(ApiClient):
    ...
    async def create_role_permission(
        ...
        permission_type: Annotated[StrictStr, Field(description="An Okta [permission](/openapi/okta-management/guides/permissions)")],
        ...
        :param permission_type: An Okta [permission](/openapi/okta-management/guides/permissions) (required)
