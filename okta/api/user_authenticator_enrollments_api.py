...
class UserAuthenticatorEnrollmentsApi(ApiClient):
    ...
    async def create_authenticator_enrollment(
        ...
        method, url, header_params, body, post_params = self._create_authenticator_enrollment_serialize(
            user_id=user_id,
        ...
        if AuthenticatorEnrollment is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, AuthenticatorEnrollment)
    ...
    async def create_tac_authenticator_enrollment(
        ...
        method, url, header_params, body, post_params = self._create_tac_authenticator_enrollment_serialize(
            user_id=user_id,
            authenticator=authenticator,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        if TacAuthenticatorEnrollment is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, TacAuthenticatorEnrollment)
    ...
    async def delete_authenticator_enrollment(
        ...
        method, url, header_params, body, post_params = self._delete_authenticator_enrollment_serialize(
            user_id=user_id,
    ...
    async def get_authenticator_enrollment(
        ...
        user_id: Annotated[StrictStr, Field(description="ID of an existing Okta user")],
        enrollment_id: Annotated[StrictStr, Field(description="Unique identifier of an enrollment")],
        disclose_identifiers: Annotated[Optional[List[StrictStr]], Field(description="Indicates whether or not the identifier of an authenticator enrollment is disclosed or anonymized. If it's included in the operation query, then the identifier of the authenticator enrollment (the actual phone number, for example) is included in the response.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        method, url, header_params, body, post_params = self._get_authenticator_enrollment_serialize(
            user_id=user_id,
            enrollment_id=enrollment_id,
    ...
    async def list_authenticator_enrollments(
        ...
        method, url, header_params, body, post_params = self._list_authenticator_enrollments_serialize(
            user_id=user_id,
            disclose_identifiers=disclose_identifiers,
            _request_auth=_request_auth,
            _content_type=_content_type,
