...
class ApplicationSSOPublicKeysApi(ApiClient):
    ...
    async def activate_o_auth2_client_json_web_key(
        ...
        method, url, header_params, body, post_params = self._activate_o_auth2_client_json_web_key_serialize(
            app_id=app_id,
            key_id=key_id,
        ...
        if ListJwk200ResponseInner is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, ListJwk200ResponseInner)
    ...
    async def activate_o_auth2_client_secret(
        ...
        method, url, header_params, body, post_params = self._activate_o_auth2_client_secret_serialize(
            app_id=app_id,
            secret_id=secret_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        if OAuth2ClientSecret is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, OAuth2ClientSecret)
    ...
    async def create_o_auth2_client_secret(
        ...
        method, url, header_params, body, post_params = self._create_o_auth2_client_secret_serialize(
            app_id=app_id,
    ...
    async def deactivate_o_auth2_client_json_web_key(
        ...
        method, url, header_params, body, post_params = self._deactivate_o_auth2_client_json_web_key_serialize(
            app_id=app_id,
            key_id=key_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def deactivate_o_auth2_client_secret(
        ...
        method, url, header_params, body, post_params = self._deactivate_o_auth2_client_secret_serialize(
            app_id=app_id,
            secret_id=secret_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def delete_o_auth2_client_secret(
        ...
        method, url, header_params, body, post_params = self._delete_o_auth2_client_secret_serialize(
            app_id=app_id,
            secret_id=secret_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def get_jwk(
        ...
        if GetJwk200Response is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, GetJwk200Response)
    ...
    async def get_o_auth2_client_secret(
        ...
        method, url, header_params, body, post_params = self._get_o_auth2_client_secret_serialize(
            app_id=app_id,
            secret_id=secret_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def list_o_auth2_client_secrets(
        ...
        method, url, header_params, body, post_params = self._list_o_auth2_client_secrets_serialize(
            app_id=app_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
