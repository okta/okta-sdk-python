...
class OrgSettingCustomizationApi(ApiClient):
    ...
    @validate_call
    async def set_org_hide_okta_ui_footer(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        method, url, header_params, body, post_params = self._set_org_hide_okta_ui_footer_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _set_org_hide_okta_ui_footer_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    async def set_org_show_okta_ui_footer(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        method, url, header_params, body, post_params = self._set_org_show_okta_ui_footer_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _set_org_show_okta_ui_footer_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
