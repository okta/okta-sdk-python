...
class DeviceIntegrationsApi(ApiClient):
    ...
    async def activate_device_integration(
        ...
        method, url, header_params, body, post_params = self._activate_device_integration_serialize(
        ...
        if DeviceIntegrations is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, DeviceIntegrations)
    ...
    async def deactivate_device_integration(
        ...
        method, url, header_params, body, post_params = self._deactivate_device_integration_serialize(
            device_integration_id=device_integration_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def get_device_integration(
        ...
        method, url, header_params, body, post_params = self._get_device_integration_serialize(
            device_integration_id=device_integration_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def list_device_integrations(
        ...
        method, url, header_params, body, post_params = self._list_device_integrations_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
