...
class RiskEventApi(ApiClient):
    ...
    async def send_risk_events(
        ...
        """(Deprecated) Send multiple risk events
        ...
        """ # noqa: E501
        warnings.warn("POST /api/v1/risk/events/ip is deprecated.", DeprecationWarning)
        ...
        method, url, header_params, body, post_params = self._send_risk_events_serialize(
            instance=instance,
