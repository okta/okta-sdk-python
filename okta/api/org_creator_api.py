...
class OrgCreatorApi(ApiClient):
    ...
    async def create_child_org(
        ...
        method, url, header_params, body, post_params = self._create_child_org_serialize(
            child_org=child_org,
        ...
        if ChildOrg is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, ChildOrg)
