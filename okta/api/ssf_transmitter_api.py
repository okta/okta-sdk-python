...
class SSFTransmitterApi(ApiClient):
    ...
    async def create_ssf_stream(
        ...
        method, url, header_params, body, post_params = self._create_ssf_stream_serialize(
            instance=instance,
        ...
        if StreamConfiguration is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, StreamConfiguration)
    ...
    async def delete_ssf_stream(
        self,
        stream_id: Annotated[Optional[StrictStr], Field(description="The ID of the specified SSF Stream configuration")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        method, url, header_params, body, post_params = self._delete_ssf_stream_serialize(
            stream_id=stream_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def get_ssf_stream_status(
        ...
        method, url, header_params, body, post_params = self._get_ssf_stream_status_serialize(
            stream_id=stream_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        if StreamStatus is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, StreamStatus)
    ...
    async def get_ssf_streams(
        ...
        if GetSsfStreams200Response is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, GetSsfStreams200Response)
    ...
    async def get_wellknown_ssf_metadata(
        ...
        method, url, header_params, body, post_params = self._get_wellknown_ssf_metadata_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        if WellKnownSSFMetadata is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, WellKnownSSFMetadata)
    ...
    async def replace_ssf_stream(
        ...
        method, url, header_params, body, post_params = self._replace_ssf_stream_serialize(
            instance=instance,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def update_ssf_stream(
        ...
        method, url, header_params, body, post_params = self._update_ssf_stream_serialize(
            instance=instance,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def verify_ssf_stream(
        ...
        method, url, header_params, body, post_params = self._verify_ssf_stream_serialize(
            instance=instance,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
