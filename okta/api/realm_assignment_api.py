...
class RealmAssignmentApi(ApiClient):
    ...
    async def activate_realm_assignment(
        ...
        method, url, header_params, body, post_params = self._activate_realm_assignment_serialize(
    ...
    async def create_realm_assignment(
        ...
        method, url, header_params, body, post_params = self._create_realm_assignment_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        if RealmAssignment is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, RealmAssignment)
    ...
    async def deactivate_realm_assignment(
        ...
        method, url, header_params, body, post_params = self._deactivate_realm_assignment_serialize(
            assignment_id=assignment_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def delete_realm_assignment(
        ...
        method, url, header_params, body, post_params = self._delete_realm_assignment_serialize(
            assignment_id=assignment_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def execute_realm_assignment(
        ...
        method, url, header_params, body, post_params = self._execute_realm_assignment_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        if RealmAssignmentOperationResponse is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, RealmAssignmentOperationResponse)
    ...
    async def get_realm_assignment(
        ...
        method, url, header_params, body, post_params = self._get_realm_assignment_serialize(
            assignment_id=assignment_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def list_realm_assignment_operations(
        ...
        method, url, header_params, body, post_params = self._list_realm_assignment_operations_serialize(
            limit=limit,
            after=after,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def list_realm_assignments(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True, ge=1)]], Field(description="A limit on the number of objects to return")] = None,
        after: Annotated[Optional[StrictStr], Field(description="The cursor used for pagination. It represents the priority of the last realm assignment returned in the previous fetch operation.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        method, url, header_params, body, post_params = self._list_realm_assignments_serialize(
            limit=limit,
            after=after,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def replace_realm_assignment(
        ...
        method, url, header_params, body, post_params = self._replace_realm_assignment_serialize(
            assignment_id=assignment_id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
