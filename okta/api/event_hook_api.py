...
class EventHookApi(ApiClient):
    ...
    async def activate_event_hook(
        ...
        method, url, header_params, body, post_params = self._activate_event_hook_serialize(
        ...
        if EventHook is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, EventHook)
    ...
    async def create_event_hook(
        ...
        method, url, header_params, body, post_params = self._create_event_hook_serialize(
    ...
    async def deactivate_event_hook(
        ...
        method, url, header_params, body, post_params = self._deactivate_event_hook_serialize(
            event_hook_id=event_hook_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def delete_event_hook(
        ...
        method, url, header_params, body, post_params = self._delete_event_hook_serialize(
            event_hook_id=event_hook_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def list_event_hooks(
        ...
        method, url, header_params, body, post_params = self._list_event_hooks_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    async def replace_event_hook(
        ...
        method, url, header_params, body, post_params = self._replace_event_hook_serialize(
            event_hook_id=event_hook_id,
            event_hook=event_hook,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def verify_event_hook(
        ...
        method, url, header_params, body, post_params = self._verify_event_hook_serialize(
            event_hook_id=event_hook_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
