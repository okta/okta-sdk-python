...
class UserLinkedObjectApi(ApiClient):
    ...
    async def assign_linked_object_value_for_primary(
        ...
        method, url, header_params, body, post_params = self._assign_linked_object_value_for_primary_serialize(
    ...
    async def list_linked_objects_for_user(
        ...
        if List[ResponseLinks] is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, ResponseLinks)
