...
class ApplicationGrantsApi(ApiClient):
    ...
    async def get_scope_consent_grant(
        ...
        method, url, header_params, body, post_params = (
            self._get_scope_consent_grant_serialize(
                app_id=app_id,
                grant_id=grant_id,
                expand=expand,
    ...
    async def grant_consent_to_scope(
        ...
        method, url, header_params, body, post_params = (
            self._grant_consent_to_scope_serialize(
                app_id=app_id,
    ...
    async def list_scope_consent_grants(
        ...
        method, url, header_params, body, post_params = (
            self._list_scope_consent_grants_serialize(
                app_id=app_id,
                expand=expand,
                _request_auth=_request_auth,
                _content_type=_content_type,
    ...
    async def revoke_scope_consent_grant(
        ...
        method, url, header_params, body, post_params = (
            self._revoke_scope_consent_grant_serialize(
                app_id=app_id,
                grant_id=grant_id,
                _request_auth=_request_auth,
                _content_type=_content_type,
