...
class AuthorizationServerScopesApi(ApiClient):
    ...
    async def list_o_auth2_scopes(
        ...
        filter: Annotated[
            Optional[StrictStr],
            Field(description="Filter expression for Custom Token Scopes"),
        ] = None,
        after: Annotated[
            Optional[StrictStr],
            Field(
        ...
        :type filter: str
        :param after: Specifies the pagination cursor for the next page of scopes. Treat the after cursor as an opaque value
        and obtain it through the next link relationship. See [Pagination](https://developer.okta.com/docs/api/#pagination).
        :type after: str
