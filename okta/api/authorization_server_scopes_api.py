...
class AuthorizationServerScopesApi(ApiClient):
    ...
    async def list_o_auth2_scopes(
        self,
        auth_server_id: Annotated[StrictStr, Field(description="`id` of the Authorization Server")],
        q: Annotated[Optional[StrictStr], Field(description="Searches the `name` of Custom Token Scopes for matching values")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Filter expression for Custom Token Scopes")] = None,
        after: Annotated[Optional[StrictStr], Field(description="Specifies the pagination cursor for the next page of scopes. Treat the after cursor as an opaque value and obtain it through the next link relationship. See [Pagination](https://developer.okta.com/docs/api/#pagination).")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True)]], Field(description="Specifies the number of objects to return per page. If there are multiple pages of results, the Link header contains a `next` link that you need to use as an opaque value (follow it, don't parse it). See [Pagination](https://developer.okta.com/docs/api/#pagination).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
