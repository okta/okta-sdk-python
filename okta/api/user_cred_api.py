...
class UserCredApi(ApiClient):
    ...
    async def change_password(
        ...
        strict: Annotated[Optional[StrictBool], Field(description="If true, validates against the password minimum age policy")] = None,
    ...
    async def expire_password_with_temp_password(
        self,
        id: Annotated[StrictStr, Field(description="An ID, login, or login shortname (as long as the shortname is unambiguous) of an existing Okta user")],
        revoke_sessions: Annotated[Optional[StrictBool], Field(description="Revokes the user's existing sessions if `true`")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        method, url, header_params, body, post_params = self._expire_password_with_temp_password_serialize(
            id=id,
    ...
    async def forgot_password(
        self,
        user_id: Annotated[StrictStr, Field(description="ID of an existing Okta user")],
        send_email: Annotated[Optional[StrictBool], Field(description="Sends a forgot password email to the user if `true`")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def reset_password(
        ...
        revoke_sessions: Annotated[Optional[StrictBool], Field(description="Revokes all user sessions, except for the current session, if set to `true`")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
