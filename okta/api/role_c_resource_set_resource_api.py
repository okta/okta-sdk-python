...
class RoleCResourceSetResourceApi(ApiClient):
    ...
    async def add_resource_set_resource(
        ...
        if ResourceSetResource is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, ResourceSetResource)
    ...
    async def add_resource_set_resources(
        ...
        method, url, header_params, body, post_params = self._add_resource_set_resources_serialize(
            resource_set_id_or_label=resource_set_id_or_label,
            instance=instance,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def get_resource_set_resource(
        ...
        method, url, header_params, body, post_params = self._get_resource_set_resource_serialize(
            resource_set_id_or_label=resource_set_id_or_label,
            resource_id=resource_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def replace_resource_set_resource(
        ...
        method, url, header_params, body, post_params = self._replace_resource_set_resource_serialize(
            resource_set_id_or_label=resource_set_id_or_label,
            resource_id=resource_id,
