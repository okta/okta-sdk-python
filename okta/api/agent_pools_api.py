...
class AgentPoolsApi(ApiClient):
    ...
    async def list_agent_pools(
        self,
        limit_per_pool_type: Annotated[Optional[StrictInt], Field(description="Maximum number of agent pools returned")] = None,
    ...
    async def list_agent_pools_updates(
        self,
        pool_id: Annotated[StrictStr, Field(description="ID of the agent pool for which the settings apply to")],
        scheduled: Annotated[Optional[StrictBool], Field(description="Return only scheduled or ad-hoc updates. If this parameter isn't provided, Okta returns the entire list of updates.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
