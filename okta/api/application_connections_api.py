...
class ApplicationConnectionsApi(ApiClient):
    ...
    async def get_default_provisioning_connection_for_application(
        ...
        method, url, header_params, body, post_params = self._get_default_provisioning_connection_for_application_serialize(
            app_id=app_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        if ProvisioningConnectionResponse is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, ProvisioningConnectionResponse)
    ...
    async def get_user_provisioning_connection_jwks(
        ...
        method, url, header_params, body, post_params = self._get_user_provisioning_connection_jwks_serialize(
            app_id=app_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _update_default_provisioning_connection_for_application_serialize(
        ...
        if update_default_provisioning_connection_for_application_request is not None:
            _body_params = update_default_provisioning_connection_for_application_request
    ...
    async def verify_provisioning_connection_for_application(
        ...
        method, url, header_params, body, post_params = self._verify_provisioning_connection_for_application_serialize(
            app_name=app_name,
            app_id=app_id,
            code=code,
            state=state,
