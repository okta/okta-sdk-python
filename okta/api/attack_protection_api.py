...
class AttackProtectionApi(ApiClient):
    ...
    async def get_authenticator_settings(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[AttackProtectionAuthenticatorSettings]",
            '403': "Error",
            '429': "Error",
        }

        method, url, header_params, body, post_params = self._get_authenticator_settings_serialize(
    ...
    def _get_authenticator_settings_serialize(
        ...
        return self.param_serialize(
            method='GET',
            resource_path='/attack-protection/api/v1/authenticator-settings',
    ...
    async def get_user_lockout_settings(
        ...
        method, url, header_params, body, post_params = self._get_user_lockout_settings_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        if List[UserLockoutSettings] is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, UserLockoutSettings)
    ...
    async def replace_authenticator_settings(
        ...
        :param authenticator_settings: (required)
        :type authenticator_settings: AttackProtectionAuthenticatorSettings
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AttackProtectionAuthenticatorSettings",
            '400': "Error",
            '403': "Error",
            '429': "Error",
        }

        method, url, header_params, body, post_params = self._replace_authenticator_settings_serialize(
    ...
    def _replace_authenticator_settings_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if authenticator_settings is not None:
            _body_params = authenticator_settings
    ...
    async def replace_user_lockout_settings(
        ...
        method, url, header_params, body, post_params = self._replace_user_lockout_settings_serialize(
