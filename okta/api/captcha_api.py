...
class CAPTCHAApi(ApiClient):
    ...
    async def replaces_org_captcha_settings(
        ...
        Replaces the CAPTCHA settings object for your organization > **Note**: You can disable CAPTCHA for your organization
        by setting `captchaId` and `enabledPages` to `null`.
