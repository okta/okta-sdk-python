...
class GroupRuleApi(ApiClient):
    ...
    async def delete_group_rule(
        self,
        group_rule_id: Annotated[StrictStr, Field(description="The `id` of the group rule")],
        remove_users: Annotated[Optional[StrictBool], Field(description="If set to `true`, removes users from groups assigned by this rule")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def list_group_rules(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True, ge=1)]], Field(description="Specifies the number of rule results in a page")] = None,
        ...
        expand: Annotated[Optional[StrictStr], Field(description="If specified as `groupIdToGroupNameMap`, then displays group names")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
