...
class AuthorizationServerApi(ApiClient):
    ...
    async def list_authorization_servers(
        ...
        after: Annotated[
            Optional[StrictStr],
            Field(
                description="Specifies the pagination cursor for the next page of authorization servers. Treat as an opaque "
                            "value and obtain through the next link relationship."
            ),
        ] = None,
        _request_timeout: Union[
            None,
