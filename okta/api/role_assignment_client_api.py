...
class RoleAssignmentClientApi(ApiClient):
    ...
    async def assign_role_to_client(
        ...
        method, url, header_params, body, post_params = self._assign_role_to_client_serialize(
            client_id=client_id,
        ...
        if AssignRoleToClient200Response is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, AssignRoleToClient200Response)
    ...
    async def delete_role_from_client(
        ...
        method, url, header_params, body, post_params = self._delete_role_from_client_serialize(
            client_id=client_id,
    ...
    async def list_roles_for_client(
        ...
        method, url, header_params, body, post_params = self._list_roles_for_client_serialize(
            client_id=client_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def retrieve_client_role(
        ...
        method, url, header_params, body, post_params = self._retrieve_client_role_serialize(
            client_id=client_id,
            role_assignment_id=role_assignment_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
