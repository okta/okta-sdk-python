...
class ServiceAccountApi(ApiClient):
    ...
    async def create_app_service_account(
        ...
        method, url, header_params, body, post_params = self._create_app_service_account_serialize(
            body=body,
        ...
        if AppServiceAccount is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, AppServiceAccount)
    ...
    async def delete_app_service_account(
        ...
        method, url, header_params, body, post_params = self._delete_app_service_account_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def get_app_service_account(
        ...
        method, url, header_params, body, post_params = self._get_app_service_account_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def list_app_service_accounts(
            ...
            match: Annotated[Optional[Annotated[str, Field(min_length=3, strict=True, max_length=255)]], Field(
        ...
        :type after: str
        :param match: Searches for app service accounts where the account name (`name`), username (`username`),
        app instance label (`containerInstanceName`), or OIN app key name (`containerGlobalName`) contains the given value
        :type match: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        method, url, header_params, body, post_params = self._list_app_service_accounts_serialize(
            limit=limit,
            after=after,
            match=match,
            _request_auth=_request_auth,
    ...
    async def update_app_service_account(
        ...
        method, url, header_params, body, post_params = self._update_app_service_account_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
