...
class WebAuthnPreregistrationApi(ApiClient):
    ...
    async def activate_preregistration_enrollment(
        ...
        method, url, header_params, body, post_params = self._activate_preregistration_enrollment_serialize(
            body=body,
        ...
        if EnrollmentActivationResponse is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, EnrollmentActivationResponse)
    ...
    async def delete_web_authn_preregistration_factor(
        ...
        method, url, header_params, body, post_params = self._delete_web_authn_preregistration_factor_serialize(
            user_id=user_id,
            authenticator_enrollment_id=authenticator_enrollment_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def enroll_preregistration_enrollment(
        self,
        body: Annotated[Optional[EnrollmentInitializationRequest], Field(description="Enrollment initialization request")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        method, url, header_params, body, post_params = self._enroll_preregistration_enrollment_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        if EnrollmentInitializationResponse is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, EnrollmentInitializationResponse)
    ...
    async def generate_fulfillment_request(
        ...
        method, url, header_params, body, post_params = self._generate_fulfillment_request_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def list_web_authn_preregistration_factors(
        ...
        method, url, header_params, body, post_params = self._list_web_authn_preregistration_factors_serialize(
            user_id=user_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        if List[WebAuthnPreregistrationFactor] is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, WebAuthnPreregistrationFactor)
