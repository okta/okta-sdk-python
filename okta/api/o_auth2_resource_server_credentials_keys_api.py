...
class OAuth2ResourceServerCredentialsKeysApi(ApiClient):
    ...
    async def activate_o_auth2_resource_server_json_web_key(
        ...
        method, url, header_params, body, post_params = self._activate_o_auth2_resource_server_json_web_key_serialize(
        ...
        if OAuth2ResourceServerJsonWebKey is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, OAuth2ResourceServerJsonWebKey)
    ...
    async def add_o_auth2_resource_server_json_web_key(
        ...
        method, url, header_params, body, post_params = self._add_o_auth2_resource_server_json_web_key_serialize(
            auth_server_id=auth_server_id,
    ...
    async def deactivate_o_auth2_resource_server_json_web_key(
        ...
        method, url, header_params, body, post_params = self._deactivate_o_auth2_resource_server_json_web_key_serialize(
            auth_server_id=auth_server_id,
            key_id=key_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def delete_o_auth2_resource_server_json_web_key(
        ...
        method, url, header_params, body, post_params = self._delete_o_auth2_resource_server_json_web_key_serialize(
            auth_server_id=auth_server_id,
            key_id=key_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def get_o_auth2_resource_server_json_web_key(
        ...
        method, url, header_params, body, post_params = self._get_o_auth2_resource_server_json_web_key_serialize(
            auth_server_id=auth_server_id,
            key_id=key_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def list_o_auth2_resource_server_json_web_keys(
        ...
        method, url, header_params, body, post_params = self._list_o_auth2_resource_server_json_web_keys_serialize(
            auth_server_id=auth_server_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
