...
class ApplicationUsersApi(ApiClient):
    ...
    async def assign_user_to_application(
        ...
        method, url, header_params, body, post_params = self._assign_user_to_application_serialize(
            app_id=app_id,
            app_user=app_user,
        ...
        if AppUser is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, AppUser)
    ...
    async def get_application_user(
        ...
        expand: Annotated[Optional[StrictStr], Field(description="An optional query parameter to return the corresponding [User](/openapi/okta-management/management/tag/User/) object in the `_embedded` property. Valid value: `user`")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        method, url, header_params, body, post_params = self._get_application_user_serialize(
            app_id=app_id,
            user_id=user_id,
            expand=expand,
            _request_auth=_request_auth,
    ...
    async def list_application_users(
        self,
        app_id: Annotated[StrictStr, Field(description="Application ID")],
        after: Annotated[Optional[StrictStr], Field(description="Specifies the pagination cursor for the next page of results. Treat this as an opaque value obtained through the next link relationship. See [Pagination](/#pagination).")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=500, strict=True, ge=1)]], Field(description="Specifies the number of objects to return per page. If there are multiple pages of results, the Link header contains a `next` link that you need to use as an opaque value (follow it, don't parse it). See [Pagination](/#pagination). ")] = None,
        ...
        method, url, header_params, body, post_params = self._list_application_users_serialize(
            app_id=app_id,
            after=after,
            limit=limit,
            q=q,
    ...
    async def unassign_user_from_application(
        ...
        app_id: Annotated[StrictStr, Field(description="Application ID")],
        user_id: Annotated[StrictStr, Field(description="ID of an existing Okta user")],
        send_email: Annotated[Optional[StrictBool], Field(description="Sends a deactivation email to the administrator if `true`")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        method, url, header_params, body, post_params = self._unassign_user_from_application_serialize(
            app_id=app_id,
            user_id=user_id,
    ...
    async def update_application_user(
        ...
        method, url, header_params, body, post_params = self._update_application_user_serialize(
            app_id=app_id,
            user_id=user_id,
            app_user=app_user,
            _request_auth=_request_auth,
