...
class AuthorizationServerKeysApi(ApiClient):
    ...
    async def get_authorization_server_key(
        ...
        method, url, header_params, body, post_params = self._get_authorization_server_key_serialize(
        ...
        if AuthorizationServerJsonWebKey is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, AuthorizationServerJsonWebKey)
