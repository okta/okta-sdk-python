...
class ApplicationSSOFederatedClaimsApi(ApiClient):
    ...
    async def create_federated_claim(
        ...
        method, url, header_params, body, post_params = (
            self._create_federated_claim_serialize(
                app_id=app_id,
    ...
    async def delete_federated_claim(
        ...
        app_id: Annotated[StrictStr, Field(description="Application ID")],
        claim_id: Annotated[
            StrictStr, Field(description="The unique `id` of the federated claim")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        method, url, header_params, body, post_params = (
            self._delete_federated_claim_serialize(
                app_id=app_id,
                claim_id=claim_id,
                _request_auth=_request_auth,
                _content_type=_content_type,
    ...
    async def get_federated_claim(
        ...
        if FederatedClaimRequestBody is Success:
            ...
            response, response_body, error = await self._request_executor.execute(
                request, FederatedClaimRequestBody
            )
    ...
    async def list_federated_claims(
        ...
        method, url, header_params, body, post_params = (
            self._list_federated_claims_serialize(
                app_id=app_id,
                _request_auth=_request_auth,
                _content_type=_content_type,
                _headers=_headers,
    ...
    async def replace_federated_claim(
        ...
        Replaces a claim that will be included in tokens produced by federation protocols (for example: OIDC `id_tokens` or
        SAML Assertions)
