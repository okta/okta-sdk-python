...
class ApplicationSSOFederatedClaimsApi(ApiClient):
    ...
    async def create_federated_claim(
        ...
        :type app_id: str
        :param federated_claim_request_body: (required)
        :type federated_claim_request_body: FederatedClaimRequestBody
        ...
        method, url, header_params, body, post_params = self._create_federated_claim_serialize(
            app_id=app_id,
            federated_claim_request_body=federated_claim_request_body,
        ...
        if FederatedClaim is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, FederatedClaim)
    ...
    def _create_federated_claim_serialize(
        ...
        if federated_claim_request_body is not None:
            _body_params = federated_claim_request_body
        ...
        return self.param_serialize(
            method='POST',
            resource_path='/api/v1/apps/{appId}/federated-claims',
    ...
    async def delete_federated_claim(
        ...
        :param app_id: Application ID (required)
        :type app_id: str
        :param claim_id: The unique `id` of the federated claim (required)
        :type claim_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        method, url, header_params, body, post_params = self._delete_federated_claim_serialize(
            app_id=app_id,
            claim_id=claim_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _delete_federated_claim_serialize(
        ...
        return self.param_serialize(
            method='DELETE',
            resource_path='/api/v1/apps/{appId}/federated-claims/{claimId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_federated_claim(
        ...
        method, url, header_params, body, post_params = self._get_federated_claim_serialize(
            app_id=app_id,
            claim_id=claim_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        if error:
            if FederatedClaimRequestBody is Success:
                return (None, error)
            else:
                return (None, None, error)
        ...
        if FederatedClaimRequestBody is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, FederatedClaimRequestBody)
    ...
    async def list_federated_claims(
        ...
        method, url, header_params, body, post_params = self._list_federated_claims_serialize(
            app_id=app_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        if error:
            if List[FederatedClaim] is Success:
                return (None, error)
            else:
                return (None, None, error)
    ...
    async def replace_federated_claim(
        ...
        :param claim_id: The unique `id` of the federated claim (required)
        :type claim_id: str
        :param federated_claim:
        :type federated_claim: FederatedClaim
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        method, url, header_params, body, post_params = self._replace_federated_claim_serialize(
            app_id=app_id,
            claim_id=claim_id,
            federated_claim=federated_claim,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _replace_federated_claim_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if federated_claim is not None:
            _body_params = federated_claim
