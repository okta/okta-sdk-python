...
class ApplicationCrossAppAccessConnectionsApi(ApiClient):
    ...
    async def create_cross_app_access_connection(
        ...
        :type app_id: str
        :param org_cross_app_access_connection: (required)
        :type org_cross_app_access_connection: OrgCrossAppAccessConnection
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "OrgCrossAppAccessConnection",
            '400': "Error",
            '401': "Error",
            '403': "Error",
            '404': "Error",
        ...
        method, url, header_params, body, post_params = self._create_cross_app_access_connection_serialize(
            app_id=app_id,
            org_cross_app_access_connection=org_cross_app_access_connection,
        ...
        if error:
            if OrgCrossAppAccessConnection is Success:
                return (None, error)
            else:
        ...
        if OrgCrossAppAccessConnection is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, OrgCrossAppAccessConnection)
    ...
    def _create_cross_app_access_connection_serialize(
        ...
        if org_cross_app_access_connection is not None:
            _body_params = org_cross_app_access_connection
        ...
        return self.param_serialize(
            method='POST',
            resource_path='/api/v1/apps/{appId}/cwo/connections',
    ...
    async def delete_cross_app_access_connection(
        ...
        method, url, header_params, body, post_params = self._delete_cross_app_access_connection_serialize(
            app_id=app_id,
    ...
    def _delete_cross_app_access_connection_serialize(
        ...
        return self.param_serialize(
            method='DELETE',
            resource_path='/api/v1/apps/{appId}/cwo/connections/{connectionId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_all_cross_app_access_connections(
        self,
        app_id: Annotated[StrictStr, Field(description="Application ID")],
        after: Annotated[Optional[StrictStr], Field(description="Specifies the pagination cursor for the next page of connection results")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True)]], Field(description="Specifies the number of results to return per page. The values:   * -1: Return all results (up to system maximum)   * 0: Return an empty result set   * Positive integer: Return up to that many results (capped at system maximum) ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[OrgCrossAppAccessConnection]",
            '401': "Error",
            '403': "Error",
            '404': "Error",
            '429': "Error",
        ...
        method, url, header_params, body, post_params = self._get_all_cross_app_access_connections_serialize(
            app_id=app_id,
            after=after,
            limit=limit,
            _request_auth=_request_auth,
        ...
        if error:
            if List[OrgCrossAppAccessConnection] is Success:
                return (None, error)
            else:
                return (None, None, error)
    ...
    async def get_cross_app_access_connection(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OrgCrossAppAccessConnection",
            '401': "Error",
            '403': "Error",
            '404': "Error",
            '429': "Error",
        ...
        method, url, header_params, body, post_params = self._get_cross_app_access_connection_serialize(
            app_id=app_id,
            connection_id=connection_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def update_cross_app_access_connection(
        ...
        :param connection_id: Connection ID (required)
        :type connection_id: str
        :param org_cross_app_access_connection_patch_request: (required)
        :type org_cross_app_access_connection_patch_request: OrgCrossAppAccessConnectionPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        method, url, header_params, body, post_params = self._update_cross_app_access_connection_serialize(
            app_id=app_id,
            connection_id=connection_id,
            org_cross_app_access_connection_patch_request=org_cross_app_access_connection_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _update_cross_app_access_connection_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if org_cross_app_access_connection_patch_request is not None:
            _body_params = org_cross_app_access_connection_patch_request
