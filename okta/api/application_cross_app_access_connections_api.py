...
class ApplicationCrossAppAccessConnectionsApi(ApiClient):
    ...
    async def create_cross_app_access_connection(
        ...
        if OrgCrossAppAccessConnection is Success:
            ...
            response, response_body, error = await self._request_executor.execute(
                request, OrgCrossAppAccessConnection
            )
    ...
    async def delete_cross_app_access_connection(
        ...
        method, url, header_params, body, post_params = (
            self._delete_cross_app_access_connection_serialize(
                app_id=app_id,
    ...
    async def get_all_cross_app_access_connections(
        ...
        method, url, header_params, body, post_params = (
            self._get_all_cross_app_access_connections_serialize(
                app_id=app_id,
                after=after,
                limit=limit,
                _request_auth=_request_auth,
    ...
    async def get_cross_app_access_connection(
        ...
        method, url, header_params, body, post_params = (
            self._get_cross_app_access_connection_serialize(
                app_id=app_id,
                connection_id=connection_id,
                _request_auth=_request_auth,
                _content_type=_content_type,
    ...
    async def update_cross_app_access_connection(
        ...
        method, url, header_params, body, post_params = (
            self._update_cross_app_access_connection_serialize(
                app_id=app_id,
                connection_id=connection_id,
