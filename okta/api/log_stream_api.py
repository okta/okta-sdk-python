...
class LogStreamApi(ApiClient):
    ...
    async def activate_log_stream(
        ...
        method, url, header_params, body, post_params = self._activate_log_stream_serialize(
        ...
        if LogStream is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, LogStream)
    ...
    async def create_log_stream(
        ...
        method, url, header_params, body, post_params = self._create_log_stream_serialize(
            instance=instance,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def deactivate_log_stream(
        ...
        method, url, header_params, body, post_params = self._deactivate_log_stream_serialize(
            log_stream_id=log_stream_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def delete_log_stream(
        ...
        method, url, header_params, body, post_params = self._delete_log_stream_serialize(
            log_stream_id=log_stream_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def list_log_streams(
        ...
        method, url, header_params, body, post_params = self._list_log_streams_serialize(
            after=after,
            limit=limit,
            filter=filter,
            _request_auth=_request_auth,
    ...
    async def replace_log_stream(
        ...
        method, url, header_params, body, post_params = self._replace_log_stream_serialize(
            log_stream_id=log_stream_id,
            instance=instance,
            _request_auth=_request_auth,
            _content_type=_content_type,
