...
class DevicePostureCheckApi(ApiClient):
    ...
    async def delete_device_posture_check(
        self,
        posture_check_id: Annotated[
            StrictStr, Field(description="ID of the device posture check")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        method, url, header_params, body, post_params = (
            self._delete_device_posture_check_serialize(
    ...
    async def get_device_posture_check(
        ...
        method, url, header_params, body, post_params = (
            self._get_device_posture_check_serialize(
                posture_check_id=posture_check_id,
                _request_auth=_request_auth,
                _content_type=_content_type,
                _headers=_headers,
    ...
    async def list_default_device_posture_checks(
        ...
        method, url, header_params, body, post_params = (
            self._list_default_device_posture_checks_serialize(
                _request_auth=_request_auth,
                _content_type=_content_type,
                _headers=_headers,
                _host_index=_host_index,
    ...
    async def list_device_posture_checks(
        ...
        method, url, header_params, body, post_params = (
            self._list_device_posture_checks_serialize(
                _request_auth=_request_auth,
                _content_type=_content_type,
                _headers=_headers,
                _host_index=_host_index,
    ...
    async def replace_device_posture_check(
        ...
        method, url, header_params, body, post_params = (
            self._replace_device_posture_check_serialize(
                posture_check_id=posture_check_id,
                device_posture_check=device_posture_check,
                _request_auth=_request_auth,
                _content_type=_content_type,
