...
class DevicePostureCheckApi(ApiClient):
    ...
    async def create_device_posture_check(
        ...
        :param device_posture_check: (required)
        :type device_posture_check: DevicePostureCheck
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DevicePostureCheck",
            '400': "Error",
            '403': "Error",
            '429': "Error",
        }

        method, url, header_params, body, post_params = self._create_device_posture_check_serialize(
        ...
        if error:
            if DevicePostureCheck is Success:
                return (None, error)
            else:
        ...
        if DevicePostureCheck is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, DevicePostureCheck)
    ...
    def _create_device_posture_check_serialize(
        ...
        if device_posture_check is not None:
            _body_params = device_posture_check
        ...
        return self.param_serialize(
            method='POST',
            resource_path='/api/v1/device-posture-checks',
    ...
    async def delete_device_posture_check(
        ...
        method, url, header_params, body, post_params = self._delete_device_posture_check_serialize(
    ...
    def _delete_device_posture_check_serialize(
        ...
        # process the path parameters
        if posture_check_id is not None:
            _path_params['postureCheckId'] = posture_check_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.param_serialize(
            method='DELETE',
            resource_path='/api/v1/device-posture-checks/{postureCheckId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_device_posture_check(
        ...
        method, url, header_params, body, post_params = self._get_device_posture_check_serialize(
            posture_check_id=posture_check_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def list_default_device_posture_checks(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[DevicePostureCheck]",
            '403': "Error",
            '429': "Error",
        }

        method, url, header_params, body, post_params = self._list_default_device_posture_checks_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        if error:
            if List[DevicePostureCheck] is Success:
                return (None, error)
            else:
                return (None, None, error)
    ...
    def _list_default_device_posture_checks_serialize(
        ...
        return self.param_serialize(
            method='GET',
            resource_path='/api/v1/device-posture-checks/default',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def list_device_posture_checks(
        ...
        method, url, header_params, body, post_params = self._list_device_posture_checks_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    async def replace_device_posture_check(
        ...
        method, url, header_params, body, post_params = self._replace_device_posture_check_serialize(
            posture_check_id=posture_check_id,
            device_posture_check=device_posture_check,
            _request_auth=_request_auth,
            _content_type=_content_type,
