...
class ApplicationSSOApi(ApiClient):
    ...
    @validate_call
    async def preview_sam_lmetadata_for_application(
        self,
        ...
        method, url, header_params, body, post_params = self._preview_sam_lmetadata_for_application_serialize(
            app_id=app_id,
    ...
    @validate_call
    async def preview_sam_lmetadata_for_application_with_http_info(
        self,
        app_id: Annotated[StrictStr, Field(description="ID of the Application")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def preview_sam_lmetadata_for_application_without_preload_content(
        self,
        app_id: Annotated[StrictStr, Field(description="ID of the Application")],
        _request_timeout: Union[
            None,
    ...
    def _preview_sam_lmetadata_for_application_serialize(
        self,
        app_id,
        _request_auth,
        _content_type,
        ...
        return self.param_serialize(
            method='GET',
            resource_path='/api/v1/apps/${appId}/sso/saml/metadata',
