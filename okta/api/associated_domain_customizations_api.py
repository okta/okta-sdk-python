...
class AssociatedDomainCustomizationsApi(ApiClient):
    ...
    async def get_asset_links_well_known_uri(
        ...
        method, url, header_params, body, post_params = (
            self._get_asset_links_well_known_uri_serialize(
                _request_auth=_request_auth,
                _content_type=_content_type,
                _headers=_headers,
                _host_index=_host_index,
    ...
    async def get_brand_well_known_uri(
        ...
        method, url, header_params, body, post_params = (
            self._get_brand_well_known_uri_serialize(
                brand_id=brand_id,
                path=path,
                _request_auth=_request_auth,
                _content_type=_content_type,
        ...
        if WellKnownURIObjectResponse is Success:
            ...
            response, response_body, error = await self._request_executor.execute(
                request, WellKnownURIObjectResponse
            )
    ...
    async def replace_brand_well_known_uri(
        ...
        method, url, header_params, body, post_params = (
            self._replace_brand_well_known_uri_serialize(
                brand_id=brand_id,
                path=path,
