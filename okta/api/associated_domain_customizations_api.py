...
class AssociatedDomainCustomizationsApi(ApiClient):
    ...
    async def get_all_well_known_uris(
        ...
        expand: Annotated[Optional[List[StrictStr]], Field(description="Specifies additional metadata to include in the response")] = None,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "WellKnownURIsRoot",
            '403': "Error",
            '404': "Error",
            '429': "Error",
        }

        method, url, header_params, body, post_params = self._get_all_well_known_uris_serialize(
            brand_id=brand_id,
            expand=expand,
        ...
        if error:
            if WellKnownURIsRoot is Success:
                return (None, error)
            else:
        ...
        if WellKnownURIsRoot is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, WellKnownURIsRoot)
    ...
    def _get_all_well_known_uris_serialize(
        ...
        return self.param_serialize(
            method='GET',
            resource_path='/api/v1/brands/{brandId}/well-known-uris',
    ...
    async def get_apple_app_site_association_well_known_uri(
        ...
        method, url, header_params, body, post_params = self._get_apple_app_site_association_well_known_uri_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _get_apple_app_site_association_well_known_uri_serialize(
        ...
        return self.param_serialize(
            method='GET',
            resource_path='/.well-known/apple-app-site-association',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_asset_links_well_known_uri(
        ...
        method, url, header_params, body, post_params = self._get_asset_links_well_known_uri_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _get_asset_links_well_known_uri_serialize(
        ...
        return self.param_serialize(
            method='GET',
            resource_path='/.well-known/assetlinks.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_brand_well_known_uri(
        ...
        :param brand_id: The ID of the brand (required)
        :type brand_id: str
        :param path: The path of the well-known URI (required)
        :type path: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "WellKnownURIObjectResponse",
            '400': "Error",
            '403': "Error",
            '404': "Error",
            '429': "Error",
        ...
        method, url, header_params, body, post_params = self._get_brand_well_known_uri_serialize(
            brand_id=brand_id,
            path=path,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        if error:
            if WellKnownURIObjectResponse is Success:
                return (None, error)
            else:
                return (None, None, error)
        ...
        if WellKnownURIObjectResponse is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, WellKnownURIObjectResponse)
    ...
    def _get_brand_well_known_uri_serialize(
        ...
        return self.param_serialize(
            method='GET',
            resource_path='/api/v1/brands/{brandId}/well-known-uris/{path}/customized',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_root_brand_well_known_uri(
        ...
        method, url, header_params, body, post_params = self._get_root_brand_well_known_uri_serialize(
            brand_id=brand_id,
            path=path,
            expand=expand,
            _request_auth=_request_auth,
    ...
    def _get_root_brand_well_known_uri_serialize(
        ...
        return self.param_serialize(
            method='GET',
            resource_path='/api/v1/brands/{brandId}/well-known-uris/{path}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_web_authn_well_known_uri(
        ...
        method, url, header_params, body, post_params = self._get_web_authn_well_known_uri_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    async def replace_brand_well_known_uri(
        ...
        :param path: The path of the well-known URI (required)
        :type path: str
        :param well_known_uri_request:
        :type well_known_uri_request: WellKnownURIRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        method, url, header_params, body, post_params = self._replace_brand_well_known_uri_serialize(
            brand_id=brand_id,
            path=path,
            well_known_uri_request=well_known_uri_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _replace_brand_well_known_uri_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if well_known_uri_request is not None:
            _body_params = well_known_uri_request
