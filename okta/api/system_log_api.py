...
class SystemLogApi(ApiClient):
    ...
    async def list_log_events(
        self,
        since: Annotated[Optional[StrictStr], Field(description="Filters the lower time bound of the log events `published` property for bounded queries or persistence time for polling queries")] = None,
        until: Annotated[Optional[StrictStr], Field(description="Filters the upper time bound of the log events `published` property for bounded queries or persistence time for polling queries.")] = None,
        after: Annotated[Optional[StrictStr], Field(description="Retrieves the next page of results. Okta returns a link in the HTTP Header (`rel=next`) that includes the after query parameter")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Filter expression that filters the results. All operators except [ ] are supported. See [Filter](https://developer.okta.com/docs/api/#filter) and [Operators](https://developer.okta.com/docs/api/#operators).")] = None,
        q: Annotated[Optional[StrictStr], Field(description="Filters log events results by one or more case insensitive keywords.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Sets the number of results that are returned in the response")] = None,
        sort_order: Annotated[Optional[StrictStr], Field(description="The order of the returned events that are sorted by the `published` property")] = None,
        ...
        if List[LogEvent] is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, LogEvent)
