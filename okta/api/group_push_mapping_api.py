...
class GroupPushMappingApi(ApiClient):
    ...
    async def create_group_push_mapping(
        ...
        method, url, header_params, body, post_params = (
            self._create_group_push_mapping_serialize(
                app_id=app_id,
                body=body,
    ...
    async def delete_group_push_mapping(
        ...
        :type mapping_id: str
        :param delete_target_group: If set to `true`, the target group is also deleted. If set to `false`, the target group
        isn't deleted. (required)
    ...
    async def list_group_push_mappings(
        ...
        limit: Annotated[
            ...
            Field(description="Specifies the number of results returned"),
        ] = None,
        ...
        :param source_group_id: Filters group push mappings by source group ID. If you don't specify a value, all group push
        mappings are returned.
    ...
    async def update_group_push_mapping(
        ...
        method, url, header_params, body, post_params = (
            self._update_group_push_mapping_serialize(
                app_id=app_id,
                mapping_id=mapping_id,
                body=body,
                _request_auth=_request_auth,
