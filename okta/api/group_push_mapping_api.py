...
class GroupPushMappingApi(ApiClient):
    ...
    async def create_group_push_mapping(
        ...
        :type app_id: str
        :param body: (required)
        :type body: CreateGroupPushMappingRequest
        ...
        method, url, header_params, body, post_params = self._create_group_push_mapping_serialize(
            app_id=app_id,
            body=body,
        ...
        if error:
            if GroupPushMapping is Success:
                return (None, error)
            else:
        ...
        if GroupPushMapping is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, GroupPushMapping)
    ...
    def _create_group_push_mapping_serialize(
        ...
        return self.param_serialize(
            method='POST',
            resource_path='/api/v1/apps/{appId}/group-push/mappings',
    ...
    async def delete_group_push_mapping(
        ...
        method, url, header_params, body, post_params = self._delete_group_push_mapping_serialize(
            app_id=app_id,
    ...
    def _delete_group_push_mapping_serialize(
        ...
        return self.param_serialize(
            method='DELETE',
            resource_path='/api/v1/apps/{appId}/group-push/mappings/{mappingId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_group_push_mapping(
        ...
        method, url, header_params, body, post_params = self._get_group_push_mapping_serialize(
            app_id=app_id,
            mapping_id=mapping_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def list_group_push_mappings(
        self,
        app_id: Annotated[StrictStr, Field(description="Application ID")],
        after: Annotated[Optional[StrictStr], Field(description="Specifies the pagination cursor for the next page of mappings")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Specifies the number of results returned")] = None,
        last_updated: Annotated[Optional[StrictStr], Field(description="Filters group push mappings by last updated date. The `lastUpdated` parameter supports the following format: `YYYY-MM-DDTHH:mm:ssZ`. This filters mappings updated on or after the specified date and time in UTC.  If you don't specify a value, all group push mappings are returned.")] = None,
        source_group_id: Annotated[Optional[StrictStr], Field(description="Filters group push mappings by source group ID. If you don't specify a value, all group push mappings are returned.")] = None,
        status: Annotated[Optional[GroupPushMappingStatus], Field(description="Filters group push mappings by status. If you don't specify a value, all group push mappings are returned.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[GroupPushMapping]",
            '401': "Error",
            '403': "Error",
            '429': "Error",
        }

        method, url, header_params, body, post_params = self._list_group_push_mappings_serialize(
            app_id=app_id,
            after=after,
            limit=limit,
        ...
        if error:
            if List[GroupPushMapping] is Success:
                return (None, error)
            else:
                return (None, None, error)
    ...
    async def update_group_push_mapping(
        ...
        :type mapping_id: str
        :param body: (required)
        :type body: UpdateGroupPushMappingRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        method, url, header_params, body, post_params = self._update_group_push_mapping_serialize(
            app_id=app_id,
            mapping_id=mapping_id,
            body=body,
            _request_auth=_request_auth,
