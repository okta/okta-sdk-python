...
class PrincipalRateLimitApi(ApiClient):
    ...
    async def create_principal_rate_limit_entity(
        ...
        method, url, header_params, body, post_params = self._create_principal_rate_limit_entity_serialize(
            entity=entity,
        ...
        if PrincipalRateLimitEntity is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, PrincipalRateLimitEntity)
    ...
    async def get_principal_rate_limit_entity(
        ...
        method, url, header_params, body, post_params = self._get_principal_rate_limit_entity_serialize(
    ...
    async def list_principal_rate_limit_entities(
        ...
        after: Annotated[Optional[StrictStr], Field(description="The cursor to use for pagination. It's an opaque string that specifies your current location in the list and is obtained from the `Link` response header. See [Pagination](https://developer.okta.com/docs/api/#pagination).")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=50, strict=True)]], Field(description="Specifies the number of items to return in a single response page.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        method, url, header_params, body, post_params = self._list_principal_rate_limit_entities_serialize(
            filter=filter,
            after=after,
            limit=limit,
            _request_auth=_request_auth,
    ...
    async def replace_principal_rate_limit_entity(
        ...
        method, url, header_params, body, post_params = self._replace_principal_rate_limit_entity_serialize(
            principal_rate_limit_id=principal_rate_limit_id,
            entity=entity,
            _request_auth=_request_auth,
            _content_type=_content_type,
