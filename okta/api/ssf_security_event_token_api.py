...
class SSFSecurityEventTokenApi(ApiClient):
    ...
    async def publish_security_event_tokens(
        self,
        security_event_token: Annotated[
            StrictStr,
            Field(
        ...
        Publishes a Security Event Token (SET) sent by a Security Events Provider. After the token is verified, Okta ingests
        the event and performs any appropriate action.
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "202": None,
            "400": "SecurityEventTokenError",
        }

        method, url, header_params, body, post_params = (
            self._publish_security_event_tokens_serialize(
    ...
    def _publish_security_event_tokens_serialize(
        ...
        if security_event_token is not None:
            _body_params = security_event_token
        ...
        return self.param_serialize(
            method="POST",
            resource_path="/security/api/v1/security-events",
