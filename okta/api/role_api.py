...
class RoleApi(ApiClient):
    ...
    async def create_role(
        ...
        if IamRole is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, IamRole)
    ...
    async def create_role_permission(
        ...
        method, url, header_params, body, post_params = self._create_role_permission_serialize(
    ...
    async def delete_role_permission(
        ...
        method, url, header_params, body, post_params = self._delete_role_permission_serialize(
            role_id_or_label=role_id_or_label,
            permission_type=permission_type,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def get_role_permission(
        ...
        method, url, header_params, body, post_params = self._get_role_permission_serialize(
            role_id_or_label=role_id_or_label,
            permission_type=permission_type,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        if Permission is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, Permission)
    ...
    async def list_role_permissions(
        ...
        method, url, header_params, body, post_params = self._list_role_permissions_serialize(
            role_id_or_label=role_id_or_label,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        if Permissions is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, Permissions)
    ...
    async def list_roles(
        ...
        if IamRoles is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, IamRoles)
    ...
    async def replace_role_permission(
        ...
        method, url, header_params, body, post_params = self._replace_role_permission_serialize(
            role_id_or_label=role_id_or_label,
            permission_type=permission_type,
            instance=instance,
            _request_auth=_request_auth,
