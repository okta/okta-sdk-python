...
class CustomTemplatesApi(ApiClient):
    ...
    async def get_email_settings(
        ...
        if EmailSettingsResponse is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, EmailSettingsResponse)
    ...
    async def get_email_template(
        ...
        if EmailTemplateResponse is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, EmailTemplateResponse)
