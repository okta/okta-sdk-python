...
class HookKeyApi(ApiClient):
    ...
    async def create_hook_key(
        ...
        if HookKey is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, HookKey)
    ...
    async def replace_hook_key(
        ...
        method, url, header_params, body, post_params = self._replace_hook_key_serialize(
            hook_key_id=hook_key_id,
            key_request=key_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
