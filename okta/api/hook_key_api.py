...
class HookKeyApi(ApiClient):
    ...
    async def create_hook_key(
        ...
        if DetailedHookKeyInstance is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, DetailedHookKeyInstance)
    ...
    async def get_public_key(
        ...
        if Embedded is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, Embedded)
