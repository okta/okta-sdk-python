...
class RoleCResourceSetApi(ApiClient):
    ...
    async def create_resource_set(
        ...
        > **Note:** The maximum number of `resources` allowed in a resource set object is 1000. Resources are identified by
        either an Okta Resource Name (ORN) or by a REST URL format. See [Okta Resource Name](
