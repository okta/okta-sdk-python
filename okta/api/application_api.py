...
class ApplicationApi(ApiClient):
    ...
    async def get_application(
        self,
        app_id: Annotated[StrictStr, Field(description="Application ID")],
        expand: Annotated[Optional[StrictStr], Field(description="An optional query parameter to return the specified [Application User](/openapi/okta-management/management/tag/ApplicationUsers/) in the `_embedded` property. Valid value: `expand=user/{userId}`")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def list_applications(
        self,
        q: Annotated[Optional[StrictStr], Field(description="Searches for apps with `name` or `label` properties that starts with the `q` value using the `startsWith` operation")] = None,
        after: Annotated[Optional[StrictStr], Field(description="Specifies the [pagination](/#pagination) cursor for the next page of results. Treat this as an opaque value obtained through the `next` link relationship.")] = None,
        use_optimization: Annotated[Optional[StrictBool], Field(description="Specifies whether to use query optimization. If you specify `useOptimization=true` in the request query, the response contains a subset of app instance properties.")] = None,
        always_include_vpn_settings: Annotated[Optional[StrictBool], Field(description="Specifies whether to include the VPN configuration for existing notifications in the result, regardless of whether VPN notifications are configured")] = None,
        ...
        filter: Annotated[Optional[StrictStr], Field(description="Filters apps with a supported expression for a subset of properties. Filtering supports the following limited number of properties: `id`, `status`, `credentials.signing.kid`, `settings.slo.enabled`, or `name`. See [Filter](https://developer.okta.com/docs/api/#filter).")] = None,
        expand: Annotated[Optional[StrictStr], Field(description="An optional parameter used for link expansion to embed more resources in the response. Only supports `expand=user/{userId}` and must be used with the `user.id eq \"{userId}\"` filter query for the same user. Returns the assigned [application user](/openapi/okta-management/management/tag/ApplicationUsers/) in the `_embedded` property.")] = None,
        include_non_deleted: Annotated[Optional[StrictBool], Field(description="Specifies whether to include non-active, but not deleted apps in the results")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
