...
class CustomDomainApi(ApiClient):
    ...
    async def delete_custom_domain(
        ...
        method, url, header_params, body, post_params = self._delete_custom_domain_serialize(
            domain_id=domain_id,
    ...
    async def get_custom_domain(
        ...
        method, url, header_params, body, post_params = self._get_custom_domain_serialize(
            domain_id=domain_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def list_custom_domains(
        ...
        method, url, header_params, body, post_params = self._list_custom_domains_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        if DomainListResponse is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, DomainListResponse)
    ...
    async def replace_custom_domain(
        ...
        method, url, header_params, body, post_params = self._replace_custom_domain_serialize(
            domain_id=domain_id,
    ...
    async def upsert_certificate(
        ...
        method, url, header_params, body, post_params = self._upsert_certificate_serialize(
            domain_id=domain_id,
