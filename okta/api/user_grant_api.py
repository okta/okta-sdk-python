...
class UserGrantApi(ApiClient):
    ...
    async def get_user_grant(
        ...
        expand: Annotated[Optional[StrictStr], Field(description="Valid value: `scope`. If specified, scope details are included in the `_embedded` attribute.")] = None,
    ...
    async def list_grants_for_user_and_client(
        ...
        expand: Annotated[Optional[StrictStr], Field(description="Valid value: `scope`. If specified, scope details are included in the `_embedded` attribute.")] = None,
        after: Annotated[Optional[StrictStr], Field(description="The cursor to use for pagination. It is an opaque string that specifies your current location in the list and is obtained from the `Link` response header. See [Pagination](https://developer.okta.com/docs/api/#pagination).")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True, ge=1)]], Field(description="Specifies the number of tokens to return")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def list_user_grants(
        ...
        expand: Annotated[Optional[StrictStr], Field(description="Valid value: `scope`. If specified, scope details are included in the `_embedded` attribute.")] = None,
        after: Annotated[Optional[StrictStr], Field(description="The cursor to use for pagination. It is an opaque string that specifies your current location in the list and is obtained from the `Link` response header. See [Pagination](https://developer.okta.com/docs/api/#pagination).")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True, ge=1)]], Field(description="Specifies the number of grants to return")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param user_id: ID of an existing Okta user (required)
        :type user_id: str
        :param scope_id: The scope ID to filter on
        :type scope_id: str
        :param expand: Valid value: `scope`. If specified, scope details are included in the `_embedded` attribute.
        :type expand: str
        :param after: The cursor to use for pagination. It is an opaque string that specifies your current location in the list and is obtained from the `Link` response header. See [Pagination](https://developer.okta.com/docs/api/#pagination).
