...
class UserGrantApi(ApiClient):
    ...
    async def list_grants_for_user_and_client(
        ...
        limit: Annotated[
            ...
            Field(description="Specifies the number of tokens to return"),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    async def list_user_grants(
        ...
        user_id: Annotated[StrictStr, Field(description="ID of an existing Okta user")],
        scope_id: Annotated[
            Optional[StrictStr], Field(description="The scope ID to filter on")
        ] = None,
        expand: Annotated[
            Optional[StrictStr],
            Field(
        ...
        limit: Annotated[
            Optional[Annotated[int, Field(le=200, strict=True, ge=1)]],
            Field(description="Specifies the number of grants to return"),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
