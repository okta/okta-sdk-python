...
class UserRiskApi(ApiClient):
    ...
    async def get_user_risk(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "UserRiskGetResponse",
            '403': "Error",
            '404': "Error",
            '429': "Error",
        }

        method, url, header_params, body, post_params = self._get_user_risk_serialize(
            user_id=user_id,
        ...
        if error:
            if UserRiskGetResponse is Success:
                return (None, error)
            else:
        ...
        if UserRiskGetResponse is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, UserRiskGetResponse)
    ...
    def _get_user_risk_serialize(
        ...
        return self.param_serialize(
            method='GET',
            resource_path='/api/v1/users/{userId}/risk',
    ...
    @validate_call
    async def upsert_user_risk(
        self,
        user_id: Annotated[StrictStr, Field(description="ID of an existing Okta user")],
        user_risk_request: UserRiskRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param user_id: ID of an existing Okta user (required)
        :type user_id: str
        :param user_risk_request: (required)
        :type user_risk_request: UserRiskRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "UserRiskPutResponse",
            '201': "UserRiskPutResponse",
            '400': "Error",
            '403': "Error",
            '404': "Error",
            '429': "Error",
        ...
        method, url, header_params, body, post_params = self._upsert_user_risk_serialize(
            user_id=user_id,
            user_risk_request=user_risk_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        if error:
            if UserRiskPutResponse is Success:
                return (None, error)
            else:
                return (None, None, error)
        ...
        if UserRiskPutResponse is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, UserRiskPutResponse)
    ...
    def _upsert_user_risk_serialize(
        self,
        user_id,
        user_risk_request,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if user_risk_request is not None:
            _body_params = user_risk_request
