...
class OktaPersonalSettingsApi(ApiClient):
    ...
    async def list_personal_apps_export_block_list(
        ...
        method, url, header_params, body, post_params = self._list_personal_apps_export_block_list_serialize(
        ...
        if PersonalAppsBlockList is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, PersonalAppsBlockList)
    ...
    async def replace_blocked_email_domains(
        ...
        method, url, header_params, body, post_params = self._replace_blocked_email_domains_serialize(
    ...
    async def replace_okta_personal_admin_settings(
        ...
        method, url, header_params, body, post_params = self._replace_okta_personal_admin_settings_serialize(
