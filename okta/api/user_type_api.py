...
class UserTypeApi(ApiClient):
    ...
    async def create_user_type(
        ...
        additional user types. > **Note**: New user types are based on the current default schema template. Modifications to
        this schema do not automatically propagate to previously created user types.
    ...
    async def delete_user_type(
        ...
        Deletes a user type permanently. > **Note**: You can't delete the default user type or a user type that is currently
        assigned to users.
    ...
    async def update_user_type(
        ...
        and `description` elements. The `name` of an existing user type can't be changed.
