...
class UserType(object):
    ...
    def create_user_type(self, body, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_user_type(body, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.create_user_type_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_user_type_with_http_info(body, **kwargs)  # noqa: E501
            return data
    ...
    def create_user_type_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_user_type_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_user_type" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_user_type`")  # noqa: E501
    ...
    def delete_user_type(self, type_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_user_type(type_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_user_type_with_http_info(type_id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_user_type_with_http_info(type_id, **kwargs)  # noqa: E501
            return data
    ...
    def delete_user_type_with_http_info(self, type_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_user_type_with_http_info(type_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_user_type" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('type_id' not in params or
            ...
            raise ValueError("Missing the required parameter `type_id` when calling `delete_user_type`")  # noqa: E501
    ...
    def get_user_type(self, type_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_type(type_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_user_type_with_http_info(type_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_user_type_with_http_info(type_id, **kwargs)  # noqa: E501
            return data
    ...
    def get_user_type_with_http_info(self, type_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_type_with_http_info(type_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('type_id' not in params or
                params['type_id'] is None):
            raise ValueError("Missing the required parameter `type_id` when calling `get_user_type`")  # noqa: E501
    ...
    def list_user_types(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_user_types(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_user_types_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_user_types_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def list_user_types_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_user_types_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[UserType]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def replace_user_type_with_http_info(self, type_id, body, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method replace_user_type" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'type_id' is set
    ...
    def update_user_type_with_http_info(self, type_id, body, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_user_type" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'type_id' is set
