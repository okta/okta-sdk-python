...
class User(object):
    ...
    def forgot_password_set_new_password(self, user_id, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.forgot_password_set_new_password(user_id, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.forgot_password_set_new_password_with_http_info(user_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.forgot_password_set_new_password_with_http_info(user_id, body, **kwargs)  # noqa: E501
            return data

    def forgot_password_set_new_password_with_http_info(self, user_id, body, **kwargs):  # noqa: E501
        """Reset Password with Recovery Question  # noqa: E501

        Resets the user's password to the specified password if the provided answer to the recovery question is correct.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.forgot_password_set_new_password_with_http_info(user_id, body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `forgot_password_set_new_password`")  # noqa: E501
