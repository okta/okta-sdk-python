...
class ApiTokenApi(ApiClient):
    ...
    async def get_api_token(
        ...
        if ApiToken is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, ApiToken)
    ...
    async def revoke_api_token(
        ...
        method, url, header_params, body, post_params = self._revoke_api_token_serialize(
            api_token_id=api_token_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def revoke_current_api_token(
        ...
        method, url, header_params, body, post_params = self._revoke_current_api_token_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
