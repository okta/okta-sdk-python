...
class ApplicationTokensApi(ApiClient):
    ...
    async def get_o_auth2_token_for_application(
        ...
        method, url, header_params, body, post_params = self._get_o_auth2_token_for_application_serialize(
            app_id=app_id,
            token_id=token_id,
            expand=expand,
    ...
    async def list_o_auth2_tokens_for_application(
        ...
        method, url, header_params, body, post_params = self._list_o_auth2_tokens_for_application_serialize(
            app_id=app_id,
            expand=expand,
            after=after,
            limit=limit,
    ...
    async def revoke_o_auth2_token_for_application(
        ...
        method, url, header_params, body, post_params = self._revoke_o_auth2_token_for_application_serialize(
            app_id=app_id,
            token_id=token_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def revoke_o_auth2_tokens_for_application(
        ...
        method, url, header_params, body, post_params = self._revoke_o_auth2_tokens_for_application_serialize(
            app_id=app_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
