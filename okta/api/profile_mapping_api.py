...
class ProfileMappingApi(ApiClient):
    ...
    async def list_profile_mappings(
        ...
        source_id: Annotated[Optional[StrictStr], Field(description="The user type or app instance ID that acts as the source of expressions in a mapping. If this parameter is included, all returned mappings have this as their `source.id`.")] = None,
        target_id: Annotated[Optional[StrictStr], Field(description="The user type or app instance ID that acts as the target of expressions in a mapping. If this parameter is included, all returned mappings have this as their `target.id`.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
