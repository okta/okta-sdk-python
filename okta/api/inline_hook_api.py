...
class InlineHookApi(ApiClient):
    ...
    async def create_inline_hook(
        ...
        if InlineHookCreateResponse is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, InlineHookCreateResponse)
    ...
    async def execute_inline_hook(
        ...
        if ExecuteInlineHook200Response is Success:
            ...
            response, response_body, error = await self._request_executor.execute(request, ExecuteInlineHook200Response)
    ...
    async def update_inline_hook(
        ...
        method, url, header_params, body, post_params = self._update_inline_hook_serialize(
            inline_hook_id=inline_hook_id,
            inline_hook=inline_hook,
            _request_auth=_request_auth,
            _content_type=_content_type,
