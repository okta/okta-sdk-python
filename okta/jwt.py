...
class JWT:
    ...
    def get_PEM_JWK(private_key):
        ...
        if (isinstance(private_key, str) and private_key.startswith("{")) or isinstance(
            private_key, dict
        ):
            ...
            try:
                ...
                raise ValueError("JWK given is of the wrong type")
        else:  # it's a PEM
            # check for filepath or explicit private key
            if isinstance(private_key, (str, bytes, os.PathLike)) and os.path.exists(
                private_key
            ):
            ...
            try:
                ...
                raise ValueError("RSA Private Key given is of the wrong type")
    ...
    def create_dpop_token(
        ...
        Args:
            ...
            http_url: Full HTTP URL (should already have query/fragment stripped)
        ...
        Note:
            This method expects the http_url to already have query parameters
            and fragments stripped. Use DPoPProofGenerator.generate_proof_jwt()
            for automatic URL cleaning.
