...
ERROR_MESSAGE_ORG_URL_MISSING = (
    f"Your Okta URL is missing. You can copy your domain from the Okta Developer Console. Follow "
...
ERROR_MESSAGE_AUTH_MODE_INVALID = (
    "The AuthorizationMode configuration option must be one of: [SSWS, Bearer, PrivateKey]. "
    "You provided the SDK with "
)

ERROR_MESSAGE_ORG_URL_YOUROKTADOMAIN = (
    f"Replace {{yourOktaDomain}} with your Okta domain. You can copy your domain from the "
    f"Okta Developer Console. Follow these instructions to find it: {FINDING_OKTA_DOMAIN}"
)
...
ERROR_MESSAGE_API_TOKEN_MISSING = (
    f"Your Okta API token is missing. You can generate one in the Okta Develo"
    f"per Console. Follow these instructions: {GET_OKTA_API_TOKEN}"
)

ERROR_MESSAGE_API_TOKEN_DEFAULT = (
    f"Replace {{apiToken}} with your Okta API token. You can generate one in the Okta "
    f"Developer Console. Follow these instructions: {GET_OKTA_API_TOKEN}"
)
...
ERROR_MESSAGE_CLIENT_ID_DEFAULT = (
    f"Replace {{clientId}} with the client ID of your Application. You can copy it from the "
    f"Okta Developer Console in the details for the Application you created. Fol"
    f"low these instructions to find it: {FINDING_OKTA_APP_CRED}"
)
...
ERROR_MESSAGE_PROXY_MISSING_AUTH = (
    "Proxy configuration must include BOTH your username and password if authentication is "
    "required"
)
