...
from okta.models import ApplicationSignOnMode as ASM
from okta.models import FactorType as FT
from okta.models import PolicyType as PT
...
OKTA_FACTOR_TYPE_TO_FACTOR = {
    ...
    # U_2_F -> U2F, U2FUserFactor -> U2fUserFactor (F -> f)
