...
MODEL_PROPERTIES = {
    "AutoLoginApplication": "AUTO_LOGIN",
    "BasicAuthApplication": "BASIC_AUTH",
    "BookmarkApplication": "BOOKMARK",
    "BrowserPluginApplication": "BROWSER_PLUGIN",
    "OpenIdConnectApplication": "OPENID_CONNECT",
    "SamlApplication": "SAML_1_1",
    "SamlApplication": "SAML_2_0",
    "SecurePasswordStoreApplication": "SECURE_PASSWORD_STORE",
    "WsFederationApplication": "WS_FEDERATION",
    "CallUserFactor": "call",
    "EmailUserFactor": "email",
    "PushUserFactor": "push",
    "SecurityQuestionUserFactor": "question",
    "SmsUserFactor": "sms",
    "TokenUserFactor": "token",
    "HardwareUserFactor": "token:hardware",
    "CustomHotpUserFactor": "token:hotp",
    "TotpUserFactor": "token:software:totp",
    "U2fUserFactor": "u2f",
    "WebUserFactor": "web",
    "WebAuthnUserFactor": "webauthn",
    "CustomHotpUserFactor": "hotp",
    "AccessPolicy": "ACCESS_POLICY",
    "IdpDiscoveryPolicy": "IDP_DISCOVERY",
    "MultifactorEnrollmentPolicy": "MFA_ENROLL",
    "OktaSignOnPolicy": "OKTA_SIGN_ON",
    "PasswordPolicy": "PASSWORD",
    "ProfileEnrollmentPolicy": "PROFILE_ENROLLMENT",
    "AccessPolicyRule": "ACCESS_POLICY",
    "PasswordPolicyRule": "PASSWORD",
    "ProfileEnrollmentPolicyRule": "PROFILE_ENROLLMENT",
    "AuthorizationServerPolicyRule": "RESOURCE_ACCESS",
    "OktaSignOnPolicyRule": "SIGN_ON",
    "IdpDiscoveryPolicyRule": "IDP_DISCOVERY",
}
