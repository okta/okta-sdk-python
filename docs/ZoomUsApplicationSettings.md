...
json = "{}"
# create an instance of ZoomUsApplicationSettings from a JSON string
zoom_us_application_settings_instance = ZoomUsApplicationSettings.from_json(json)
# print the JSON string representation of the object
print(ZoomUsApplicationSettings.to_json())

# convert the object into a dict
zoom_us_application_settings_dict = zoom_us_application_settings_instance.to_dict()
# create an instance of ZoomUsApplicationSettings from a dict
zoom_us_application_settings_from_dict = ZoomUsApplicationSettings.from_dict(zoom_us_application_settings_dict)
```
