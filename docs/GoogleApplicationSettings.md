...
json = "{}"
# create an instance of GoogleApplicationSettings from a JSON string
google_application_settings_instance = GoogleApplicationSettings.from_json(json)
# print the JSON string representation of the object
print(GoogleApplicationSettings.to_json())

# convert the object into a dict
google_application_settings_dict = google_application_settings_instance.to_dict()
# create an instance of GoogleApplicationSettings from a dict
google_application_settings_from_dict = GoogleApplicationSettings.from_dict(google_application_settings_dict)
```
