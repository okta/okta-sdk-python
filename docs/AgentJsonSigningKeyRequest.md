...
json = "{}"
# create an instance of AgentJsonSigningKeyRequest from a JSON string
agent_json_signing_key_request_instance = AgentJsonSigningKeyRequest.from_json(json)
# print the JSON string representation of the object
print(AgentJsonSigningKeyRequest.to_json())

# convert the object into a dict
agent_json_signing_key_request_dict = agent_json_signing_key_request_instance.to_dict()
# create an instance of AgentJsonSigningKeyRequest from a dict
agent_json_signing_key_request_from_dict = AgentJsonSigningKeyRequest.from_dict(agent_json_signing_key_request_dict)
```
