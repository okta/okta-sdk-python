...
json = "{}"
# create an instance of Org2OrgApplicationSettings from a JSON string
org2_org_application_settings_instance = Org2OrgApplicationSettings.from_json(json)
# print the JSON string representation of the object
print(Org2OrgApplicationSettings.to_json())

# convert the object into a dict
org2_org_application_settings_dict = org2_org_application_settings_instance.to_dict()
# create an instance of Org2OrgApplicationSettings from a dict
org2_org_application_settings_from_dict = Org2OrgApplicationSettings.from_dict(org2_org_application_settings_dict)
```
