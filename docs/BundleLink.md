...
json = "{}"
# create an instance of BundleLink from a JSON string
bundle_link_instance = BundleLink.from_json(json)
# print the JSON string representation of the object
print(BundleLink.to_json())

# convert the object into a dict
bundle_link_dict = bundle_link_instance.to_dict()
# create an instance of BundleLink from a dict
bundle_link_from_dict = BundleLink.from_dict(bundle_link_dict)
```
