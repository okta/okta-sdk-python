...
identity_assertion_custom_as_connection_instance = IdentityAssertionCustomASConnection.from_json(json)
# print the JSON string representation of the object
print(IdentityAssertionCustomASConnection.to_json())

# convert the object into a dict
identity_assertion_custom_as_connection_dict = identity_assertion_custom_as_connection_instance.to_dict()
# create an instance of IdentityAssertionCustomASConnection from a dict
identity_assertion_custom_as_connection_from_dict = IdentityAssertionCustomASConnection.from_dict(identity_assertion_custom_as_connection_dict)
```
