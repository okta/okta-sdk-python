...
salesforce_application_settings_instance = SalesforceApplicationSettings.from_json(json)
# print the JSON string representation of the object
print(SalesforceApplicationSettings.to_json())

# convert the object into a dict
salesforce_application_settings_dict = salesforce_application_settings_instance.to_dict()
# create an instance of SalesforceApplicationSettings from a dict
salesforce_application_settings_from_dict = SalesforceApplicationSettings.from_dict(salesforce_application_settings_dict)
```
