...
json = "{}"
# create an instance of LinksPollPoll from a JSON string
links_poll_poll_instance = LinksPollPoll.from_json(json)
# print the JSON string representation of the object
print(LinksPollPoll.to_json())

# convert the object into a dict
links_poll_poll_dict = links_poll_poll_instance.to_dict()
# create an instance of LinksPollPoll from a dict
links_poll_poll_from_dict = LinksPollPoll.from_dict(links_poll_poll_dict)
```
