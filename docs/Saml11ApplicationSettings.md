...
**app** | **Dict[str, object]** |  | [optional] 
**sign_on** | [**Saml11ApplicationSettingsSignOn**](Saml11ApplicationSettingsSignOn.md) |  | [optional] 
...
json = "{}"
# create an instance of Saml11ApplicationSettings from a JSON string
saml11_application_settings_instance = Saml11ApplicationSettings.from_json(json)
# print the JSON string representation of the object
print(Saml11ApplicationSettings.to_json())

# convert the object into a dict
saml11_application_settings_dict = saml11_application_settings_instance.to_dict()
# create an instance of Saml11ApplicationSettings from a dict
saml11_application_settings_from_dict = Saml11ApplicationSettings.from_dict(saml11_application_settings_dict)
```
