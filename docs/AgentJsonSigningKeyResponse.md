...
json = "{}"
# create an instance of AgentJsonSigningKeyResponse from a JSON string
agent_json_signing_key_response_instance = AgentJsonSigningKeyResponse.from_json(json)
# print the JSON string representation of the object
print(AgentJsonSigningKeyResponse.to_json())

# convert the object into a dict
agent_json_signing_key_response_dict = agent_json_signing_key_response_instance.to_dict()
# create an instance of AgentJsonSigningKeyResponse from a dict
agent_json_signing_key_response_from_dict = AgentJsonSigningKeyResponse.from_dict(agent_json_signing_key_response_dict)
```
