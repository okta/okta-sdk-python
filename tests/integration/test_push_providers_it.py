...
-----END PRIVATE KEY-----""",
    ...
    async def test_full_crud_workflow(self, fs):
        ...
        try:
            ...
            retrieved_provider, _, err = await client.get_push_provider(created_provider.id)
            assert err is None
            ...
            updated_provider, _, err = await client.replace_push_provider(created_provider.id, created_provider)
            assert err is None
            ...
            deleted_provider, _, get_err = await client.get_push_provider(created_provider.id)
    ...
    async def test_http_info_variants_workflow(self, fs):
        ...
        try:
            ...
            created_provider, http_response, err = await client.create_push_provider_with_http_info(provider)
            ...
            # GET with HTTP info
            retrieved_provider, http_response, err = await client.get_push_provider_with_http_info(created_provider.id)
            assert err is None
            assert retrieved_provider is not None
            assert http_response is not None
            assert retrieved_provider.id == created_provider.id
            ...
            # LIST with HTTP info
            providers_list, http_response, err = await client.list_push_providers_with_http_info()
            assert err is None
            assert isinstance(providers_list, list)
            assert http_response is not None
            ...
            created_provider.name = new_name
            updated_provider, http_response, err = await client.replace_push_provider_with_http_info(
            ...
            result = await client.delete_push_provider_with_http_info(created_provider.id)
            if len(result) == 2:
    ...
    async def test_without_preload_content_variants_workflow(self, fs):
        ...
        try:
            ...
            created_provider, http_response, err = await client.create_push_provider_without_preload_content(provider)
            ...
            retrieved_provider, http_response, err = await client.get_push_provider_without_preload_content(created_provider.id)
            assert err is None
            assert retrieved_provider is not None
            assert http_response is not None
            assert retrieved_provider.id == created_provider.id
            ...
            providers_list, http_response, err = await client.list_push_providers_without_preload_content()
            assert err is None
            assert isinstance(providers_list, list)
            assert http_response is not None
            ...
            created_provider.name = new_name
            updated_provider, http_response, err = await client.replace_push_provider_without_preload_content(
                created_provider.id, created_provider)
            assert err is None
            assert updated_provider is not None
            assert http_response is not None
            ...
            result = await client.delete_push_provider_without_preload_content(created_provider.id)
            if len(result) == 2:
                http_response, err = result
            else:
                _, http_response, err = result
    ...
    async def test_error_handling_invalid_data_and_not_found(self, fs):
        ...
        updated_provider, _, err = await client.replace_push_provider("nonexistent-id-12345", test_provider)
    ...
    async def test_all_push_provider_api_methods_accessibility(self, fs):
        ...
        # Core methods (5)
        core_methods = [
            'create_push_provider', 'get_push_provider', 'list_push_providers', 
            'replace_push_provider', 'delete_push_provider'
        ]
        
        # HTTP info variants (5)
        http_info_methods = [
            'create_push_provider_with_http_info', 'get_push_provider_with_http_info',
            'list_push_providers_with_http_info', 'replace_push_provider_with_http_info',
            'delete_push_provider_with_http_info'
        ]
        
        # Without preload content variants (5)
        preload_methods = [
            'create_push_provider_without_preload_content', 'get_push_provider_without_preload_content',
        ...
        providers, http_resp, err = await client.list_push_providers_without_preload_content()
        assert err is None
        assert http_resp is not None
